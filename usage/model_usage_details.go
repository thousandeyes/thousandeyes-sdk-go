...
func (o *UsageDetails) GetAllocations() UnitAllocationSummary {
	if o == nil || utils.IsNil(o.Allocations) {
		var ret UnitAllocationSummary
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UsageDetails) GetAllocationsOk() (*UnitAllocationSummary, bool) {
	if o == nil || utils.IsNil(o.Allocations) {
		return nil, false
	}
...
func (o *UsageDetails) HasAllocations() bool {
	if o != nil && !utils.IsNil(o.Allocations) {
		return true
	}
...
// SetAllocations gets a reference to the given UnitAllocationSummary and assigns it to the Allocations field.
func (o *UsageDetails) SetAllocations(v UnitAllocationSummary) {
	o.Allocations = &v
}
