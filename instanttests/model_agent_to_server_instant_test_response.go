...
func (o *AgentToServerInstantTestResponse) GetPort() int32 {
...
// and a boolean to check if the value has been set.
func (o *AgentToServerInstantTestResponse) GetPortOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Port) {
		return nil, false
	}
	return o.Port, true
...
func (o *AgentToServerInstantTestResponse) HasPort() bool {
	if o != nil && !utils.IsNil(o.Port) {
		return true
	}
...
func (o *AgentToServerInstantTestResponse) SetPort(v int32) {
	o.Port = &v
}
