...
func NewFtpServerProperties(requestType FtpServerRequestType, url string, username string) *FtpServerProperties {
...
func (o *FtpServerProperties) HasPassword() bool {
	if o != nil && !utils.IsNil(o.Password) {
		return true
	}
