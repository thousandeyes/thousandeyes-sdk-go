...
func (o *SipServerInstantTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *SipServerInstantTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *SipServerInstantTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *SipServerInstantTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}
