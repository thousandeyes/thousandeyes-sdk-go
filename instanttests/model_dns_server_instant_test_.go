...
func (o *DnsServerInstantTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *DnsServerInstantTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *DnsServerInstantTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *DnsServerInstantTest) SetTags(v []TestTag) {
	o.Tags = v
}
