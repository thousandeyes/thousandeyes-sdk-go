...
func TestAgentToServerInstantTestsAPIService_CreateAgentToServerInstantTest(t *testing.T) {
	...
	var requestBody AgentToServerInstantTestRequest
	...
	var expectedResponse AgentToServerInstantTestResponse
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		expectedPath := "/tests/agent-to-server/instant"
		...
		var receivedBody AgentToServerInstantTestRequest
	...
	api := (*AgentToServerInstantTestsAPIService)(&apiClient.Common)

	actualResponse, httpResponse, err := api.CreateAgentToServerInstantTest().AgentToServerInstantTestRequest(requestBody).Aid(aid).Expand(expand).Execute()
	if err != nil {
		t.Fatalf("CreateAgentToServerInstantTest() error = %v", err)
	}
	if httpResponse == nil {
		t.Fatal("CreateAgentToServerInstantTest() returned a nil HTTP response")
	}
	if httpResponse.StatusCode != responseStatus {
		t.Errorf("CreateAgentToServerInstantTest() status = %d, want %d", httpResponse.StatusCode, responseStatus)
	}
	expected := &expectedResponse
	if !reflect.DeepEqual(actualResponse, expected) {
		t.Errorf("CreateAgentToServerInstantTest() response = %#v, want %#v", actualResponse, expected)
	}
}

func TestAgentToServerInstantTestsAPIService_CreateAgentToServerInstantTest_Errors(t *testing.T) {
	const testToken = "test-token"
	...
	runErrorCase := func(
		...
		_, httpResponse, err := api.CreateAgentToServerInstantTest().AgentToServerInstantTestRequest(requestBody).Aid(aid).Expand(expand).Execute()
		if err == nil {
			t.Fatalf("CreateAgentToServerInstantTest() error = nil, want *GenericAPIError")
		}
		if httpResponse == nil {
			t.Fatal("CreateAgentToServerInstantTest() returned a nil HTTP response")
		}
		...
		if !errors.As(err, &apiError) {
			t.Fatalf("CreateAgentToServerInstantTest() error type = %T, want *GenericAPIError", err)
		}
