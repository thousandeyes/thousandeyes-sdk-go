...
func (o *SipServerInstantTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *SipServerInstantTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *SipServerInstantTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *SipServerInstantTest) SetTags(v []TestTag) {
	o.Tags = v
}
