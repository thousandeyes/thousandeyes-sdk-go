...
func TestAgentToAgentInstantTestsAPIService_CreateAgentToAgentInstantTest(t *testing.T) {
	...
	var requestBody AgentToAgentInstantTestRequest
	...
	var expectedResponse AgentToAgentInstantTestResponse
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		expectedPath := "/tests/agent-to-agent/instant"
		...
		var receivedBody AgentToAgentInstantTestRequest
	...
	api := (*AgentToAgentInstantTestsAPIService)(&apiClient.Common)

	actualResponse, httpResponse, err := api.CreateAgentToAgentInstantTest().AgentToAgentInstantTestRequest(requestBody).Aid(aid).Expand(expand).Execute()
	if err != nil {
		t.Fatalf("CreateAgentToAgentInstantTest() error = %v", err)
	}
	if httpResponse == nil {
		t.Fatal("CreateAgentToAgentInstantTest() returned a nil HTTP response")
	}
	if httpResponse.StatusCode != responseStatus {
		t.Errorf("CreateAgentToAgentInstantTest() status = %d, want %d", httpResponse.StatusCode, responseStatus)
	}
	expected := &expectedResponse
	if !reflect.DeepEqual(actualResponse, expected) {
		t.Errorf("CreateAgentToAgentInstantTest() response = %#v, want %#v", actualResponse, expected)
	}
}

func TestAgentToAgentInstantTestsAPIService_CreateAgentToAgentInstantTest_Errors(t *testing.T) {
	const testToken = "test-token"
	...
	runErrorCase := func(
		...
		_, httpResponse, err := api.CreateAgentToAgentInstantTest().AgentToAgentInstantTestRequest(requestBody).Aid(aid).Expand(expand).Execute()
		if err == nil {
			t.Fatalf("CreateAgentToAgentInstantTest() error = nil, want *GenericAPIError")
		}
		if httpResponse == nil {
			t.Fatal("CreateAgentToAgentInstantTest() returned a nil HTTP response")
		}
		...
		if !errors.As(err, &apiError) {
			t.Fatalf("CreateAgentToAgentInstantTest() error type = %T, want *GenericAPIError", err)
		}
