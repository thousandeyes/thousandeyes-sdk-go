...
// checks if the VoiceInstantTestResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VoiceInstantTestResponse{}

// VoiceInstantTestResponse struct for VoiceInstantTestResponse
...
// NewVoiceInstantTestResponse instantiates a new VoiceInstantTestResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewVoiceInstantTestResponse(targetAgentId string) *VoiceInstantTestResponse {
	this := VoiceInstantTestResponse{}
...
// NewVoiceInstantTestResponseWithDefaults instantiates a new VoiceInstantTestResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewVoiceInstantTestResponseWithDefaults() *VoiceInstantTestResponse {
	this := VoiceInstantTestResponse{}
	var dscpId TestDscpId = "0"
	this.DscpId = &dscpId
	var duration int32 = 5
...
func (o *VoiceInstantTestResponse) GetCreatedBy() string {
...
func (o *VoiceInstantTestResponse) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetTestId(v string) {
	o.TestId = &v
}

// GetTestName returns the TestName field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetTestName() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *VoiceInstantTestResponse) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *VoiceInstantTestResponse) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetLabels(v []TestLabel) {
	o.Labels = v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *VoiceInstantTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}

// GetSharedWithAccounts returns the SharedWithAccounts field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetSharedWithAccounts() []SharedWithAccount {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetSharedWithAccounts(v []SharedWithAccount) {
	o.SharedWithAccounts = v
}

// GetCodec returns the Codec field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetCodec() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetCodecOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Codec) {
		return nil, false
	}
	return o.Codec, true
...
func (o *VoiceInstantTestResponse) HasCodec() bool {
	if o != nil && !utils.IsNil(o.Codec) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetCodec(v string) {
	o.Codec = &v
}

// GetCodecId returns the CodecId field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetCodecId() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetCodecIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CodecId) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasCodecId() bool {
	if o != nil && !utils.IsNil(o.CodecId) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetCodecId(v string) {
	o.CodecId = &v
}

// GetDscp returns the Dscp field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetDscp() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetDscpOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Dscp) {
		return nil, false
	}
	return o.Dscp, true
...
func (o *VoiceInstantTestResponse) HasDscp() bool {
	if o != nil && !utils.IsNil(o.Dscp) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetDscp(v string) {
	o.Dscp = &v
}

// GetDscpId returns the DscpId field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetDscpId() TestDscpId {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetDscpIdOk() (*TestDscpId, bool) {
	if o == nil || utils.IsNil(o.DscpId) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasDscpId() bool {
	if o != nil && !utils.IsNil(o.DscpId) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetDscpId(v TestDscpId) {
	o.DscpId = &v
}

// GetDuration returns the Duration field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetDuration() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetDurationOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Duration) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasDuration() bool {
	if o != nil && !utils.IsNil(o.Duration) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetDuration(v int32) {
	o.Duration = &v
}

// GetJitterBuffer returns the JitterBuffer field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetJitterBuffer() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetJitterBufferOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.JitterBuffer) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasJitterBuffer() bool {
	if o != nil && !utils.IsNil(o.JitterBuffer) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetJitterBuffer(v int32) {
	o.JitterBuffer = &v
}

// GetNumPathTraces returns the NumPathTraces field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetNumPathTraces() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetPort returns the Port field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetPort() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetPortOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Port) {
		return nil, false
	}
	return o.Port, true
...
func (o *VoiceInstantTestResponse) HasPort() bool {
	if o != nil && !utils.IsNil(o.Port) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetPort(v int32) {
	o.Port = &v
}

// GetRandomizedStartTime returns the RandomizedStartTime field value if set, zero value otherwise.
func (o *VoiceInstantTestResponse) GetRandomizedStartTime() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
func (o *VoiceInstantTestResponse) SetRandomizedStartTime(v bool) {
	o.RandomizedStartTime = &v
}

// GetTargetAgentId returns the TargetAgentId field value
func (o *VoiceInstantTestResponse) GetTargetAgentId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceInstantTestResponse) GetTargetAgentIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VoiceInstantTestResponse) SetTargetAgentId(v string) {
	o.TargetAgentId = v
}
...
func (o *VoiceInstantTestResponse) HasAgents() bool {
	if o != nil && !utils.IsNil(o.Agents) {
		return true
	}
...
func (o VoiceInstantTestResponse) MarshalJSON() ([]byte, error) {
...
func (o VoiceInstantTestResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VoiceInstantTestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVoiceInstantTestResponse := _VoiceInstantTestResponse{}

    err = json.Unmarshal(data, &varVoiceInstantTestResponse)

	if err != nil {
		return err
	}

	*o = VoiceInstantTestResponse(varVoiceInstantTestResponse)

	return err
}

type NullableVoiceInstantTestResponse struct {
	value *VoiceInstantTestResponse
	isSet bool
}

func (v NullableVoiceInstantTestResponse) Get() *VoiceInstantTestResponse {
	return v.value
}

func (v *NullableVoiceInstantTestResponse) Set(val *VoiceInstantTestResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVoiceInstantTestResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVoiceInstantTestResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoiceInstantTestResponse(val *VoiceInstantTestResponse) *NullableVoiceInstantTestResponse {
	return &NullableVoiceInstantTestResponse{value: val, isSet: true}
}

func (v NullableVoiceInstantTestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoiceInstantTestResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
