...
func (o *SimpleAgent) GetNetworkProviderInfo() NetworkProviderInfo {
...
// and a boolean to check if the value has been set.
func (o *SimpleAgent) GetNetworkProviderInfoOk() (*NetworkProviderInfo, bool) {
	if o == nil || utils.IsNil(o.NetworkProviderInfo) {
		return nil, false
	}
...
func (o *SimpleAgent) SetNetworkProviderInfo(v NetworkProviderInfo) {
