...
func TestFTPServerInstantTestsAPIService_CreateFtpServerInstantTest(t *testing.T) {
	...
	var requestBody FtpServerInstantTestRequest
	...
	var expectedResponse FtpServerInstantTestResponse
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		expectedPath := "/tests/ftp-server/instant"
		...
		var receivedBody FtpServerInstantTestRequest
	...
	api := (*FTPServerInstantTestsAPIService)(&apiClient.Common)

	actualResponse, httpResponse, err := api.CreateFtpServerInstantTest().FtpServerInstantTestRequest(requestBody).Aid(aid).Expand(expand).Execute()
	if err != nil {
		t.Fatalf("CreateFtpServerInstantTest() error = %v", err)
	}
	if httpResponse == nil {
		t.Fatal("CreateFtpServerInstantTest() returned a nil HTTP response")
	}
	if httpResponse.StatusCode != responseStatus {
		t.Errorf("CreateFtpServerInstantTest() status = %d, want %d", httpResponse.StatusCode, responseStatus)
	}
	expected := &expectedResponse
	if !reflect.DeepEqual(actualResponse, expected) {
		t.Errorf("CreateFtpServerInstantTest() response = %#v, want %#v", actualResponse, expected)
	}
}

func TestFTPServerInstantTestsAPIService_CreateFtpServerInstantTest_Errors(t *testing.T) {
	const testToken = "test-token"
	...
	runErrorCase := func(
		...
		_, httpResponse, err := api.CreateFtpServerInstantTest().FtpServerInstantTestRequest(requestBody).Aid(aid).Expand(expand).Execute()
		if err == nil {
			t.Fatalf("CreateFtpServerInstantTest() error = nil, want *GenericAPIError")
		}
		if httpResponse == nil {
			t.Fatal("CreateFtpServerInstantTest() returned a nil HTTP response")
		}
		...
		if !errors.As(err, &apiError) {
			t.Fatalf("CreateFtpServerInstantTest() error type = %T, want *GenericAPIError", err)
		}
