...
func NewFtpServerInstantTest(requestType FtpServerRequestType, url string, username string) *FtpServerInstantTest {
...
func (o *FtpServerInstantTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *FtpServerInstantTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *FtpServerInstantTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *FtpServerInstantTest) SetTags(v []TestTag) {
	o.Tags = v
}
...
func (o *FtpServerInstantTest) HasPassword() bool {
	if o != nil && !utils.IsNil(o.Password) {
		return true
	}
