...
func (o *DnsServerInstantTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *DnsServerInstantTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *DnsServerInstantTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *DnsServerInstantTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}
