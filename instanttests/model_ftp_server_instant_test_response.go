...
func NewFtpServerInstantTestResponse(requestType FtpServerRequestType, url string, username string) *FtpServerInstantTestResponse {
...
func (o *FtpServerInstantTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *FtpServerInstantTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *FtpServerInstantTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *FtpServerInstantTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}
...
func (o *FtpServerInstantTestResponse) HasPassword() bool {
	if o != nil && !utils.IsNil(o.Password) {
		return true
	}
...
func (o *FtpServerInstantTestResponse) GetAgents() []TestAgentResponse {
...
// and a boolean to check if the value has been set.
func (o *FtpServerInstantTestResponse) GetAgentsOk() ([]TestAgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *FtpServerInstantTestResponse) SetAgents(v []TestAgentResponse) {
	o.Agents = v
}
