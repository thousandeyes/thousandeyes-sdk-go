...
func (o *ApiRequest) GetVerifyCertificate() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiRequest) GetVerifyCertificateOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.VerifyCertificate) {
		return nil, false
	}
...
func (o *ApiRequest) HasVerifyCertificate() bool {
	if o != nil && !utils.IsNil(o.VerifyCertificate) {
		return true
	}
...
func (o *ApiRequest) SetVerifyCertificate(v bool) {
