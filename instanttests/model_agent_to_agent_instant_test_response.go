...
func (o *AgentToAgentInstantTestResponse) GetAgents() []AgentResponse {
...
// and a boolean to check if the value has been set.
func (o *AgentToAgentInstantTestResponse) GetAgentsOk() ([]AgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *AgentToAgentInstantTestResponse) SetAgents(v []AgentResponse) {
	o.Agents = v
}
