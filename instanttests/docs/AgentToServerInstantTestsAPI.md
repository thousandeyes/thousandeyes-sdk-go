...
func main() {
	agentToServerInstantTestRequest := *instanttests.NewAgentToServerInstantTestRequest("www.thousandeyes.com:80", []instanttests.TestAgentWithSourceIpAddress{*instanttests.NewTestAgentWithSourceIpAddress()}) // AgentToServerInstantTestRequest | 
