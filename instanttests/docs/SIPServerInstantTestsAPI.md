...
func main() {
	sipServerInstantTestRequest := *instanttests.NewSipServerInstantTestRequest([]instanttests.TestAgentWithSourceIpAddress{*instanttests.NewTestAgentWithSourceIpAddress()}, *instanttests.NewTestSipCredentials(int32(49153))) // SipServerInstantTestRequest | 
