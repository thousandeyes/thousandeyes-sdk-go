...
func main() {
	agentToAgentInstantTestRequest := *instanttests.NewAgentToAgentInstantTestRequest("2954", []instanttests.TestAgentWithSourceIpAddress{*instanttests.NewTestAgentWithSourceIpAddress()}) // AgentToAgentInstantTestRequest | 
