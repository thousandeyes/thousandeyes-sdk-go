...
func main() {
	ftpServerInstantTestRequest := *instanttests.NewFtpServerInstantTestRequest("password", instanttests.FtpServerRequestType("download"), "www.thousandeyes.com", "username", []instanttests.TestAgentWithSourceIpAddress{*instanttests.NewTestAgentWithSourceIpAddress()}) // FtpServerInstantTestRequest | 
