...
func main() {
	voiceInstantTestRequest := *instanttests.NewVoiceInstantTestRequest("281474976710706", []instanttests.TestAgentWithSourceIpAddress{*instanttests.NewTestAgentWithSourceIpAddress()}) // VoiceInstantTestRequest | 
