...
func (r ApiGetTestDnsSecResultsRequest) ExecuteContext(ctx context.Context) (*DnssecTestResults, *http.Response, error) {
	r.ctx = ctx
	return r.Execute()
}

func (r ApiGetTestDnsSecResultsRequest) Paginated() *pagination.Pager[DnssecTestResults] {
	return pagination.NewPager(
		r.cursor,
		func(ctx context.Context, cursor *string) (*DnssecTestResults, *http.Response, error) {
			pageRequest := r
			if cursor != nil {
		...
		func(page *DnssecTestResults) (string, bool) {
			if page == nil {
				return "", false
			}
...
func (r ApiGetTestDnsSecResultsRequest) All(ctx context.Context) iter.Seq2[DnssecTestResult, error] {
	return pagination.All(ctx, r.Paginated(), (*DnssecTestResults).GetResults)
}
