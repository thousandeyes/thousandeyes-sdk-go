...
> ApiDetailTestResults GetTestApiAgentRoundResults(testId, agentId, roundId).Aid(aid).Execute()
...
func main() {
	...
	resp, r, err := api.GetTestApiAgentRoundResults(testId, agentId, roundId).Aid(aid).Execute()
	if err != nil {
