...
> PageLoadDetailTestResults GetTestPageLoadAgentRoundResults(testIdagentIdroundId).Aid(aid).Execute()
...
func main() {
	...
	resp, r, err := api.GetTestPageLoadAgentRoundResults(testIdagentIdroundId).Aid(aid).Execute()
	if err != nil {
