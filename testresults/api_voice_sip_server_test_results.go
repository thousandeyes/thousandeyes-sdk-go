...
// VoiceSIPServerTestResultsAPIService VoiceSIPServerTestResultsAPI service
type VoiceSIPServerTestResultsAPIService client.Service

type ApiGetTestSipServerResultsRequest struct {

	ApiService *VoiceSIPServerTestResultsAPIService
	testId string
	aid *string
	window *string
	startDate *time.Time
...
func (r ApiGetTestSipServerResultsRequest) Aid(aid string) ApiGetTestSipServerResultsRequest {
	r.aid = &aid
	return r
}
...
func (r ApiGetTestSipServerResultsRequest) Window(window string) ApiGetTestSipServerResultsRequest {
	r.window = &window
	return r
}
...
func (r ApiGetTestSipServerResultsRequest) StartDate(startDate time.Time) ApiGetTestSipServerResultsRequest {
...
func (r ApiGetTestSipServerResultsRequest) EndDate(endDate time.Time) ApiGetTestSipServerResultsRequest {
	r.endDate = &endDate
	return r
}

// (Optional) Opaque cursor used for pagination. Clients should use &#x60;next&#x60; value from &#x60;_links&#x60; instead of this parameter.
func (r ApiGetTestSipServerResultsRequest) Cursor(cursor string) ApiGetTestSipServerResultsRequest {
	r.cursor = &cursor
	return r
}

func (r ApiGetTestSipServerResultsRequest) Execute() (*SipServerTestResults, *http.Response, error) {
	return r.ApiService.GetTestSipServerResultsExecute(r)
}

func (r ApiGetTestSipServerResultsRequest) ExecuteContext(ctx context.Context) (*SipServerTestResults, *http.Response, error) {
	r.ctx = ctx
	return r.Execute()
}

func (r ApiGetTestSipServerResultsRequest) Paginated() *pagination.Pager[SipServerTestResults] {
	return pagination.NewPager(
		r.cursor,
		func(ctx context.Context, cursor *string) (*SipServerTestResults, *http.Response, error) {
			pageRequest := r
			if cursor != nil {
		...
		func(page *SipServerTestResults) (string, bool) {
			if page == nil {
				return "", false
			}
...
func (r ApiGetTestSipServerResultsRequest) All(ctx context.Context) iter.Seq2[SipServerTestResult, error] {
	return pagination.All(ctx, r.Paginated(), (*SipServerTestResults).GetResults)
}
...
Returns Voice SIP server test results. If no window, start time, or end time is specified, data for the most recent round is returned. If a window or start time is specified, the results might include a round that started just before the specified start time.
 ...
 @return ApiGetTestSipServerResultsRequest
*/
func (a *VoiceSIPServerTestResultsAPIService) GetTestSipServerResults(testId string ) ApiGetTestSipServerResultsRequest {
	return ApiGetTestSipServerResultsRequest{
		ApiService: a,
		testId: testId,
	}
...
func (a *VoiceSIPServerTestResultsAPIService) GetTestSipServerResultsExecute(r ApiGetTestSipServerResultsRequest) (*SipServerTestResults, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarReturnValue  *SipServerTestResults
	)

	localBasePath := a.Client.GetConfig().ServerURL

	localVarPath := localBasePath + "/test-results/{testId}/sip-server"
