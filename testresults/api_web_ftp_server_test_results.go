...
// WebFTPServerTestResultsAPIService WebFTPServerTestResultsAPI service
type WebFTPServerTestResultsAPIService client.Service

type ApiGetTestFtpServerResultsRequest struct {

	ApiService *WebFTPServerTestResultsAPIService
	testId string
	aid *string
	window *string
	startDate *time.Time
...
func (r ApiGetTestFtpServerResultsRequest) Aid(aid string) ApiGetTestFtpServerResultsRequest {
	r.aid = &aid
	return r
}
...
func (r ApiGetTestFtpServerResultsRequest) Window(window string) ApiGetTestFtpServerResultsRequest {
	r.window = &window
	return r
}
...
func (r ApiGetTestFtpServerResultsRequest) StartDate(startDate time.Time) ApiGetTestFtpServerResultsRequest {
...
func (r ApiGetTestFtpServerResultsRequest) EndDate(endDate time.Time) ApiGetTestFtpServerResultsRequest {
	r.endDate = &endDate
	return r
}

// (Optional) Opaque cursor used for pagination. Clients should use &#x60;next&#x60; value from &#x60;_links&#x60; instead of this parameter.
func (r ApiGetTestFtpServerResultsRequest) Cursor(cursor string) ApiGetTestFtpServerResultsRequest {
	r.cursor = &cursor
	return r
}

func (r ApiGetTestFtpServerResultsRequest) Execute() (*FtpServerTestResults, *http.Response, error) {
	return r.ApiService.GetTestFtpServerResultsExecute(r)
}

func (r ApiGetTestFtpServerResultsRequest) ExecuteContext(ctx context.Context) (*FtpServerTestResults, *http.Response, error) {
	r.ctx = ctx
	return r.Execute()
}

func (r ApiGetTestFtpServerResultsRequest) Paginated() *pagination.Pager[FtpServerTestResults] {
	return pagination.NewPager(
		r.cursor,
		func(ctx context.Context, cursor *string) (*FtpServerTestResults, *http.Response, error) {
			pageRequest := r
			if cursor != nil {
		...
		func(page *FtpServerTestResults) (string, bool) {
			if page == nil {
				return "", false
			}
...
func (r ApiGetTestFtpServerResultsRequest) All(ctx context.Context) iter.Seq2[FtpServerTestResult, error] {
	return pagination.All(ctx, r.Paginated(), (*FtpServerTestResults).GetResults)
}
...
Returns test results for FTP server requests. If no window, start time, or end time is specified, data for the most recent round is returned. If a window or start time is specified, the results might include a round that started just before the specified start time.
 ...
 @return ApiGetTestFtpServerResultsRequest
*/
func (a *WebFTPServerTestResultsAPIService) GetTestFtpServerResults(testId string ) ApiGetTestFtpServerResultsRequest {
	return ApiGetTestFtpServerResultsRequest{
		ApiService: a,
		testId: testId,
	}
...
func (a *WebFTPServerTestResultsAPIService) GetTestFtpServerResultsExecute(r ApiGetTestFtpServerResultsRequest) (*FtpServerTestResults, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarReturnValue  *FtpServerTestResults
	)

	localBasePath := a.Client.GetConfig().ServerURL

	localVarPath := localBasePath + "/test-results/{testId}/ftp-server"
