...
// DNSTraceTestResultsAPIService DNSTraceTestResultsAPI service
type DNSTraceTestResultsAPIService client.Service

type ApiGetTestDnsTraceResultsRequest struct {

	ApiService *DNSTraceTestResultsAPIService
	testId string
	aid *string
	window *string
	startDate *time.Time
...
func (r ApiGetTestDnsTraceResultsRequest) Aid(aid string) ApiGetTestDnsTraceResultsRequest {
	r.aid = &aid
	return r
}
...
func (r ApiGetTestDnsTraceResultsRequest) Window(window string) ApiGetTestDnsTraceResultsRequest {
	r.window = &window
	return r
}
...
func (r ApiGetTestDnsTraceResultsRequest) StartDate(startDate time.Time) ApiGetTestDnsTraceResultsRequest {
...
func (r ApiGetTestDnsTraceResultsRequest) EndDate(endDate time.Time) ApiGetTestDnsTraceResultsRequest {
	r.endDate = &endDate
	return r
}

// (Optional) Opaque cursor used for pagination. Clients should use &#x60;next&#x60; value from &#x60;_links&#x60; instead of this parameter.
func (r ApiGetTestDnsTraceResultsRequest) Cursor(cursor string) ApiGetTestDnsTraceResultsRequest {
	r.cursor = &cursor
	return r
}

func (r ApiGetTestDnsTraceResultsRequest) Execute() (*DnsTraceTestResults, *http.Response, error) {
	return r.ApiService.GetTestDnsTraceResultsExecute(r)
}

func (r ApiGetTestDnsTraceResultsRequest) ExecuteContext(ctx context.Context) (*DnsTraceTestResults, *http.Response, error) {
	r.ctx = ctx
	return r.Execute()
}

func (r ApiGetTestDnsTraceResultsRequest) Paginated() *pagination.Pager[DnsTraceTestResults] {
	return pagination.NewPager(
		r.cursor,
		func(ctx context.Context, cursor *string) (*DnsTraceTestResults, *http.Response, error) {
			pageRequest := r
			if cursor != nil {
		...
		func(page *DnsTraceTestResults) (string, bool) {
			if page == nil {
				return "", false
			}
...
func (r ApiGetTestDnsTraceResultsRequest) All(ctx context.Context) iter.Seq2[DnsTraceTestResult, error] {
	return pagination.All(ctx, r.Paginated(), (*DnsTraceTestResults).GetResults)
}
...
Returns a DNS record from the requesting agent's point of view. This is similar to dig +trace.
 ...
 @return ApiGetTestDnsTraceResultsRequest
*/
func (a *DNSTraceTestResultsAPIService) GetTestDnsTraceResults(testId string ) ApiGetTestDnsTraceResultsRequest {
	return ApiGetTestDnsTraceResultsRequest{
		ApiService: a,
		testId: testId,
	}
...
func (a *DNSTraceTestResultsAPIService) GetTestDnsTraceResultsExecute(r ApiGetTestDnsTraceResultsRequest) (*DnsTraceTestResults, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarReturnValue  *DnsTraceTestResults
	)

	localBasePath := a.Client.GetConfig().ServerURL

	localVarPath := localBasePath + "/test-results/{testId}/dns-trace"
