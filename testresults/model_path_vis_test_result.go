...
// checks if the PathVisTestResult type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PathVisTestResult{}

// PathVisTestResult struct for PathVisTestResult
...
// NewPathVisTestResult instantiates a new PathVisTestResult object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPathVisTestResult() *PathVisTestResult {
	this := PathVisTestResult{}
	return &this
}

// NewPathVisTestResultWithDefaults instantiates a new PathVisTestResult object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPathVisTestResultWithDefaults() *PathVisTestResult {
	this := PathVisTestResult{}
	return &this
}

// GetDate returns the Date field value if set, zero value otherwise.
func (o *PathVisTestResult) GetDate() time.Time {
...
func (o *PathVisTestResult) GetDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.Date) {
		return nil, false
	}
	return o.Date, true
...
func (o *PathVisTestResult) HasDate() bool {
	if o != nil && !utils.IsNil(o.Date) {
		return true
	}
...
func (o *PathVisTestResult) SetDate(v time.Time) {
	o.Date = &v
}

// GetRoundId returns the RoundId field value if set, zero value otherwise.
func (o *PathVisTestResult) GetRoundId() int32 {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetRoundIdOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.RoundId) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasRoundId() bool {
	if o != nil && !utils.IsNil(o.RoundId) {
		return true
	}
...
func (o *PathVisTestResult) SetRoundId(v int32) {
	o.RoundId = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *PathVisTestResult) GetLinks() TestResultAppLinks {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetLinksOk() (*TestResultAppLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PathVisTestResult) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *PathVisTestResult) SetLinks(v TestResultAppLinks) {
	o.Links = &v
}

// GetStartTime returns the StartTime field value if set, zero value otherwise.
func (o *PathVisTestResult) GetStartTime() int32 {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetStartTimeOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.StartTime) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasStartTime() bool {
	if o != nil && !utils.IsNil(o.StartTime) {
		return true
	}
...
func (o *PathVisTestResult) SetStartTime(v int32) {
	o.StartTime = &v
}

// GetEndTime returns the EndTime field value if set, zero value otherwise.
func (o *PathVisTestResult) GetEndTime() int32 {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetEndTimeOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.EndTime) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasEndTime() bool {
	if o != nil && !utils.IsNil(o.EndTime) {
		return true
	}
...
func (o *PathVisTestResult) SetEndTime(v int32) {
	o.EndTime = &v
}

// GetAgent returns the Agent field value if set, zero value otherwise.
func (o *PathVisTestResult) GetAgent() TestResultAgent {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetAgentOk() (*TestResultAgent, bool) {
	if o == nil || utils.IsNil(o.Agent) {
		return nil, false
	}
	return o.Agent, true
...
func (o *PathVisTestResult) HasAgent() bool {
	if o != nil && !utils.IsNil(o.Agent) {
		return true
	}
...
func (o *PathVisTestResult) SetAgent(v TestResultAgent) {
	o.Agent = &v
}

// GetServer returns the Server field value if set, zero value otherwise.
func (o *PathVisTestResult) GetServer() string {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetServerOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Server) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasServer() bool {
	if o != nil && !utils.IsNil(o.Server) {
		return true
	}
...
func (o *PathVisTestResult) SetServer(v string) {
	o.Server = &v
}

// GetServerIp returns the ServerIp field value if set, zero value otherwise.
func (o *PathVisTestResult) GetServerIp() string {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetServerIpOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ServerIp) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasServerIp() bool {
	if o != nil && !utils.IsNil(o.ServerIp) {
		return true
	}
...
func (o *PathVisTestResult) SetServerIp(v string) {
	o.ServerIp = &v
}

// GetSourceIp returns the SourceIp field value if set, zero value otherwise.
func (o *PathVisTestResult) GetSourceIp() string {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetSourceIpOk() (*string, bool) {
	if o == nil || utils.IsNil(o.SourceIp) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasSourceIp() bool {
	if o != nil && !utils.IsNil(o.SourceIp) {
		return true
	}
...
func (o *PathVisTestResult) SetSourceIp(v string) {
	o.SourceIp = &v
}

// GetSourcePrefix returns the SourcePrefix field value if set, zero value otherwise.
func (o *PathVisTestResult) GetSourcePrefix() string {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetSourcePrefixOk() (*string, bool) {
	if o == nil || utils.IsNil(o.SourcePrefix) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasSourcePrefix() bool {
	if o != nil && !utils.IsNil(o.SourcePrefix) {
		return true
	}
...
func (o *PathVisTestResult) SetSourcePrefix(v string) {
	o.SourcePrefix = &v
}

// GetTargetIsProxy returns the TargetIsProxy field value if set, zero value otherwise.
func (o *PathVisTestResult) GetTargetIsProxy() bool {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetTargetIsProxyOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.TargetIsProxy) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasTargetIsProxy() bool {
	if o != nil && !utils.IsNil(o.TargetIsProxy) {
		return true
	}
...
func (o *PathVisTestResult) SetTargetIsProxy(v bool) {
	o.TargetIsProxy = &v
}

// GetDirection returns the Direction field value if set, zero value otherwise.
func (o *PathVisTestResult) GetDirection() PathVisDirection {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetDirectionOk() (*PathVisDirection, bool) {
	if o == nil || utils.IsNil(o.Direction) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasDirection() bool {
	if o != nil && !utils.IsNil(o.Direction) {
		return true
	}
...
func (o *PathVisTestResult) SetDirection(v PathVisDirection) {
	o.Direction = &v
}

// GetPathTraces returns the PathTraces field value if set, zero value otherwise.
func (o *PathVisTestResult) GetPathTraces() []PathTrace {
...
// and a boolean to check if the value has been set.
func (o *PathVisTestResult) GetPathTracesOk() ([]PathTrace, bool) {
	if o == nil || utils.IsNil(o.PathTraces) {
		return nil, false
	}
...
func (o *PathVisTestResult) HasPathTraces() bool {
	if o != nil && !utils.IsNil(o.PathTraces) {
		return true
	}
...
// SetPathTraces gets a reference to the given []PathTrace and assigns it to the PathTraces field.
func (o *PathVisTestResult) SetPathTraces(v []PathTrace) {
	o.PathTraces = v
}

func (o PathVisTestResult) MarshalJSON() ([]byte, error) {
...
func (o PathVisTestResult) ToMap() (map[string]interface{}, error) {
...
type NullablePathVisTestResult struct {
	value *PathVisTestResult
	isSet bool
}

func (v NullablePathVisTestResult) Get() *PathVisTestResult {
	return v.value
}

func (v *NullablePathVisTestResult) Set(val *PathVisTestResult) {
	v.value = val
	v.isSet = true
}

func (v NullablePathVisTestResult) IsSet() bool {
	return v.isSet
}

func (v *NullablePathVisTestResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePathVisTestResult(val *PathVisTestResult) *NullablePathVisTestResult {
	return &NullablePathVisTestResult{value: val, isSet: true}
}

func (v NullablePathVisTestResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePathVisTestResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
