...
func (r ApiGetTestRtpServerResultsRequest) ExecuteContext(ctx context.Context) (*RtpStreamTestResults, *http.Response, error) {
	r.ctx = ctx
	return r.Execute()
}

func (r ApiGetTestRtpServerResultsRequest) Paginated() *pagination.Pager[RtpStreamTestResults] {
	return pagination.NewPager(
		r.cursor,
		func(ctx context.Context, cursor *string) (*RtpStreamTestResults, *http.Response, error) {
			pageRequest := r
			if cursor != nil {
		...
		func(page *RtpStreamTestResults) (string, bool) {
			if page == nil {
				return "", false
			}
...
func (r ApiGetTestRtpServerResultsRequest) All(ctx context.Context) iter.Seq2[RtpStreamTestResult, error] {
	return pagination.All(ctx, r.Paginated(), (*RtpStreamTestResults).GetResults)
}
