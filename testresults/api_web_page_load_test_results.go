...
func (r ApiGetTestPageLoadResultsRequest) ExecuteContext(ctx context.Context) (*PageLoadTestResults, *http.Response, error) {
	r.ctx = ctx
	return r.Execute()
}

func (r ApiGetTestPageLoadResultsRequest) Paginated() *pagination.Pager[PageLoadTestResults] {
	return pagination.NewPager(
		r.cursor,
		func(ctx context.Context, cursor *string) (*PageLoadTestResults, *http.Response, error) {
			pageRequest := r
			if cursor != nil {
		...
		func(page *PageLoadTestResults) (string, bool) {
			if page == nil {
				return "", false
			}
...
func (r ApiGetTestPageLoadResultsRequest) All(ctx context.Context) iter.Seq2[PageLoadTestResult, error] {
	return pagination.All(ctx, r.Paginated(), (*PageLoadTestResults).GetResults)
}
