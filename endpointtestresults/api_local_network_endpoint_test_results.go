...
func (r ApiFilterLocalNetworksTestResultsTopologiesRequest) All(ctx context.Context) iter.Seq2[LocalNetworkTopologyResultBase, error] {
	return pagination.All(ctx, r.Paginated(), (*LocalNetworkTopologyResults).GetResults)
}
