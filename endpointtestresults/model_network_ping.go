...
// checks if the NetworkPing type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &NetworkPing{}

// NetworkPing struct for NetworkPing
...
// NewNetworkPing instantiates a new NetworkPing object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNetworkPing() *NetworkPing {
	this := NetworkPing{}
	return &this
}

// NewNetworkPingWithDefaults instantiates a new NetworkPing object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNetworkPingWithDefaults() *NetworkPing {
	this := NetworkPing{}
	return &this
}

// GetAvgRtt returns the AvgRtt field value if set, zero value otherwise.
func (o *NetworkPing) GetAvgRtt() int32 {
...
func (o *NetworkPing) GetAvgRttOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.AvgRtt) {
		return nil, false
	}
...
func (o *NetworkPing) HasAvgRtt() bool {
	if o != nil && !utils.IsNil(o.AvgRtt) {
		return true
	}
...
func (o *NetworkPing) SetAvgRtt(v int32) {
	o.AvgRtt = &v
}

// GetMaxRtt returns the MaxRtt field value if set, zero value otherwise.
func (o *NetworkPing) GetMaxRtt() int32 {
...
// and a boolean to check if the value has been set.
func (o *NetworkPing) GetMaxRttOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.MaxRtt) {
		return nil, false
	}
...
func (o *NetworkPing) HasMaxRtt() bool {
	if o != nil && !utils.IsNil(o.MaxRtt) {
		return true
	}
...
func (o *NetworkPing) SetMaxRtt(v int32) {
	o.MaxRtt = &v
}

// GetLoss returns the Loss field value if set, zero value otherwise.
func (o *NetworkPing) GetLoss() float64 {
...
// and a boolean to check if the value has been set.
func (o *NetworkPing) GetLossOk() (*float64, bool) {
	if o == nil || utils.IsNil(o.Loss) {
		return nil, false
	}
	return o.Loss, true
...
func (o *NetworkPing) HasLoss() bool {
	if o != nil && !utils.IsNil(o.Loss) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *NetworkPing) GetMeanDevRttOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.MeanDevRtt) {
		return nil, false
	}
...
func (o *NetworkPing) HasMeanDevRtt() bool {
	if o != nil && !utils.IsNil(o.MeanDevRtt) {
		return true
	}
...
func (o *NetworkPing) SetMeanDevRtt(v int32) {
	o.MeanDevRtt = &v
}

// GetMinRtt returns the MinRtt field value if set, zero value otherwise.
func (o *NetworkPing) GetMinRtt() int32 {
...
// and a boolean to check if the value has been set.
func (o *NetworkPing) GetMinRttOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.MinRtt) {
		return nil, false
	}
...
func (o *NetworkPing) HasMinRtt() bool {
	if o != nil && !utils.IsNil(o.MinRtt) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *NetworkPing) GetPktsReceivedOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.PktsReceived) {
		return nil, false
	}
...
func (o *NetworkPing) HasPktsReceived() bool {
	if o != nil && !utils.IsNil(o.PktsReceived) {
		return true
	}
...
func (o *NetworkPing) SetPktsReceived(v int32) {
	o.PktsReceived = &v
}

// GetPktsSent returns the PktsSent field value if set, zero value otherwise.
func (o *NetworkPing) GetPktsSent() int32 {
...
// and a boolean to check if the value has been set.
func (o *NetworkPing) GetPktsSentOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.PktsSent) {
		return nil, false
	}
...
func (o *NetworkPing) HasPktsSent() bool {
	if o != nil && !utils.IsNil(o.PktsSent) {
		return true
	}
...
func (o *NetworkPing) SetPktsSent(v int32) {
	o.PktsSent = &v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *NetworkPing) GetError() string {
...
// and a boolean to check if the value has been set.
func (o *NetworkPing) GetErrorOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *NetworkPing) HasError() bool {
	if o != nil && !utils.IsNil(o.Error) {
		return true
	}
...
func (o *NetworkPing) SetError(v string) {
	o.Error = &v
}

// GetInfoFlags returns the InfoFlags field value if set, zero value otherwise.
func (o *NetworkPing) GetInfoFlags() []string {
...
// and a boolean to check if the value has been set.
func (o *NetworkPing) GetInfoFlagsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.InfoFlags) {
		return nil, false
	}
...
func (o *NetworkPing) HasInfoFlags() bool {
	if o != nil && !utils.IsNil(o.InfoFlags) {
		return true
	}
...
func (o *NetworkPing) SetInfoFlags(v []string) {
	o.InfoFlags = v
}

func (o NetworkPing) MarshalJSON() ([]byte, error) {
...
func (o NetworkPing) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkPing struct {
	value *NetworkPing
	isSet bool
}

func (v NullableNetworkPing) Get() *NetworkPing {
	return v.value
}

func (v *NullableNetworkPing) Set(val *NetworkPing) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkPing) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkPing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkPing(val *NetworkPing) *NullableNetworkPing {
	return &NullableNetworkPing{value: val, isSet: true}
}

func (v NullableNetworkPing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkPing) UnmarshalJSON(src []byte) error {
	v.isSet = true
