...
func (o *EndpointResultRequestFilter) GetNicModel() []string {
...
// and a boolean to check if the value has been set.
func (o *EndpointResultRequestFilter) GetNicModelOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.NicModel) {
		return nil, false
	}
...
func (o *EndpointResultRequestFilter) HasNicModel() bool {
	if o != nil && !utils.IsNil(o.NicModel) {
		return true
	}
...
func (o *EndpointResultRequestFilter) SetNicModel(v []string) {
	o.NicModel = v
}

// GetNicDriverVersion returns the NicDriverVersion field value if set, zero value otherwise.
func (o *EndpointResultRequestFilter) GetNicDriverVersion() []string {
...
// and a boolean to check if the value has been set.
func (o *EndpointResultRequestFilter) GetNicDriverVersionOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.NicDriverVersion) {
		return nil, false
	}
...
func (o *EndpointResultRequestFilter) HasNicDriverVersion() bool {
	if o != nil && !utils.IsNil(o.NicDriverVersion) {
		return true
	}
...
func (o *EndpointResultRequestFilter) SetNicDriverVersion(v []string) {
