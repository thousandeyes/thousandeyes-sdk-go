...
func (o *EndpointNetworkTopologyResultRequest) GetThresholdFilter() EndpointNetworkTopologyThresholdFilter {
	if o == nil || utils.IsNil(o.ThresholdFilter) {
		var ret EndpointNetworkTopologyThresholdFilter
		return ret
	}
...
func (o *EndpointNetworkTopologyResultRequest) GetThresholdFilterOk() (*EndpointNetworkTopologyThresholdFilter, bool) {
	if o == nil || utils.IsNil(o.ThresholdFilter) {
		return nil, false
	}
...
func (o *EndpointNetworkTopologyResultRequest) HasThresholdFilter() bool {
	if o != nil && !utils.IsNil(o.ThresholdFilter) {
		return true
	}
...
// SetThresholdFilter gets a reference to the given EndpointNetworkTopologyThresholdFilter and assigns it to the ThresholdFilter field.
func (o *EndpointNetworkTopologyResultRequest) SetThresholdFilter(v EndpointNetworkTopologyThresholdFilter) {
	o.ThresholdFilter = &v
}
