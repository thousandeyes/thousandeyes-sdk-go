...
func (o *NetworkDynamicEndpointTestResult) GetUserProfile() UserProfile {
...
// and a boolean to check if the value has been set.
func (o *NetworkDynamicEndpointTestResult) GetUserProfileOk() (*UserProfile, bool) {
	if o == nil || utils.IsNil(o.UserProfile) {
		return nil, false
	}
...
func (o *NetworkDynamicEndpointTestResult) HasUserProfile() bool {
	if o != nil && !utils.IsNil(o.UserProfile) {
		return true
	}
...
func (o *NetworkDynamicEndpointTestResult) SetUserProfile(v UserProfile) {
	o.UserProfile = &v
}
...
func (o *NetworkDynamicEndpointTestResult) GetBatteryMetrics() BatteryMetrics {
...
// and a boolean to check if the value has been set.
func (o *NetworkDynamicEndpointTestResult) GetBatteryMetricsOk() (*BatteryMetrics, bool) {
	if o == nil || utils.IsNil(o.BatteryMetrics) {
		return nil, false
	}
...
func (o *NetworkDynamicEndpointTestResult) HasBatteryMetrics() bool {
	if o != nil && !utils.IsNil(o.BatteryMetrics) {
		return true
	}
...
func (o *NetworkDynamicEndpointTestResult) SetBatteryMetrics(v BatteryMetrics) {
	o.BatteryMetrics = &v
}

// GetCellularProfile returns the CellularProfile field value if set, zero value otherwise.
func (o *NetworkDynamicEndpointTestResult) GetCellularProfile() CellularProfile {
...
// and a boolean to check if the value has been set.
func (o *NetworkDynamicEndpointTestResult) GetCellularProfileOk() (*CellularProfile, bool) {
	if o == nil || utils.IsNil(o.CellularProfile) {
		return nil, false
	}
...
func (o *NetworkDynamicEndpointTestResult) HasCellularProfile() bool {
	if o != nil && !utils.IsNil(o.CellularProfile) {
		return true
	}
...
func (o *NetworkDynamicEndpointTestResult) SetCellularProfile(v CellularProfile) {
	o.CellularProfile = &v
}

// GetPlatform returns the Platform field value if set, zero value otherwise.
func (o *NetworkDynamicEndpointTestResult) GetPlatform() Platform {
...
// and a boolean to check if the value has been set.
func (o *NetworkDynamicEndpointTestResult) GetPlatformOk() (*Platform, bool) {
	if o == nil || utils.IsNil(o.Platform) {
		return nil, false
	}
...
func (o *NetworkDynamicEndpointTestResult) HasPlatform() bool {
	if o != nil && !utils.IsNil(o.Platform) {
		return true
	}
...
func (o *NetworkDynamicEndpointTestResult) SetPlatform(v Platform) {
	o.Platform = &v
}
...
func (o *NetworkDynamicEndpointTestResult) GetScore() EndpointPingDataPointScore {
	if o == nil || utils.IsNil(o.Score) {
		var ret EndpointPingDataPointScore
		return ret
	}
	return *o.Score
}
...
// and a boolean to check if the value has been set.
func (o *NetworkDynamicEndpointTestResult) GetScoreOk() (*EndpointPingDataPointScore, bool) {
	if o == nil || utils.IsNil(o.Score) {
		return nil, false
	}
	return o.Score, true
...
func (o *NetworkDynamicEndpointTestResult) HasScore() bool {
	if o != nil && !utils.IsNil(o.Score) {
		return true
	}
...
// SetScore gets a reference to the given EndpointPingDataPointScore and assigns it to the Score field.
func (o *NetworkDynamicEndpointTestResult) SetScore(v EndpointPingDataPointScore) {
	o.Score = &v
}

// GetZtaMetrics returns the ZtaMetrics field value if set, zero value otherwise.
func (o *NetworkDynamicEndpointTestResult) GetZtaMetrics() []EndpointZtaMetrics {
	if o == nil || utils.IsNil(o.ZtaMetrics) {
		var ret []EndpointZtaMetrics
		return ret
	}
	return o.ZtaMetrics
}

// GetZtaMetricsOk returns a tuple with the ZtaMetrics field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkDynamicEndpointTestResult) GetZtaMetricsOk() ([]EndpointZtaMetrics, bool) {
	if o == nil || utils.IsNil(o.ZtaMetrics) {
		return nil, false
	}
	return o.ZtaMetrics, true
}

// HasZtaMetrics returns a boolean if a field has been set.
func (o *NetworkDynamicEndpointTestResult) HasZtaMetrics() bool {
	if o != nil && !utils.IsNil(o.ZtaMetrics) {
		return true
	}
...
// SetZtaMetrics gets a reference to the given []EndpointZtaMetrics and assigns it to the ZtaMetrics field.
func (o *NetworkDynamicEndpointTestResult) SetZtaMetrics(v []EndpointZtaMetrics) {
	o.ZtaMetrics = v
}
...
func (o NetworkDynamicEndpointTestResult) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.ZtaMetrics) {
		toSerialize["ztaMetrics"] = o.ZtaMetrics
	}
