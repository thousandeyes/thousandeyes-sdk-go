...
func (r ApiFilterScheduledTestNetworkResultsRequest) Expand(expand []ExpandEndpointNetworkOptions) ApiFilterScheduledTestNetworkResultsRequest {
	r.expand = &expand
	return r
}
...
func (r ApiFilterScheduledTestsNetworkResultsRequest) UseAllPermittedAids(useAllPermittedAids bool) ApiFilterScheduledTestsNetworkResultsRequest {
	r.useAllPermittedAids = &useAllPermittedAids
	return r
}

// This parameter is optional and determines whether to expand resources related to test results. By default, no expansion occurs when this query parameter is omitted. To expand a specific resource, such as \&quot;user-profile,\&quot; append &#x60;?expand&#x3D;user-profile&#x60; to the query.
func (r ApiFilterScheduledTestsNetworkResultsRequest) Expand(expand []ExpandEndpointNetworkOptions) ApiFilterScheduledTestsNetworkResultsRequest {
	r.expand = &expand
	return r
}
