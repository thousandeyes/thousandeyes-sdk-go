...
func (o *GatewayNetworkPing) GetLoss() float64 {
...
// and a boolean to check if the value has been set.
func (o *GatewayNetworkPing) GetLossOk() (*float64, bool) {
	if o == nil || utils.IsNil(o.Loss) {
		return nil, false
	}
	return o.Loss, true
...
func (o *GatewayNetworkPing) HasLoss() bool {
	if o != nil && !utils.IsNil(o.Loss) {
		return true
	}
...
func (o *GatewayNetworkPing) SetLoss(v float64) {
	o.Loss = &v
}
