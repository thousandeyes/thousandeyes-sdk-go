...
func (o *MultiTestIdEndpointTestsDataSearchFilter) GetNicModel() []string {
...
// and a boolean to check if the value has been set.
func (o *MultiTestIdEndpointTestsDataSearchFilter) GetNicModelOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.NicModel) {
		return nil, false
	}
...
func (o *MultiTestIdEndpointTestsDataSearchFilter) HasNicModel() bool {
	if o != nil && !utils.IsNil(o.NicModel) {
		return true
	}
...
func (o *MultiTestIdEndpointTestsDataSearchFilter) SetNicModel(v []string) {
	o.NicModel = v
}

// GetNicDriverVersion returns the NicDriverVersion field value if set, zero value otherwise.
func (o *MultiTestIdEndpointTestsDataSearchFilter) GetNicDriverVersion() []string {
...
// and a boolean to check if the value has been set.
func (o *MultiTestIdEndpointTestsDataSearchFilter) GetNicDriverVersionOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.NicDriverVersion) {
		return nil, false
	}
...
func (o *MultiTestIdEndpointTestsDataSearchFilter) HasNicDriverVersion() bool {
	if o != nil && !utils.IsNil(o.NicDriverVersion) {
		return true
	}
...
func (o *MultiTestIdEndpointTestsDataSearchFilter) SetNicDriverVersion(v []string) {
