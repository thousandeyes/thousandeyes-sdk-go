...
func (o *HttpEndpointTestResult) GetUserProfile() UserProfile {
...
// and a boolean to check if the value has been set.
func (o *HttpEndpointTestResult) GetUserProfileOk() (*UserProfile, bool) {
	if o == nil || utils.IsNil(o.UserProfile) {
		return nil, false
	}
...
func (o *HttpEndpointTestResult) HasUserProfile() bool {
	if o != nil && !utils.IsNil(o.UserProfile) {
		return true
	}
...
func (o *HttpEndpointTestResult) SetUserProfile(v UserProfile) {
	o.UserProfile = &v
}
...
func (o *HttpEndpointTestResult) GetBatteryMetrics() BatteryMetrics {
...
// and a boolean to check if the value has been set.
func (o *HttpEndpointTestResult) GetBatteryMetricsOk() (*BatteryMetrics, bool) {
	if o == nil || utils.IsNil(o.BatteryMetrics) {
		return nil, false
	}
...
func (o *HttpEndpointTestResult) HasBatteryMetrics() bool {
	if o != nil && !utils.IsNil(o.BatteryMetrics) {
		return true
	}
...
func (o *HttpEndpointTestResult) SetBatteryMetrics(v BatteryMetrics) {
	o.BatteryMetrics = &v
}

// GetCellularProfile returns the CellularProfile field value if set, zero value otherwise.
func (o *HttpEndpointTestResult) GetCellularProfile() CellularProfile {
...
// and a boolean to check if the value has been set.
func (o *HttpEndpointTestResult) GetCellularProfileOk() (*CellularProfile, bool) {
	if o == nil || utils.IsNil(o.CellularProfile) {
		return nil, false
	}
...
func (o *HttpEndpointTestResult) HasCellularProfile() bool {
	if o != nil && !utils.IsNil(o.CellularProfile) {
		return true
	}
...
func (o *HttpEndpointTestResult) SetCellularProfile(v CellularProfile) {
	o.CellularProfile = &v
}

// GetPlatform returns the Platform field value if set, zero value otherwise.
func (o *HttpEndpointTestResult) GetPlatform() Platform {
...
// and a boolean to check if the value has been set.
func (o *HttpEndpointTestResult) GetPlatformOk() (*Platform, bool) {
	if o == nil || utils.IsNil(o.Platform) {
		return nil, false
	}
...
func (o *HttpEndpointTestResult) HasPlatform() bool {
	if o != nil && !utils.IsNil(o.Platform) {
		return true
	}
...
func (o *HttpEndpointTestResult) SetPlatform(v Platform) {
	o.Platform = &v
}

// GetScore returns the Score field value if set, zero value otherwise.
func (o *HttpEndpointTestResult) GetScore() EndpointHttpDataPointScore {
	if o == nil || utils.IsNil(o.Score) {
		var ret EndpointHttpDataPointScore
		return ret
	}
	return *o.Score
}
...
// and a boolean to check if the value has been set.
func (o *HttpEndpointTestResult) GetScoreOk() (*EndpointHttpDataPointScore, bool) {
	if o == nil || utils.IsNil(o.Score) {
		return nil, false
	}
	return o.Score, true
...
func (o *HttpEndpointTestResult) HasScore() bool {
	if o != nil && !utils.IsNil(o.Score) {
		return true
	}
...
// SetScore gets a reference to the given EndpointHttpDataPointScore and assigns it to the Score field.
func (o *HttpEndpointTestResult) SetScore(v EndpointHttpDataPointScore) {
	o.Score = &v
}
...
func (o *HttpEndpointTestResult) GetThroughput() int32 {
...
// and a boolean to check if the value has been set.
func (o *HttpEndpointTestResult) GetThroughputOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Throughput) {
		return nil, false
	}
...
func (o *HttpEndpointTestResult) HasThroughput() bool {
	if o != nil && !utils.IsNil(o.Throughput) {
		return true
	}
...
func (o *HttpEndpointTestResult) SetThroughput(v int32) {
	o.Throughput = &v
}
