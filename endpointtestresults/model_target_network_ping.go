...
func (o *TargetNetworkPing) GetLoss() float64 {
...
// and a boolean to check if the value has been set.
func (o *TargetNetworkPing) GetLossOk() (*float64, bool) {
	if o == nil || utils.IsNil(o.Loss) {
		return nil, false
	}
	return o.Loss, true
...
func (o *TargetNetworkPing) HasLoss() bool {
	if o != nil && !utils.IsNil(o.Loss) {
		return true
	}
...
func (o *TargetNetworkPing) SetLoss(v float64) {
	o.Loss = &v
}
