...
func (o *RealUserEndpointTestResultRequestFilter) GetNicModel() []string {
...
// and a boolean to check if the value has been set.
func (o *RealUserEndpointTestResultRequestFilter) GetNicModelOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.NicModel) {
		return nil, false
	}
...
func (o *RealUserEndpointTestResultRequestFilter) HasNicModel() bool {
	if o != nil && !utils.IsNil(o.NicModel) {
		return true
	}
...
func (o *RealUserEndpointTestResultRequestFilter) SetNicModel(v []string) {
	o.NicModel = v
}

// GetNicDriverVersion returns the NicDriverVersion field value if set, zero value otherwise.
func (o *RealUserEndpointTestResultRequestFilter) GetNicDriverVersion() []string {
...
// and a boolean to check if the value has been set.
func (o *RealUserEndpointTestResultRequestFilter) GetNicDriverVersionOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.NicDriverVersion) {
		return nil, false
	}
...
func (o *RealUserEndpointTestResultRequestFilter) HasNicDriverVersion() bool {
	if o != nil && !utils.IsNil(o.NicDriverVersion) {
		return true
	}
...
func (o *RealUserEndpointTestResultRequestFilter) SetNicDriverVersion(v []string) {
