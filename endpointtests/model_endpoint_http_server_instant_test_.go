...
func (o *EndpointHttpServerInstantTest) GetTagIds() []string {
...
// and a boolean to check if the value has been set.
func (o *EndpointHttpServerInstantTest) GetTagIdsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.TagIds) {
		return nil, false
	}
...
func (o *EndpointHttpServerInstantTest) HasTagIds() bool {
	if o != nil && !utils.IsNil(o.TagIds) {
		return true
	}
...
func (o *EndpointHttpServerInstantTest) SetTagIds(v []string) {
	o.TagIds = v
}
...
func (o *EndpointHttpServerInstantTest) GetIpVersion() EndpointIpVersionIn {
...
// and a boolean to check if the value has been set.
func (o *EndpointHttpServerInstantTest) GetIpVersionOk() (*EndpointIpVersionIn, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *EndpointHttpServerInstantTest) HasIpVersion() bool {
	if o != nil && !utils.IsNil(o.IpVersion) {
		return true
	}
...
func (o *EndpointHttpServerInstantTest) SetIpVersion(v EndpointIpVersionIn) {
	o.IpVersion = &v
}
...
func (o *EndpointHttpServerInstantTest) GetTcpProbeMode() TestProbeMode {
...
// and a boolean to check if the value has been set.
func (o *EndpointHttpServerInstantTest) GetTcpProbeModeOk() (*TestProbeMode, bool) {
	if o == nil || utils.IsNil(o.TcpProbeMode) {
		return nil, false
	}
...
func (o *EndpointHttpServerInstantTest) SetTcpProbeMode(v TestProbeMode) {
	o.TcpProbeMode = &v
}
