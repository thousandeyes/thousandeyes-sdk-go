...
func (o *EndpointAgentToServerTestRequest) GetIpVersion() EndpointIpVersionIn {
...
// and a boolean to check if the value has been set.
func (o *EndpointAgentToServerTestRequest) GetIpVersionOk() (*EndpointIpVersionIn, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *EndpointAgentToServerTestRequest) HasIpVersion() bool {
	if o != nil && !utils.IsNil(o.IpVersion) {
		return true
	}
...
func (o *EndpointAgentToServerTestRequest) SetIpVersion(v EndpointIpVersionIn) {
	o.IpVersion = &v
}
...
func (o *EndpointAgentToServerTestRequest) HasServerName() bool {
	if o != nil && !utils.IsNil(o.ServerName) {
		return true
	}
...
func (o *EndpointAgentToServerTestRequest) GetServer() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EndpointAgentToServerTestRequest) GetServerOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EndpointAgentToServerTestRequest) SetServer(v string) {
	o.Server = v
}
