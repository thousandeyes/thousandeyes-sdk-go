...
func (o *DynamicTest) GetIsPrioritized() bool {
...
// and a boolean to check if the value has been set.
func (o *DynamicTest) GetIsPrioritizedOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.IsPrioritized) {
		return nil, false
	}
...
func (o *DynamicTest) HasIsPrioritized() bool {
	if o != nil && !utils.IsNil(o.IsPrioritized) {
		return true
	}
...
func (o *DynamicTest) SetIsPrioritized(v bool) {
	o.IsPrioritized = &v
}
...
func (o *DynamicTest) GetIpVersion() string {
...
// and a boolean to check if the value has been set.
func (o *DynamicTest) GetIpVersionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *DynamicTest) SetIpVersion(v string) {
	o.IpVersion = &v
}
