...
func (o *DynamicTestRequest) GetIsPrioritized() bool {
...
// and a boolean to check if the value has been set.
func (o *DynamicTestRequest) GetIsPrioritizedOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.IsPrioritized) {
		return nil, false
	}
...
func (o *DynamicTestRequest) HasIsPrioritized() bool {
	if o != nil && !utils.IsNil(o.IsPrioritized) {
		return true
	}
...
func (o *DynamicTestRequest) SetIsPrioritized(v bool) {
	o.IsPrioritized = &v
}
...
func (o *DynamicTestRequest) GetIpVersion() EndpointIpVersionIn {
...
// and a boolean to check if the value has been set.
func (o *DynamicTestRequest) GetIpVersionOk() (*EndpointIpVersionIn, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *DynamicTestRequest) HasIpVersion() bool {
	if o != nil && !utils.IsNil(o.IpVersion) {
		return true
	}
...
func (o *DynamicTestRequest) SetIpVersion(v EndpointIpVersionIn) {
	o.IpVersion = &v
}
