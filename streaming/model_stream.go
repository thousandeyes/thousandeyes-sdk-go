...
func (o *Stream) GetInputConfig() InputConfig {
...
// and a boolean to check if the value has been set.
func (o *Stream) GetInputConfigOk() (*InputConfig, bool) {
	if o == nil || utils.IsNil(o.InputConfig) {
		return nil, false
	}
...
func (o *Stream) HasInputConfig() bool {
	if o != nil && !utils.IsNil(o.InputConfig) {
		return true
	}
...
func (o *Stream) SetInputConfig(v InputConfig) {
	o.InputConfig = &v
}
...
func (o *Stream) GetEndpointAgentLabel() []EndpointAgentLabel {
...
// and a boolean to check if the value has been set.
func (o *Stream) GetEndpointAgentLabelOk() ([]EndpointAgentLabel, bool) {
	if o == nil || utils.IsNil(o.EndpointAgentLabel) {
		return nil, false
	}
...
func (o *Stream) HasEndpointAgentLabel() bool {
	if o != nil && !utils.IsNil(o.EndpointAgentLabel) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Stream) GetEndpointAgentTagOk() ([]EndpointAgentTag, bool) {
	if o == nil || utils.IsNil(o.EndpointAgentTag) {
		return nil, false
	}
...
func (o *Stream) HasEndpointAgentTag() bool {
	if o != nil && !utils.IsNil(o.EndpointAgentTag) {
		return true
	}
...
func (o *Stream) SetEndpointAgentTag(v []EndpointAgentTag) {
