...
func (o *ExporterConfig) GetAuthorization() ExporterConfigAuthorization {
	if o == nil || utils.IsNil(o.Authorization) {
		var ret ExporterConfigAuthorization
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ExporterConfig) GetAuthorizationOk() (*ExporterConfigAuthorization, bool) {
	if o == nil || utils.IsNil(o.Authorization) {
		return nil, false
	}
...
func (o *ExporterConfig) HasAuthorization() bool {
	if o != nil && !utils.IsNil(o.Authorization) {
		return true
	}
...
// SetAuthorization gets a reference to the given ExporterConfigAuthorization and assigns it to the Authorization field.
func (o *ExporterConfig) SetAuthorization(v ExporterConfigAuthorization) {
	o.Authorization = &v
}
...
func (o ExporterConfig) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.Authorization) {
