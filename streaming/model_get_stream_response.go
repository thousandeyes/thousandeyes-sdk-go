...
func (o *GetStreamResponse) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *GetStreamResponse) GetNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *GetStreamResponse) HasName() bool {
	if o != nil && !utils.IsNil(o.Name) {
		return true
	}
...
func (o *GetStreamResponse) SetName(v string) {
	o.Name = &v
}
...
func (o *GetStreamResponse) GetInputConfig() InputConfig {
...
// and a boolean to check if the value has been set.
func (o *GetStreamResponse) GetInputConfigOk() (*InputConfig, bool) {
	if o == nil || utils.IsNil(o.InputConfig) {
		return nil, false
	}
...
func (o *GetStreamResponse) HasInputConfig() bool {
	if o != nil && !utils.IsNil(o.InputConfig) {
		return true
	}
...
func (o *GetStreamResponse) SetInputConfig(v InputConfig) {
	o.InputConfig = &v
}
...
func (o *GetStreamResponse) GetEndpointAgentLabel() []EndpointAgentLabel {
...
// and a boolean to check if the value has been set.
func (o *GetStreamResponse) GetEndpointAgentLabelOk() ([]EndpointAgentLabel, bool) {
	if o == nil || utils.IsNil(o.EndpointAgentLabel) {
		return nil, false
	}
...
func (o *GetStreamResponse) HasEndpointAgentLabel() bool {
	if o != nil && !utils.IsNil(o.EndpointAgentLabel) {
		return true
	}
...
func (o *GetStreamResponse) SetEndpointAgentLabel(v []EndpointAgentLabel) {
	o.EndpointAgentLabel = v
}

// GetEndpointAgentTag returns the EndpointAgentTag field value if set, zero value otherwise.
func (o *GetStreamResponse) GetEndpointAgentTag() []EndpointAgentTag {
...
// and a boolean to check if the value has been set.
func (o *GetStreamResponse) GetEndpointAgentTagOk() ([]EndpointAgentTag, bool) {
	if o == nil || utils.IsNil(o.EndpointAgentTag) {
		return nil, false
	}
...
func (o *GetStreamResponse) HasEndpointAgentTag() bool {
	if o != nil && !utils.IsNil(o.EndpointAgentTag) {
		return true
	}
...
func (o *GetStreamResponse) SetEndpointAgentTag(v []EndpointAgentTag) {
...
func (o *GetStreamResponse) GetStreamStatus() StreamStatus {
...
// and a boolean to check if the value has been set.
func (o *GetStreamResponse) GetStreamStatusOk() (*StreamStatus, bool) {
	if o == nil || utils.IsNil(o.StreamStatus) {
		return nil, false
	}
...
func (o *GetStreamResponse) HasStreamStatus() bool {
	if o != nil && !utils.IsNil(o.StreamStatus) {
		return true
	}
...
func (o *GetStreamResponse) SetStreamStatus(v StreamStatus) {
	o.StreamStatus = &v
}
