...
func (o *RuleDetailUpdate) GetSeverity() AlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *RuleDetailUpdate) GetSeverityOk() (*AlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *RuleDetailUpdate) SetSeverity(v AlertSeverity) {
	o.Severity = &v
}
