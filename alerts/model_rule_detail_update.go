...
func NewRuleDetailUpdate(ruleName string, expression string, alertType AlertType, roundsViolatingOutOf int32) *RuleDetailUpdate {
...
func (o *RuleDetailUpdate) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *RuleDetailUpdate) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *RuleDetailUpdate) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *RuleDetailUpdate) SetDescription(v string) {
	o.Description = &v
}
...
func (o *RuleDetailUpdate) HasRoundsViolatingRequired() bool {
	if o != nil && !utils.IsNil(o.RoundsViolatingRequired) {
		return true
	}
