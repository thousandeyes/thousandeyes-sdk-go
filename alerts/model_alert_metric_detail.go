...
func (o *AlertMetricDetail) GetState() AlertState {
...
// and a boolean to check if the value has been set.
func (o *AlertMetricDetail) GetStateOk() (*AlertState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
// SetState gets a reference to the given AlertState and assigns it to the State field.
func (o *AlertMetricDetail) SetState(v AlertState) {
	o.State = &v
}
