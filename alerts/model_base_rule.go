...
func NewBaseRule(ruleName string, expression string, alertType AlertType, roundsViolatingOutOf int32) *BaseRule {
	this := BaseRule{}
...
func (o *BaseRule) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *BaseRule) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *BaseRule) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *BaseRule) SetDescription(v string) {
	o.Description = &v
}
...
func (o *BaseRule) HasRoundsViolatingRequired() bool {
	if o != nil && !utils.IsNil(o.RoundsViolatingRequired) {
		return true
	}
