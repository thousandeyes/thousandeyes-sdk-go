...
func (o *Alert) GetAlertState() AlertState {
...
// and a boolean to check if the value has been set.
func (o *Alert) GetAlertStateOk() (*AlertState, bool) {
	if o == nil || utils.IsNil(o.AlertState) {
		return nil, false
	}
...
func (o *Alert) SetAlertState(v AlertState) {
	o.AlertState = &v
}

// GetAlertSeverity returns the AlertSeverity field value if set, zero value otherwise.
func (o *Alert) GetAlertSeverity() AlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *Alert) GetAlertSeverityOk() (*AlertSeverity, bool) {
	if o == nil || utils.IsNil(o.AlertSeverity) {
		return nil, false
	}
...
func (o *Alert) SetAlertSeverity(v AlertSeverity) {
	o.AlertSeverity = &v
}
