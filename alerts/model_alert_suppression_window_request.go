...
func (o *AlertSuppressionWindowRequest) GetTestIds() []string {
...
// and a boolean to check if the value has been set.
func (o *AlertSuppressionWindowRequest) GetTestIdsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.TestIds) {
		return nil, false
	}
...
func (o *AlertSuppressionWindowRequest) HasTestIds() bool {
	if o != nil && !utils.IsNil(o.TestIds) {
		return true
	}
...
func (o *AlertSuppressionWindowRequest) SetTestIds(v []string) {
	o.TestIds = v
}
