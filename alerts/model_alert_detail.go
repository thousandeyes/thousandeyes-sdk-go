...
func (o *AlertDetail) GetAlertState() AlertState {
...
// and a boolean to check if the value has been set.
func (o *AlertDetail) GetAlertStateOk() (*AlertState, bool) {
	if o == nil || utils.IsNil(o.AlertState) {
		return nil, false
	}
...
// SetAlertState gets a reference to the given AlertState and assigns it to the AlertState field.
func (o *AlertDetail) SetAlertState(v AlertState) {
	o.AlertState = &v
}

// GetAlertSeverity returns the AlertSeverity field value if set, zero value otherwise.
func (o *AlertDetail) GetAlertSeverity() AlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *AlertDetail) GetAlertSeverityOk() (*AlertSeverity, bool) {
	if o == nil || utils.IsNil(o.AlertSeverity) {
		return nil, false
	}
...
// SetAlertSeverity gets a reference to the given AlertSeverity and assigns it to the AlertSeverity field.
func (o *AlertDetail) SetAlertSeverity(v AlertSeverity) {
	o.AlertSeverity = &v
}
