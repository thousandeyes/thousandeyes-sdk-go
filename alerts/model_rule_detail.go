...
func NewRuleDetail(ruleName string, expression string, alertType AlertType, roundsViolatingOutOf int32) *RuleDetail {
	this := RuleDetail{}
...
func (o *RuleDetail) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *RuleDetail) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *RuleDetail) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *RuleDetail) SetDescription(v string) {
	o.Description = &v
}
...
func (o *RuleDetail) HasRoundsViolatingRequired() bool {
	if o != nil && !utils.IsNil(o.RoundsViolatingRequired) {
		return true
	}
...
func (o *RuleDetail) GetTestIds() []string {
...
// and a boolean to check if the value has been set.
func (o *RuleDetail) GetTestIdsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.TestIds) {
		return nil, false
	}
...
func (o *RuleDetail) HasTestIds() bool {
	if o != nil && !utils.IsNil(o.TestIds) {
		return true
	}
...
func (o *RuleDetail) SetTestIds(v []string) {
	o.TestIds = v
}
