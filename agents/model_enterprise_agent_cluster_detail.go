...
func (o *EnterpriseAgentClusterDetail) GetCoordinates() Coordinates {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentClusterDetail) GetCoordinatesOk() (*Coordinates, bool) {
	if o == nil || utils.IsNil(o.Coordinates) {
		return nil, false
	}
...
func (o *EnterpriseAgentClusterDetail) HasCoordinates() bool {
	if o != nil && !utils.IsNil(o.Coordinates) {
		return true
	}
...
func (o *EnterpriseAgentClusterDetail) GetNetworkProviderInfo() NetworkProviderInfo {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentClusterDetail) GetNetworkProviderInfoOk() (*NetworkProviderInfo, bool) {
	if o == nil || utils.IsNil(o.NetworkProviderInfo) {
		return nil, false
	}
...
func (o *EnterpriseAgentClusterDetail) SetNetworkProviderInfo(v NetworkProviderInfo) {
...
func (o *EnterpriseAgentClusterDetail) GetTestIds() []int64 {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentClusterDetail) GetTestIdsOk() ([]int64, bool) {
	if o == nil || utils.IsNil(o.TestIds) {
		return nil, false
	}
...
func (o *EnterpriseAgentClusterDetail) HasTestIds() bool {
	if o != nil && !utils.IsNil(o.TestIds) {
		return true
	}
...
// SetTestIds gets a reference to the given []int64 and assigns it to the TestIds field.
func (o *EnterpriseAgentClusterDetail) SetTestIds(v []int64) {
	o.TestIds = v
}
...
// GetInterfaceIpMapping returns the InterfaceIpMapping field value if set, zero value otherwise.
func (o *EnterpriseAgentClusterDetail) GetInterfaceIpMapping() []InterfaceIpMapping {
	if o == nil || utils.IsNil(o.InterfaceIpMapping) {
		var ret []InterfaceIpMapping
		return ret
	}
	return o.InterfaceIpMapping
}

// GetInterfaceIpMappingOk returns a tuple with the InterfaceIpMapping field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentClusterDetail) GetInterfaceIpMappingOk() ([]InterfaceIpMapping, bool) {
	if o == nil || utils.IsNil(o.InterfaceIpMapping) {
		return nil, false
	}
	return o.InterfaceIpMapping, true
}

// HasInterfaceIpMapping returns a boolean if a field has been set.
func (o *EnterpriseAgentClusterDetail) HasInterfaceIpMapping() bool {
	if o != nil && !utils.IsNil(o.InterfaceIpMapping) {
		return true
	}
...
// SetInterfaceIpMapping gets a reference to the given []InterfaceIpMapping and assigns it to the InterfaceIpMapping field.
func (o *EnterpriseAgentClusterDetail) SetInterfaceIpMapping(v []InterfaceIpMapping) {
	o.InterfaceIpMapping = v
}
...
func (o *EnterpriseAgentClusterDetail) GetTags() []AgentTag {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentClusterDetail) GetTagsOk() ([]AgentTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *EnterpriseAgentClusterDetail) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *EnterpriseAgentClusterDetail) SetTags(v []AgentTag) {
	o.Tags = v
}
...
func (o EnterpriseAgentClusterDetail) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.InterfaceIpMapping) {
		toSerialize["interfaceIpMapping"] = o.InterfaceIpMapping
	}
