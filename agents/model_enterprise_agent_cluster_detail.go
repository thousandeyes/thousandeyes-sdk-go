...
func (o *EnterpriseAgentClusterDetail) GetSerialNumber() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentClusterDetail) GetSerialNumberOk() (*string, bool) {
	if o == nil || utils.IsNil(o.SerialNumber) {
		return nil, false
	}
...
func (o *EnterpriseAgentClusterDetail) HasSerialNumber() bool {
	if o != nil && !utils.IsNil(o.SerialNumber) {
		return true
	}
...
func (o *EnterpriseAgentClusterDetail) SetSerialNumber(v string) {
	o.SerialNumber = &v
}
