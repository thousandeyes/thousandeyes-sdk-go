...
func (o *EnterpriseAgentResponseExpands) GetTestIds() []int64 {
...
func (o *EnterpriseAgentResponseExpands) GetTestIdsOk() ([]int64, bool) {
	if o == nil || utils.IsNil(o.TestIds) {
		return nil, false
	}
...
func (o *EnterpriseAgentResponseExpands) HasTestIds() bool {
	if o != nil && !utils.IsNil(o.TestIds) {
		return true
	}
...
func (o *EnterpriseAgentResponseExpands) SetTestIds(v []int64) {
	o.TestIds = v
}
...
func (o *EnterpriseAgentResponseExpands) GetTags() []AgentTag {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentResponseExpands) GetTagsOk() ([]AgentTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *EnterpriseAgentResponseExpands) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *EnterpriseAgentResponseExpands) SetTags(v []AgentTag) {
	o.Tags = v
}
