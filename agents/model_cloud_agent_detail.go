...
func (o *CloudAgentDetail) GetCoordinates() Coordinates {
...
// and a boolean to check if the value has been set.
func (o *CloudAgentDetail) GetCoordinatesOk() (*Coordinates, bool) {
	if o == nil || utils.IsNil(o.Coordinates) {
		return nil, false
	}
...
func (o *CloudAgentDetail) HasCoordinates() bool {
	if o != nil && !utils.IsNil(o.Coordinates) {
		return true
	}
...
func (o *CloudAgentDetail) SetCoordinates(v Coordinates) {
	o.Coordinates = &v
}

// GetNetworkProviderInfo returns the NetworkProviderInfo field value if set, zero value otherwise.
func (o *CloudAgentDetail) GetNetworkProviderInfo() NetworkProviderInfo {
...
// and a boolean to check if the value has been set.
func (o *CloudAgentDetail) GetNetworkProviderInfoOk() (*NetworkProviderInfo, bool) {
	if o == nil || utils.IsNil(o.NetworkProviderInfo) {
		return nil, false
	}
...
func (o *CloudAgentDetail) SetNetworkProviderInfo(v NetworkProviderInfo) {
