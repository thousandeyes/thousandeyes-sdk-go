...
func (o *EnterpriseAgent) GetCoordinates() Coordinates {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgent) GetCoordinatesOk() (*Coordinates, bool) {
	if o == nil || utils.IsNil(o.Coordinates) {
		return nil, false
	}
...
func (o *EnterpriseAgent) HasCoordinates() bool {
	if o != nil && !utils.IsNil(o.Coordinates) {
		return true
	}
...
func (o *EnterpriseAgent) GetNetworkProviderInfo() NetworkProviderInfo {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgent) GetNetworkProviderInfoOk() (*NetworkProviderInfo, bool) {
	if o == nil || utils.IsNil(o.NetworkProviderInfo) {
		return nil, false
	}
...
func (o *EnterpriseAgent) SetNetworkProviderInfo(v NetworkProviderInfo) {
...
func (o *EnterpriseAgent) GetTestIds() []int64 {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgent) GetTestIdsOk() ([]int64, bool) {
	if o == nil || utils.IsNil(o.TestIds) {
		return nil, false
	}
...
func (o *EnterpriseAgent) HasTestIds() bool {
	if o != nil && !utils.IsNil(o.TestIds) {
		return true
	}
...
func (o *EnterpriseAgent) SetTestIds(v []int64) {
	o.TestIds = v
}

// GetTests returns the Tests field value if set, zero value otherwise.
func (o *EnterpriseAgent) GetTests() []SimpleTest {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgent) GetTestsOk() ([]SimpleTest, bool) {
	if o == nil || utils.IsNil(o.Tests) {
		return nil, false
	}
	return o.Tests, true
...
func (o *EnterpriseAgent) HasTests() bool {
	if o != nil && !utils.IsNil(o.Tests) {
		return true
	}
...
func (o *EnterpriseAgent) SetTests(v []SimpleTest) {
	o.Tests = v
}
...
func (o *EnterpriseAgent) GetInterfaceIpMapping() []InterfaceIpMapping {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgent) GetInterfaceIpMappingOk() ([]InterfaceIpMapping, bool) {
	if o == nil || utils.IsNil(o.InterfaceIpMapping) {
		return nil, false
	}
...
func (o *EnterpriseAgent) HasInterfaceIpMapping() bool {
	if o != nil && !utils.IsNil(o.InterfaceIpMapping) {
		return true
	}
...
func (o *EnterpriseAgent) SetInterfaceIpMapping(v []InterfaceIpMapping) {
