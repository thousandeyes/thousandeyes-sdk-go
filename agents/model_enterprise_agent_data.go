...
func (o *EnterpriseAgentData) GetTestIds() []int64 {
...
func (o *EnterpriseAgentData) GetTestIdsOk() ([]int64, bool) {
	if o == nil || utils.IsNil(o.TestIds) {
		return nil, false
	}
...
func (o *EnterpriseAgentData) HasTestIds() bool {
	if o != nil && !utils.IsNil(o.TestIds) {
		return true
	}
...
func (o *EnterpriseAgentData) SetTestIds(v []int64) {
	o.TestIds = v
}

// GetTests returns the Tests field value if set, zero value otherwise.
func (o *EnterpriseAgentData) GetTests() []SimpleTest {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentData) GetTestsOk() ([]SimpleTest, bool) {
	if o == nil || utils.IsNil(o.Tests) {
		return nil, false
	}
	return o.Tests, true
...
func (o *EnterpriseAgentData) HasTests() bool {
	if o != nil && !utils.IsNil(o.Tests) {
		return true
	}
...
func (o *EnterpriseAgentData) SetTests(v []SimpleTest) {
	o.Tests = v
}
...
func (o *EnterpriseAgentData) GetInterfaceIpMapping() []InterfaceIpMapping {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentData) GetInterfaceIpMappingOk() ([]InterfaceIpMapping, bool) {
	if o == nil || utils.IsNil(o.InterfaceIpMapping) {
		return nil, false
	}
...
func (o *EnterpriseAgentData) HasInterfaceIpMapping() bool {
	if o != nil && !utils.IsNil(o.InterfaceIpMapping) {
		return true
	}
...
func (o *EnterpriseAgentData) SetInterfaceIpMapping(v []InterfaceIpMapping) {
