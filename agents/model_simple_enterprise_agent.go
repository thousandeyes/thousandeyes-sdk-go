...
func (o *SimpleEnterpriseAgent) GetInterfaceIpMappings() []InterfaceIpMapping {
...
// and a boolean to check if the value has been set.
func (o *SimpleEnterpriseAgent) GetInterfaceIpMappingsOk() ([]InterfaceIpMapping, bool) {
	if o == nil || utils.IsNil(o.InterfaceIpMappings) {
		return nil, false
	}
...
func (o *SimpleEnterpriseAgent) HasInterfaceIpMappings() bool {
	if o != nil && !utils.IsNil(o.InterfaceIpMappings) {
		return true
	}
...
func (o *SimpleEnterpriseAgent) SetInterfaceIpMappings(v []InterfaceIpMapping) {
