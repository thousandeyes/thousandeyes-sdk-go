...
func (o *SimpleEnterpriseAgent) GetNetworkProviderInfo() NetworkProviderInfo {
...
// and a boolean to check if the value has been set.
func (o *SimpleEnterpriseAgent) GetNetworkProviderInfoOk() (*NetworkProviderInfo, bool) {
	if o == nil || utils.IsNil(o.NetworkProviderInfo) {
		return nil, false
	}
...
func (o *SimpleEnterpriseAgent) SetNetworkProviderInfo(v NetworkProviderInfo) {
