...
func (o *EnterpriseAgentDetail) GetNetworkProviderInfo() NetworkProviderInfo {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetNetworkProviderInfoOk() (*NetworkProviderInfo, bool) {
	if o == nil || utils.IsNil(o.NetworkProviderInfo) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) SetNetworkProviderInfo(v NetworkProviderInfo) {
