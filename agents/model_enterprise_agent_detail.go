...
func (o *EnterpriseAgentDetail) GetInterfaceIpMappings() []InterfaceIpMapping {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetInterfaceIpMappingsOk() ([]InterfaceIpMapping, bool) {
	if o == nil || utils.IsNil(o.InterfaceIpMappings) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasInterfaceIpMappings() bool {
	if o != nil && !utils.IsNil(o.InterfaceIpMappings) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetInterfaceIpMappings(v []InterfaceIpMapping) {
