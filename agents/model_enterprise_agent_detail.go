...
// checks if the EnterpriseAgentDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EnterpriseAgentDetail{}

// EnterpriseAgentDetail struct for EnterpriseAgentDetail
...
type _EnterpriseAgentDetail EnterpriseAgentDetail

// NewEnterpriseAgentDetail instantiates a new EnterpriseAgentDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEnterpriseAgentDetail(agentType string) *EnterpriseAgentDetail {
	this := EnterpriseAgentDetail{}
	this.AgentType = agentType
	return &this
}

// NewEnterpriseAgentDetailWithDefaults instantiates a new EnterpriseAgentDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEnterpriseAgentDetailWithDefaults() *EnterpriseAgentDetail {
	this := EnterpriseAgentDetail{}
	return &this
}

// GetIpAddresses returns the IpAddresses field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetIpAddresses() []string {
...
func (o *EnterpriseAgentDetail) GetIpAddressesOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.IpAddresses) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasIpAddresses() bool {
	if o != nil && !utils.IsNil(o.IpAddresses) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetIpAddresses(v []string) {
	o.IpAddresses = v
}

// GetPublicIpAddresses returns the PublicIpAddresses field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetPublicIpAddresses() []string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetPublicIpAddressesOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.PublicIpAddresses) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasPublicIpAddresses() bool {
	if o != nil && !utils.IsNil(o.PublicIpAddresses) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetPublicIpAddresses(v []string) {
	o.PublicIpAddresses = v
}

// GetNetwork returns the Network field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetNetwork() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetNetworkOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Network) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasNetwork() bool {
	if o != nil && !utils.IsNil(o.Network) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetNetwork(v string) {
	o.Network = &v
}

// GetAgentId returns the AgentId field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetAgentId() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetAgentIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.AgentId) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasAgentId() bool {
	if o != nil && !utils.IsNil(o.AgentId) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetAgentId(v string) {
	o.AgentId = &v
}

// GetAgentName returns the AgentName field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetAgentName() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetAgentNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.AgentName) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasAgentName() bool {
	if o != nil && !utils.IsNil(o.AgentName) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetAgentName(v string) {
	o.AgentName = &v
}

// GetLocation returns the Location field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetLocation() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetLocationOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Location) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasLocation() bool {
	if o != nil && !utils.IsNil(o.Location) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetLocation(v string) {
	o.Location = &v
}

// GetCountryId returns the CountryId field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetCountryId() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetCountryIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CountryId) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasCountryId() bool {
	if o != nil && !utils.IsNil(o.CountryId) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetCountryId(v string) {
	o.CountryId = &v
}

// GetCoordinates returns the Coordinates field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetCoordinates() Coordinates {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetCoordinatesOk() (*Coordinates, bool) {
	if o == nil || utils.IsNil(o.Coordinates) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasCoordinates() bool {
	if o != nil && !utils.IsNil(o.Coordinates) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetCoordinates(v Coordinates) {
	o.Coordinates = &v
}

// GetNetworkProviderInfo returns the NetworkProviderInfo field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetNetworkProviderInfo() SimpleAgentAllOfNetworkProviderInfo {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetNetworkProviderInfoOk() (*SimpleAgentAllOfNetworkProviderInfo, bool) {
	if o == nil || utils.IsNil(o.NetworkProviderInfo) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasNetworkProviderInfo() bool {
	if o != nil && !utils.IsNil(o.NetworkProviderInfo) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetNetworkProviderInfo(v SimpleAgentAllOfNetworkProviderInfo) {
	o.NetworkProviderInfo = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetEnabled(v bool) {
	o.Enabled = &v
}

// GetVerifySslCertificates returns the VerifySslCertificates field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetVerifySslCertificates() bool {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetVerifySslCertificatesOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.VerifySslCertificates) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasVerifySslCertificates() bool {
	if o != nil && !utils.IsNil(o.VerifySslCertificates) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetVerifySslCertificates(v bool) {
	o.VerifySslCertificates = &v
}

// GetPrefix returns the Prefix field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetPrefix() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetPrefixOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Prefix) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasPrefix() bool {
	if o != nil && !utils.IsNil(o.Prefix) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetPrefix(v string) {
	o.Prefix = &v
}

// GetTestIds returns the TestIds field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetTestIds() []int64 {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetTestIdsOk() ([]int64, bool) {
	if o == nil || utils.IsNil(o.TestIds) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasTestIds() bool {
	if o != nil && !utils.IsNil(o.TestIds) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetTestIds(v []int64) {
	o.TestIds = v
}

// GetTests returns the Tests field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetTests() []SimpleTest {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetTestsOk() ([]SimpleTest, bool) {
	if o == nil || utils.IsNil(o.Tests) {
		return nil, false
	}
	return o.Tests, true
...
func (o *EnterpriseAgentDetail) HasTests() bool {
	if o != nil && !utils.IsNil(o.Tests) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetTests(v []SimpleTest) {
	o.Tests = v
}

// GetClusterMembers returns the ClusterMembers field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetClusterMembers() []ClusterMember {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetClusterMembersOk() ([]ClusterMember, bool) {
	if o == nil || utils.IsNil(o.ClusterMembers) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasClusterMembers() bool {
	if o != nil && !utils.IsNil(o.ClusterMembers) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetClusterMembers(v []ClusterMember) {
	o.ClusterMembers = v
}

// GetUtilization returns the Utilization field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetUtilization() int32 {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetUtilizationOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Utilization) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasUtilization() bool {
	if o != nil && !utils.IsNil(o.Utilization) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetUtilization(v int32) {
	o.Utilization = &v
}

// GetAccountGroups returns the AccountGroups field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetAccountGroups() []AccountGroup {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetAccountGroupsOk() ([]AccountGroup, bool) {
	if o == nil || utils.IsNil(o.AccountGroups) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasAccountGroups() bool {
	if o != nil && !utils.IsNil(o.AccountGroups) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetAccountGroups(v []AccountGroup) {
	o.AccountGroups = v
}

// GetIpv6Policy returns the Ipv6Policy field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetIpv6Policy() EnterpriseAgentIpv6Policy {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetIpv6PolicyOk() (*EnterpriseAgentIpv6Policy, bool) {
	if o == nil || utils.IsNil(o.Ipv6Policy) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasIpv6Policy() bool {
	if o != nil && !utils.IsNil(o.Ipv6Policy) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetIpv6Policy(v EnterpriseAgentIpv6Policy) {
	o.Ipv6Policy = &v
}

// GetErrorDetails returns the ErrorDetails field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetErrorDetails() []ErrorDetail {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetErrorDetailsOk() ([]ErrorDetail, bool) {
	if o == nil || utils.IsNil(o.ErrorDetails) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasErrorDetails() bool {
	if o != nil && !utils.IsNil(o.ErrorDetails) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetErrorDetails(v []ErrorDetail) {
	o.ErrorDetails = v
}

// GetHostname returns the Hostname field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetHostname() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetHostnameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Hostname) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasHostname() bool {
	if o != nil && !utils.IsNil(o.Hostname) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetHostname(v string) {
	o.Hostname = &v
}

// GetLastSeen returns the LastSeen field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetLastSeen() time.Time {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetLastSeenOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.LastSeen) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasLastSeen() bool {
	if o != nil && !utils.IsNil(o.LastSeen) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetLastSeen(v time.Time) {
	o.LastSeen = &v
}

// GetAgentState returns the AgentState field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetAgentState() EnterpriseAgentState {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetAgentStateOk() (*EnterpriseAgentState, bool) {
	if o == nil || utils.IsNil(o.AgentState) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasAgentState() bool {
	if o != nil && !utils.IsNil(o.AgentState) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetAgentState(v EnterpriseAgentState) {
	o.AgentState = &v
}

// GetKeepBrowserCache returns the KeepBrowserCache field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetKeepBrowserCache() bool {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetKeepBrowserCacheOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.KeepBrowserCache) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasKeepBrowserCache() bool {
	if o != nil && !utils.IsNil(o.KeepBrowserCache) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetKeepBrowserCache(v bool) {
	o.KeepBrowserCache = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetTargetForTests returns the TargetForTests field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetTargetForTests() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetTargetForTestsOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TargetForTests) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasTargetForTests() bool {
	if o != nil && !utils.IsNil(o.TargetForTests) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetTargetForTests(v string) {
	o.TargetForTests = &v
}

// GetSerialNumber returns the SerialNumber field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetSerialNumber() string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetSerialNumberOk() (*string, bool) {
	if o == nil || utils.IsNil(o.SerialNumber) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasSerialNumber() bool {
	if o != nil && !utils.IsNil(o.SerialNumber) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetSerialNumber(v string) {
	o.SerialNumber = &v
}

// GetLocalResolutionPrefixes returns the LocalResolutionPrefixes field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetLocalResolutionPrefixes() []string {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetLocalResolutionPrefixesOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.LocalResolutionPrefixes) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasLocalResolutionPrefixes() bool {
	if o != nil && !utils.IsNil(o.LocalResolutionPrefixes) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetLocalResolutionPrefixes(v []string) {
	o.LocalResolutionPrefixes = v
}

// GetInterfaceIpMapping returns the InterfaceIpMapping field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetInterfaceIpMapping() []InterfaceIpMapping {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetInterfaceIpMappingOk() ([]InterfaceIpMapping, bool) {
	if o == nil || utils.IsNil(o.InterfaceIpMapping) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasInterfaceIpMapping() bool {
	if o != nil && !utils.IsNil(o.InterfaceIpMapping) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetInterfaceIpMapping(v []InterfaceIpMapping) {
	o.InterfaceIpMapping = v
}

// GetNotificationRules returns the NotificationRules field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetNotificationRules() []NotificationRules {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetNotificationRulesOk() ([]NotificationRules, bool) {
	if o == nil || utils.IsNil(o.NotificationRules) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasNotificationRules() bool {
	if o != nil && !utils.IsNil(o.NotificationRules) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetNotificationRules(v []NotificationRules) {
	o.NotificationRules = v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetLabels() []AgentLabel {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetLabelsOk() ([]AgentLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetLabels(v []AgentLabel) {
	o.Labels = v
}
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetAgentTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EnterpriseAgentDetail) SetAgentType(v string) {
	o.AgentType = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *EnterpriseAgentDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *EnterpriseAgentDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *EnterpriseAgentDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *EnterpriseAgentDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

func (o EnterpriseAgentDetail) MarshalJSON() ([]byte, error) {
...
func (o EnterpriseAgentDetail) ToMap() (map[string]interface{}, error) {
...
func (o *EnterpriseAgentDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varEnterpriseAgentDetail := _EnterpriseAgentDetail{}

    err = json.Unmarshal(data, &varEnterpriseAgentDetail)

	if err != nil {
		return err
	}

	*o = EnterpriseAgentDetail(varEnterpriseAgentDetail)

	return err
}

type NullableEnterpriseAgentDetail struct {
	value *EnterpriseAgentDetail
	isSet bool
}

func (v NullableEnterpriseAgentDetail) Get() *EnterpriseAgentDetail {
	return v.value
}

func (v *NullableEnterpriseAgentDetail) Set(val *EnterpriseAgentDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableEnterpriseAgentDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableEnterpriseAgentDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnterpriseAgentDetail(val *EnterpriseAgentDetail) *NullableEnterpriseAgentDetail {
	return &NullableEnterpriseAgentDetail{value: val, isSet: true}
}

func (v NullableEnterpriseAgentDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnterpriseAgentDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
