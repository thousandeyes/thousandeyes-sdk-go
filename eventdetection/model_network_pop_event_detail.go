...
// checks if the NetworkPopEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &NetworkPopEventDetail{}

// NetworkPopEventDetail struct for NetworkPopEventDetail
...
type _NetworkPopEventDetail NetworkPopEventDetail

// NewNetworkPopEventDetail instantiates a new NetworkPopEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNetworkPopEventDetail(type_ string) *NetworkPopEventDetail {
	this := NetworkPopEventDetail{}
	this.Type = type_
	return &this
}

// NewNetworkPopEventDetailWithDefaults instantiates a new NetworkPopEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNetworkPopEventDetailWithDefaults() *NetworkPopEventDetail {
	this := NetworkPopEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetId() string {
...
func (o *NetworkPopEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *NetworkPopEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *NetworkPopEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NetworkPopEventDetail) GetEndDate() time.Time {
...
func (o *NetworkPopEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasEndDate() bool {
...
func (o *NetworkPopEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *NetworkPopEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *NetworkPopEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *NetworkPopEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *NetworkPopEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *NetworkPopEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *NetworkPopEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *NetworkPopEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *NetworkPopEventDetail) GetGrouping() NetworkEventGrouping {
...
// and a boolean to check if the value has been set.
func (o *NetworkPopEventDetail) GetGroupingOk() (*NetworkEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *NetworkPopEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
func (o *NetworkPopEventDetail) SetGrouping(v NetworkEventGrouping) {
	o.Grouping = &v
}

func (o NetworkPopEventDetail) MarshalJSON() ([]byte, error) {
...
func (o NetworkPopEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkPopEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkPopEventDetail := _NetworkPopEventDetail{}

    err = json.Unmarshal(data, &varNetworkPopEventDetail)

	if err != nil {
		return err
	}

	*o = NetworkPopEventDetail(varNetworkPopEventDetail)

	return err
}

type NullableNetworkPopEventDetail struct {
	value *NetworkPopEventDetail
	isSet bool
}

func (v NullableNetworkPopEventDetail) Get() *NetworkPopEventDetail {
	return v.value
}

func (v *NullableNetworkPopEventDetail) Set(val *NetworkPopEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkPopEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkPopEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkPopEventDetail(val *NetworkPopEventDetail) *NullableNetworkPopEventDetail {
	return &NullableNetworkPopEventDetail{value: val, isSet: true}
}

func (v NullableNetworkPopEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkPopEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
