...
// checks if the GatewayEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &GatewayEventDetail{}

// GatewayEventDetail struct for GatewayEventDetail
...
type _GatewayEventDetail GatewayEventDetail

// NewGatewayEventDetail instantiates a new GatewayEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGatewayEventDetail(type_ string) *GatewayEventDetail {
	this := GatewayEventDetail{}
	this.Type = type_
	return &this
}

// NewGatewayEventDetailWithDefaults instantiates a new GatewayEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGatewayEventDetailWithDefaults() *GatewayEventDetail {
	this := GatewayEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetId() string {
...
func (o *GatewayEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *GatewayEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *GatewayEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *GatewayEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *GatewayEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *GatewayEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *GatewayEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GatewayEventDetail) GetEndDate() time.Time {
...
func (o *GatewayEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasEndDate() bool {
...
func (o *GatewayEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *GatewayEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *GatewayEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *GatewayEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *GatewayEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *GatewayEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *GatewayEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *GatewayEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *GatewayEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *GatewayEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *GatewayEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *GatewayEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *GatewayEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *GatewayEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *GatewayEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *GatewayEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GatewayEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *GatewayEventDetail) GetGrouping() GatewayEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret GatewayEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *GatewayEventDetail) GetGroupingOk() (*GatewayEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *GatewayEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given GatewayEventGrouping and assigns it to the Grouping field.
func (o *GatewayEventDetail) SetGrouping(v GatewayEventGrouping) {
	o.Grouping = &v
}

func (o GatewayEventDetail) MarshalJSON() ([]byte, error) {
...
func (o GatewayEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varGatewayEventDetail := _GatewayEventDetail{}

    err = json.Unmarshal(data, &varGatewayEventDetail)

	if err != nil {
		return err
	}

	*o = GatewayEventDetail(varGatewayEventDetail)

	return err
}

type NullableGatewayEventDetail struct {
	value *GatewayEventDetail
	isSet bool
}

func (v NullableGatewayEventDetail) Get() *GatewayEventDetail {
	return v.value
}

func (v *NullableGatewayEventDetail) Set(val *GatewayEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewayEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewayEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewayEventDetail(val *GatewayEventDetail) *NullableGatewayEventDetail {
	return &NullableGatewayEventDetail{value: val, isSet: true}
}

func (v NullableGatewayEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewayEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
