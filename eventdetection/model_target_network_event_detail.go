...
func (o *TargetNetworkEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *TargetNetworkEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}
...
func (o *TargetNetworkEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *TargetNetworkEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *TargetNetworkEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *TargetNetworkEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}
