...
// checks if the AgentBranchEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AgentBranchEventDetail{}

// AgentBranchEventDetail struct for AgentBranchEventDetail
...
type _AgentBranchEventDetail AgentBranchEventDetail

// NewAgentBranchEventDetail instantiates a new AgentBranchEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAgentBranchEventDetail(type_ string) *AgentBranchEventDetail {
	this := AgentBranchEventDetail{}
	this.Type = type_
	return &this
}

// NewAgentBranchEventDetailWithDefaults instantiates a new AgentBranchEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAgentBranchEventDetailWithDefaults() *AgentBranchEventDetail {
	this := AgentBranchEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetId() string {
...
func (o *AgentBranchEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *AgentBranchEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *AgentBranchEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AgentBranchEventDetail) GetEndDate() time.Time {
...
func (o *AgentBranchEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasEndDate() bool {
...
func (o *AgentBranchEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *AgentBranchEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *AgentBranchEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *AgentBranchEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *AgentBranchEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *AgentBranchEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *AgentBranchEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *AgentBranchEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *AgentBranchEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *AgentBranchEventDetail) GetGrouping() AgentBranchEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret AgentBranchEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *AgentBranchEventDetail) GetGroupingOk() (*AgentBranchEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *AgentBranchEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given AgentBranchEventGrouping and assigns it to the Grouping field.
func (o *AgentBranchEventDetail) SetGrouping(v AgentBranchEventGrouping) {
	o.Grouping = &v
}

func (o AgentBranchEventDetail) MarshalJSON() ([]byte, error) {
...
func (o AgentBranchEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *AgentBranchEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentBranchEventDetail := _AgentBranchEventDetail{}

    err = json.Unmarshal(data, &varAgentBranchEventDetail)

	if err != nil {
		return err
	}

	*o = AgentBranchEventDetail(varAgentBranchEventDetail)

	return err
}

type NullableAgentBranchEventDetail struct {
	value *AgentBranchEventDetail
	isSet bool
}

func (v NullableAgentBranchEventDetail) Get() *AgentBranchEventDetail {
	return v.value
}

func (v *NullableAgentBranchEventDetail) Set(val *AgentBranchEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentBranchEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentBranchEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentBranchEventDetail(val *AgentBranchEventDetail) *NullableAgentBranchEventDetail {
	return &NullableAgentBranchEventDetail{value: val, isSet: true}
}

func (v NullableAgentBranchEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentBranchEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
