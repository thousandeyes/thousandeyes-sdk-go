...
// checks if the DomainEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DomainEventDetail{}

// DomainEventDetail struct for DomainEventDetail
...
type _DomainEventDetail DomainEventDetail

// NewDomainEventDetail instantiates a new DomainEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDomainEventDetail(type_ string) *DomainEventDetail {
	this := DomainEventDetail{}
	this.Type = type_
	return &this
}

// NewDomainEventDetailWithDefaults instantiates a new DomainEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDomainEventDetailWithDefaults() *DomainEventDetail {
	this := DomainEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *DomainEventDetail) GetId() string {
...
func (o *DomainEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *DomainEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *DomainEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *DomainEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *DomainEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *DomainEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *DomainEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *DomainEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *DomainEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *DomainEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DomainEventDetail) GetEndDate() time.Time {
...
func (o *DomainEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DomainEventDetail) HasEndDate() bool {
...
func (o *DomainEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *DomainEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *DomainEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *DomainEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *DomainEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *DomainEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *DomainEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *DomainEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *DomainEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *DomainEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *DomainEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *DomainEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *DomainEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *DomainEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *DomainEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *DomainEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *DomainEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *DomainEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *DomainEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *DomainEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *DomainEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *DomainEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *DomainEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *DomainEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *DomainEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *DomainEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *DomainEventDetail) GetGrouping() DomainEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret DomainEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *DomainEventDetail) GetGroupingOk() (*DomainEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *DomainEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given DomainEventGrouping and assigns it to the Grouping field.
func (o *DomainEventDetail) SetGrouping(v DomainEventGrouping) {
	o.Grouping = &v
}

func (o DomainEventDetail) MarshalJSON() ([]byte, error) {
...
func (o DomainEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *DomainEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varDomainEventDetail := _DomainEventDetail{}

    err = json.Unmarshal(data, &varDomainEventDetail)

	if err != nil {
		return err
	}

	*o = DomainEventDetail(varDomainEventDetail)

	return err
}

type NullableDomainEventDetail struct {
	value *DomainEventDetail
	isSet bool
}

func (v NullableDomainEventDetail) Get() *DomainEventDetail {
	return v.value
}

func (v *NullableDomainEventDetail) Set(val *DomainEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainEventDetail(val *DomainEventDetail) *NullableDomainEventDetail {
	return &NullableDomainEventDetail{value: val, isSet: true}
}

func (v NullableDomainEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
