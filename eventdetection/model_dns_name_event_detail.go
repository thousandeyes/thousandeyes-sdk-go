...
// checks if the DnsNameEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DnsNameEventDetail{}

// DnsNameEventDetail struct for DnsNameEventDetail
...
type _DnsNameEventDetail DnsNameEventDetail

// NewDnsNameEventDetail instantiates a new DnsNameEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDnsNameEventDetail(type_ string) *DnsNameEventDetail {
	this := DnsNameEventDetail{}
	this.Type = type_
	return &this
}

// NewDnsNameEventDetailWithDefaults instantiates a new DnsNameEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDnsNameEventDetailWithDefaults() *DnsNameEventDetail {
	this := DnsNameEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetId() string {
...
func (o *DnsNameEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *DnsNameEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *DnsNameEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *DnsNameEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *DnsNameEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *DnsNameEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *DnsNameEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DnsNameEventDetail) GetEndDate() time.Time {
...
func (o *DnsNameEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasEndDate() bool {
...
func (o *DnsNameEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *DnsNameEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *DnsNameEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *DnsNameEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *DnsNameEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *DnsNameEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *DnsNameEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *DnsNameEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *DnsNameEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *DnsNameEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *DnsNameEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *DnsNameEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *DnsNameEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *DnsNameEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *DnsNameEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *DnsNameEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *DnsNameEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *DnsNameEventDetail) GetGrouping() DnsNameEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret DnsNameEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *DnsNameEventDetail) GetGroupingOk() (*DnsNameEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *DnsNameEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given DnsNameEventGrouping and assigns it to the Grouping field.
func (o *DnsNameEventDetail) SetGrouping(v DnsNameEventGrouping) {
	o.Grouping = &v
}

func (o DnsNameEventDetail) MarshalJSON() ([]byte, error) {
...
func (o DnsNameEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *DnsNameEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsNameEventDetail := _DnsNameEventDetail{}

    err = json.Unmarshal(data, &varDnsNameEventDetail)

	if err != nil {
		return err
	}

	*o = DnsNameEventDetail(varDnsNameEventDetail)

	return err
}

type NullableDnsNameEventDetail struct {
	value *DnsNameEventDetail
	isSet bool
}

func (v NullableDnsNameEventDetail) Get() *DnsNameEventDetail {
	return v.value
}

func (v *NullableDnsNameEventDetail) Set(val *DnsNameEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsNameEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsNameEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsNameEventDetail(val *DnsNameEventDetail) *NullableDnsNameEventDetail {
	return &NullableDnsNameEventDetail{value: val, isSet: true}
}

func (v NullableDnsNameEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsNameEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
