...
// checks if the ProxyEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ProxyEventDetail{}

// ProxyEventDetail struct for ProxyEventDetail
...
type _ProxyEventDetail ProxyEventDetail

// NewProxyEventDetail instantiates a new ProxyEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewProxyEventDetail(type_ string) *ProxyEventDetail {
	this := ProxyEventDetail{}
	this.Type = type_
	return &this
}

// NewProxyEventDetailWithDefaults instantiates a new ProxyEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewProxyEventDetailWithDefaults() *ProxyEventDetail {
	this := ProxyEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetId() string {
...
func (o *ProxyEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *ProxyEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *ProxyEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *ProxyEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *ProxyEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *ProxyEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *ProxyEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ProxyEventDetail) GetEndDate() time.Time {
...
func (o *ProxyEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasEndDate() bool {
...
func (o *ProxyEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *ProxyEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *ProxyEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *ProxyEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *ProxyEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *ProxyEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *ProxyEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *ProxyEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *ProxyEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *ProxyEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *ProxyEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *ProxyEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *ProxyEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ProxyEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *ProxyEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *ProxyEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *ProxyEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *ProxyEventDetail) GetGrouping() ProxyEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret ProxyEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *ProxyEventDetail) GetGroupingOk() (*ProxyEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *ProxyEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given ProxyEventGrouping and assigns it to the Grouping field.
func (o *ProxyEventDetail) SetGrouping(v ProxyEventGrouping) {
	o.Grouping = &v
}

func (o ProxyEventDetail) MarshalJSON() ([]byte, error) {
...
func (o ProxyEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *ProxyEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varProxyEventDetail := _ProxyEventDetail{}

    err = json.Unmarshal(data, &varProxyEventDetail)

	if err != nil {
		return err
	}

	*o = ProxyEventDetail(varProxyEventDetail)

	return err
}

type NullableProxyEventDetail struct {
	value *ProxyEventDetail
	isSet bool
}

func (v NullableProxyEventDetail) Get() *ProxyEventDetail {
	return v.value
}

func (v *NullableProxyEventDetail) Set(val *ProxyEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableProxyEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableProxyEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProxyEventDetail(val *ProxyEventDetail) *NullableProxyEventDetail {
	return &NullableProxyEventDetail{value: val, isSet: true}
}

func (v NullableProxyEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProxyEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
