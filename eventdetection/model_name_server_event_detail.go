...
// checks if the NameServerEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &NameServerEventDetail{}

// NameServerEventDetail struct for NameServerEventDetail
...
type _NameServerEventDetail NameServerEventDetail

// NewNameServerEventDetail instantiates a new NameServerEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNameServerEventDetail(type_ string) *NameServerEventDetail {
	this := NameServerEventDetail{}
	this.Type = type_
	return &this
}

// NewNameServerEventDetailWithDefaults instantiates a new NameServerEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNameServerEventDetailWithDefaults() *NameServerEventDetail {
	this := NameServerEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetId() string {
...
func (o *NameServerEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *NameServerEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *NameServerEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *NameServerEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *NameServerEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *NameServerEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *NameServerEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NameServerEventDetail) GetEndDate() time.Time {
...
func (o *NameServerEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasEndDate() bool {
...
func (o *NameServerEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *NameServerEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *NameServerEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *NameServerEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *NameServerEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *NameServerEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *NameServerEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *NameServerEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *NameServerEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *NameServerEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *NameServerEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *NameServerEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *NameServerEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *NameServerEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *NameServerEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *NameServerEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *NameServerEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *NameServerEventDetail) GetGrouping() NameServerEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret NameServerEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *NameServerEventDetail) GetGroupingOk() (*NameServerEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *NameServerEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given NameServerEventGrouping and assigns it to the Grouping field.
func (o *NameServerEventDetail) SetGrouping(v NameServerEventGrouping) {
	o.Grouping = &v
}

func (o NameServerEventDetail) MarshalJSON() ([]byte, error) {
...
func (o NameServerEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *NameServerEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varNameServerEventDetail := _NameServerEventDetail{}

    err = json.Unmarshal(data, &varNameServerEventDetail)

	if err != nil {
		return err
	}

	*o = NameServerEventDetail(varNameServerEventDetail)

	return err
}

type NullableNameServerEventDetail struct {
	value *NameServerEventDetail
	isSet bool
}

func (v NullableNameServerEventDetail) Get() *NameServerEventDetail {
	return v.value
}

func (v *NullableNameServerEventDetail) Set(val *NameServerEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableNameServerEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableNameServerEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNameServerEventDetail(val *NameServerEventDetail) *NullableNameServerEventDetail {
	return &NullableNameServerEventDetail{value: val, isSet: true}
}

func (v NullableNameServerEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNameServerEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
