...
// checks if the ApplicationEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ApplicationEventDetail{}

// ApplicationEventDetail struct for ApplicationEventDetail
...
type _ApplicationEventDetail ApplicationEventDetail

// NewApplicationEventDetail instantiates a new ApplicationEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewApplicationEventDetail(type_ string) *ApplicationEventDetail {
	this := ApplicationEventDetail{}
	this.Type = type_
	return &this
}

// NewApplicationEventDetailWithDefaults instantiates a new ApplicationEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewApplicationEventDetailWithDefaults() *ApplicationEventDetail {
	this := ApplicationEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetId() string {
...
func (o *ApplicationEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *ApplicationEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *ApplicationEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *ApplicationEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *ApplicationEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *ApplicationEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *ApplicationEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ApplicationEventDetail) GetEndDate() time.Time {
...
func (o *ApplicationEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasEndDate() bool {
...
func (o *ApplicationEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *ApplicationEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *ApplicationEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *ApplicationEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *ApplicationEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *ApplicationEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *ApplicationEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *ApplicationEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *ApplicationEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *ApplicationEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *ApplicationEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *ApplicationEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *ApplicationEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ApplicationEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *ApplicationEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *ApplicationEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *ApplicationEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *ApplicationEventDetail) GetGrouping() ApplicationEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret ApplicationEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *ApplicationEventDetail) GetGroupingOk() (*ApplicationEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *ApplicationEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given ApplicationEventGrouping and assigns it to the Grouping field.
func (o *ApplicationEventDetail) SetGrouping(v ApplicationEventGrouping) {
	o.Grouping = &v
}

func (o ApplicationEventDetail) MarshalJSON() ([]byte, error) {
...
func (o ApplicationEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicationEventDetail := _ApplicationEventDetail{}

    err = json.Unmarshal(data, &varApplicationEventDetail)

	if err != nil {
		return err
	}

	*o = ApplicationEventDetail(varApplicationEventDetail)

	return err
}

type NullableApplicationEventDetail struct {
	value *ApplicationEventDetail
	isSet bool
}

func (v NullableApplicationEventDetail) Get() *ApplicationEventDetail {
	return v.value
}

func (v *NullableApplicationEventDetail) Set(val *ApplicationEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationEventDetail(val *ApplicationEventDetail) *NullableApplicationEventDetail {
	return &NullableApplicationEventDetail{value: val, isSet: true}
}

func (v NullableApplicationEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
