...
// checks if the WirelessEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WirelessEventDetail{}

// WirelessEventDetail struct for WirelessEventDetail
...
type _WirelessEventDetail WirelessEventDetail

// NewWirelessEventDetail instantiates a new WirelessEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWirelessEventDetail(type_ string) *WirelessEventDetail {
	this := WirelessEventDetail{}
	this.Type = type_
	return &this
}

// NewWirelessEventDetailWithDefaults instantiates a new WirelessEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewWirelessEventDetailWithDefaults() *WirelessEventDetail {
	this := WirelessEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetId() string {
...
func (o *WirelessEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *WirelessEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *WirelessEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *WirelessEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *WirelessEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *WirelessEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *WirelessEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WirelessEventDetail) GetEndDate() time.Time {
...
func (o *WirelessEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasEndDate() bool {
...
func (o *WirelessEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *WirelessEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *WirelessEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *WirelessEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *WirelessEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *WirelessEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *WirelessEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *WirelessEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *WirelessEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *WirelessEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *WirelessEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *WirelessEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *WirelessEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *WirelessEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *WirelessEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *WirelessEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *WirelessEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *WirelessEventDetail) GetGrouping() WirelessEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret WirelessEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *WirelessEventDetail) GetGroupingOk() (*WirelessEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *WirelessEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given WirelessEventGrouping and assigns it to the Grouping field.
func (o *WirelessEventDetail) SetGrouping(v WirelessEventGrouping) {
	o.Grouping = &v
}

func (o WirelessEventDetail) MarshalJSON() ([]byte, error) {
...
func (o WirelessEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *WirelessEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varWirelessEventDetail := _WirelessEventDetail{}

    err = json.Unmarshal(data, &varWirelessEventDetail)

	if err != nil {
		return err
	}

	*o = WirelessEventDetail(varWirelessEventDetail)

	return err
}

type NullableWirelessEventDetail struct {
	value *WirelessEventDetail
	isSet bool
}

func (v NullableWirelessEventDetail) Get() *WirelessEventDetail {
	return v.value
}

func (v *NullableWirelessEventDetail) Set(val *WirelessEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableWirelessEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableWirelessEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWirelessEventDetail(val *WirelessEventDetail) *NullableWirelessEventDetail {
	return &NullableWirelessEventDetail{value: val, isSet: true}
}

func (v NullableWirelessEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWirelessEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
