...
// checks if the DnsServerEventDetail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DnsServerEventDetail{}

// DnsServerEventDetail struct for DnsServerEventDetail
...
type _DnsServerEventDetail DnsServerEventDetail

// NewDnsServerEventDetail instantiates a new DnsServerEventDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDnsServerEventDetail(type_ string) *DnsServerEventDetail {
	this := DnsServerEventDetail{}
	this.Type = type_
	return &this
}

// NewDnsServerEventDetailWithDefaults instantiates a new DnsServerEventDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDnsServerEventDetailWithDefaults() *DnsServerEventDetail {
	this := DnsServerEventDetail{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetId() string {
...
func (o *DnsServerEventDetail) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *DnsServerEventDetail) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *DnsServerEventDetail) SetId(v string) {
	o.Id = &v
}

// GetTypeName returns the TypeName field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetTypeName() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetTypeNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TypeName) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasTypeName() bool {
	if o != nil && !utils.IsNil(o.TypeName) {
		return true
	}
...
func (o *DnsServerEventDetail) SetTypeName(v string) {
	o.TypeName = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetState() EventState {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetStateOk() (*EventState, bool) {
	if o == nil || utils.IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *DnsServerEventDetail) HasState() bool {
	if o != nil && !utils.IsNil(o.State) {
		return true
	}
...
func (o *DnsServerEventDetail) SetState(v EventState) {
	o.State = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetStartDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasStartDate() bool {
	if o != nil && !utils.IsNil(o.StartDate) {
		return true
	}
...
func (o *DnsServerEventDetail) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DnsServerEventDetail) GetEndDate() time.Time {
...
func (o *DnsServerEventDetail) GetEndDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasEndDate() bool {
...
func (o *DnsServerEventDetail) SetEndDate(v time.Time) {
	o.EndDate.Set(&v)
}
// SetEndDateNil sets the value for EndDate to be an explicit nil
func (o *DnsServerEventDetail) SetEndDateNil() {
	o.EndDate.Set(nil)
}

// UnsetEndDate ensures that no value is present for EndDate, not even an explicit nil
func (o *DnsServerEventDetail) UnsetEndDate() {
	o.EndDate.Unset()
}

// GetSeverity returns the Severity field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetSeverity() EventAlertSeverity {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetSeverityOk() (*EventAlertSeverity, bool) {
	if o == nil || utils.IsNil(o.Severity) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasSeverity() bool {
	if o != nil && !utils.IsNil(o.Severity) {
		return true
	}
...
func (o *DnsServerEventDetail) SetSeverity(v EventAlertSeverity) {
	o.Severity = &v
}

// GetAid returns the Aid field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetAid() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetAidOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Aid) {
		return nil, false
	}
	return o.Aid, true
...
func (o *DnsServerEventDetail) HasAid() bool {
	if o != nil && !utils.IsNil(o.Aid) {
		return true
	}
...
func (o *DnsServerEventDetail) SetAid(v string) {
	o.Aid = &v
}

// GetSummary returns the Summary field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetSummary() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetSummaryOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Summary) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasSummary() bool {
	if o != nil && !utils.IsNil(o.Summary) {
		return true
	}
...
func (o *DnsServerEventDetail) SetSummary(v string) {
	o.Summary = &v
}

// GetAgentType returns the AgentType field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetAgentType() EventAgentType {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetAgentTypeOk() (*EventAgentType, bool) {
	if o == nil || utils.IsNil(o.AgentType) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasAgentType() bool {
	if o != nil && !utils.IsNil(o.AgentType) {
		return true
	}
...
func (o *DnsServerEventDetail) SetAgentType(v EventAgentType) {
	o.AgentType = &v
}

// GetAffectedTests returns the AffectedTests field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetAffectedTests() AffectedTests {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetAffectedTestsOk() (*AffectedTests, bool) {
	if o == nil || utils.IsNil(o.AffectedTests) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasAffectedTests() bool {
	if o != nil && !utils.IsNil(o.AffectedTests) {
		return true
	}
...
func (o *DnsServerEventDetail) SetAffectedTests(v AffectedTests) {
	o.AffectedTests = &v
}

// GetAffectedTargets returns the AffectedTargets field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetAffectedTargets() AffectedTargets {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetAffectedTargetsOk() (*AffectedTargets, bool) {
	if o == nil || utils.IsNil(o.AffectedTargets) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasAffectedTargets() bool {
	if o != nil && !utils.IsNil(o.AffectedTargets) {
		return true
	}
...
func (o *DnsServerEventDetail) SetAffectedTargets(v AffectedTargets) {
	o.AffectedTargets = &v
}

// GetAffectedAgents returns the AffectedAgents field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetAffectedAgents() AffectedAgents {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetAffectedAgentsOk() (*AffectedAgents, bool) {
	if o == nil || utils.IsNil(o.AffectedAgents) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasAffectedAgents() bool {
	if o != nil && !utils.IsNil(o.AffectedAgents) {
		return true
	}
...
func (o *DnsServerEventDetail) SetAffectedAgents(v AffectedAgents) {
	o.AffectedAgents = &v
}

// GetCause returns the Cause field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetCause() []string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetCauseOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Cause) {
		return nil, false
	}
	return o.Cause, true
...
func (o *DnsServerEventDetail) HasCause() bool {
	if o != nil && !utils.IsNil(o.Cause) {
		return true
	}
...
func (o *DnsServerEventDetail) SetCause(v []string) {
	o.Cause = v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *DnsServerEventDetail) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *DnsServerEventDetail) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetType returns the Type field value
func (o *DnsServerEventDetail) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *DnsServerEventDetail) SetType(v string) {
	o.Type = v
}

// GetGrouping returns the Grouping field value if set, zero value otherwise.
func (o *DnsServerEventDetail) GetGrouping() DnsServerEventGrouping {
	if o == nil || utils.IsNil(o.Grouping) {
		var ret DnsServerEventGrouping
		return ret
	}
	return *o.Grouping
}
...
// and a boolean to check if the value has been set.
func (o *DnsServerEventDetail) GetGroupingOk() (*DnsServerEventGrouping, bool) {
	if o == nil || utils.IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *DnsServerEventDetail) HasGrouping() bool {
	if o != nil && !utils.IsNil(o.Grouping) {
		return true
	}
...
// SetGrouping gets a reference to the given DnsServerEventGrouping and assigns it to the Grouping field.
func (o *DnsServerEventDetail) SetGrouping(v DnsServerEventGrouping) {
	o.Grouping = &v
}

func (o DnsServerEventDetail) MarshalJSON() ([]byte, error) {
...
func (o DnsServerEventDetail) ToMap() (map[string]interface{}, error) {
...
func (o *DnsServerEventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsServerEventDetail := _DnsServerEventDetail{}

    err = json.Unmarshal(data, &varDnsServerEventDetail)

	if err != nil {
		return err
	}

	*o = DnsServerEventDetail(varDnsServerEventDetail)

	return err
}

type NullableDnsServerEventDetail struct {
	value *DnsServerEventDetail
	isSet bool
}

func (v NullableDnsServerEventDetail) Get() *DnsServerEventDetail {
	return v.value
}

func (v *NullableDnsServerEventDetail) Set(val *DnsServerEventDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsServerEventDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsServerEventDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsServerEventDetail(val *DnsServerEventDetail) *NullableDnsServerEventDetail {
	return &NullableDnsServerEventDetail{value: val, isSet: true}
}

func (v NullableDnsServerEventDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsServerEventDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
