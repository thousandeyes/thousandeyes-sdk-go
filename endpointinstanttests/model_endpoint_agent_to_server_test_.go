...
func (o *EndpointAgentToServerTest) GetIpVersion() string {
...
// and a boolean to check if the value has been set.
func (o *EndpointAgentToServerTest) GetIpVersionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *EndpointAgentToServerTest) SetIpVersion(v string) {
	o.IpVersion = &v
}
