...
func NewEndpointAgentToServerInstantTest(testName string, server string) *EndpointAgentToServerInstantTest {
...
func (o *EndpointAgentToServerInstantTest) GetTagIds() []string {
...
// and a boolean to check if the value has been set.
func (o *EndpointAgentToServerInstantTest) GetTagIdsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.TagIds) {
		return nil, false
	}
...
func (o *EndpointAgentToServerInstantTest) HasTagIds() bool {
	if o != nil && !utils.IsNil(o.TagIds) {
		return true
	}
...
func (o *EndpointAgentToServerInstantTest) SetTagIds(v []string) {
	o.TagIds = v
}
...
func (o *EndpointAgentToServerInstantTest) GetIpVersion() EndpointIpVersionIn {
...
// and a boolean to check if the value has been set.
func (o *EndpointAgentToServerInstantTest) GetIpVersionOk() (*EndpointIpVersionIn, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *EndpointAgentToServerInstantTest) HasIpVersion() bool {
	if o != nil && !utils.IsNil(o.IpVersion) {
		return true
	}
...
func (o *EndpointAgentToServerInstantTest) SetIpVersion(v EndpointIpVersionIn) {
	o.IpVersion = &v
}
...
func (o *EndpointAgentToServerInstantTest) HasServerName() bool {
	if o != nil && !utils.IsNil(o.ServerName) {
		return true
	}
...
func (o *EndpointAgentToServerInstantTest) GetServer() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EndpointAgentToServerInstantTest) GetServerOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EndpointAgentToServerInstantTest) SetServer(v string) {
	o.Server = v
}
