...
func (o *EndpointTest) GetIsPrioritized() bool {
...
// and a boolean to check if the value has been set.
func (o *EndpointTest) GetIsPrioritizedOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.IsPrioritized) {
		return nil, false
	}
...
func (o *EndpointTest) HasIsPrioritized() bool {
	if o != nil && !utils.IsNil(o.IsPrioritized) {
		return true
	}
...
func (o *EndpointTest) SetIsPrioritized(v bool) {
	o.IsPrioritized = &v
}
...
func (o *EndpointTest) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *EndpointTest) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *EndpointTest) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *EndpointTest) SetLabels(v []TestLabel) {
	o.Labels = v
}
...
func (o *EndpointTest) GetIpVersion() string {
...
// and a boolean to check if the value has been set.
func (o *EndpointTest) GetIpVersionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *EndpointTest) SetIpVersion(v string) {
	o.IpVersion = &v
}
