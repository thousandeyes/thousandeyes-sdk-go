...
func (o *EndpointHttpServerTest) GetIpVersion() string {
...
// and a boolean to check if the value has been set.
func (o *EndpointHttpServerTest) GetIpVersionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *EndpointHttpServerTest) SetIpVersion(v string) {
	o.IpVersion = &v
}
