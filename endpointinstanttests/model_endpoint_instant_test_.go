...
func (o *EndpointInstantTest) GetTagIds() []string {
...
// and a boolean to check if the value has been set.
func (o *EndpointInstantTest) GetTagIdsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.TagIds) {
		return nil, false
	}
...
func (o *EndpointInstantTest) HasTagIds() bool {
	if o != nil && !utils.IsNil(o.TagIds) {
		return true
	}
...
func (o *EndpointInstantTest) SetTagIds(v []string) {
	o.TagIds = v
}
...
func (o *EndpointInstantTest) GetIpVersion() EndpointIpVersionIn {
...
// and a boolean to check if the value has been set.
func (o *EndpointInstantTest) GetIpVersionOk() (*EndpointIpVersionIn, bool) {
	if o == nil || utils.IsNil(o.IpVersion) {
		return nil, false
	}
...
func (o *EndpointInstantTest) HasIpVersion() bool {
	if o != nil && !utils.IsNil(o.IpVersion) {
		return true
	}
...
func (o *EndpointInstantTest) SetIpVersion(v EndpointIpVersionIn) {
	o.IpVersion = &v
}
