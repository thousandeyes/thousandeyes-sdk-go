...
func (o *AgentResponse) GetCoordinates() Coordinates {
...
// and a boolean to check if the value has been set.
func (o *AgentResponse) GetCoordinatesOk() (*Coordinates, bool) {
	if o == nil || utils.IsNil(o.Coordinates) {
		return nil, false
	}
...
func (o *AgentResponse) HasCoordinates() bool {
	if o != nil && !utils.IsNil(o.Coordinates) {
		return true
	}
...
func (o *AgentResponse) SetCoordinates(v Coordinates) {
	o.Coordinates = &v
}

// GetNetworkProviderInfo returns the NetworkProviderInfo field value if set, zero value otherwise.
func (o *AgentResponse) GetNetworkProviderInfo() SimpleAgentAllOfNetworkProviderInfo {
...
// and a boolean to check if the value has been set.
func (o *AgentResponse) GetNetworkProviderInfoOk() (*SimpleAgentAllOfNetworkProviderInfo, bool) {
	if o == nil || utils.IsNil(o.NetworkProviderInfo) {
		return nil, false
	}
...
func (o *AgentResponse) SetNetworkProviderInfo(v SimpleAgentAllOfNetworkProviderInfo) {
