...
func NewUnexpandedFtpServerTest(interval TestInterval, requestType FtpServerRequestType, url string, username string) *UnexpandedFtpServerTest {
...
func (o *UnexpandedFtpServerTest) HasPassword() bool {
	if o != nil && !utils.IsNil(o.Password) {
		return true
	}
