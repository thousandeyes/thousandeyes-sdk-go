...
// checks if the SipServerTestResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SipServerTestResponse{}

// SipServerTestResponse struct for SipServerTestResponse
type SipServerTestResponse struct {
...
type _SipServerTestResponse SipServerTestResponse

// NewSipServerTestResponse instantiates a new SipServerTestResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSipServerTestResponse(interval TestInterval, port int32) *SipServerTestResponse {
	this := SipServerTestResponse{}
...
// NewSipServerTestResponseWithDefaults instantiates a new SipServerTestResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSipServerTestResponseWithDefaults() *SipServerTestResponse {
	this := SipServerTestResponse{}
...
func (o *SipServerTestResponse) GetInterval() TestInterval {
	if o == nil {
...
func (o *SipServerTestResponse) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SipServerTestResponse) SetInterval(v TestInterval) {
	o.Interval = v
}

// GetAlertsEnabled returns the AlertsEnabled field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetAlertsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *SipServerTestResponse) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
func (o *SipServerTestResponse) SetEnabled(v bool) {
	o.Enabled = &v
}

// GetAlertRules returns the AlertRules field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetAlertRules() []AlertRule {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *SipServerTestResponse) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetBgpMeasurements returns the BgpMeasurements field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetBgpMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetBgpMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BgpMeasurements) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasBgpMeasurements() bool {
	if o != nil && !utils.IsNil(o.BgpMeasurements) {
		return true
	}
...
func (o *SipServerTestResponse) SetBgpMeasurements(v bool) {
	o.BgpMeasurements = &v
}

// GetUsePublicBgp returns the UsePublicBgp field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetUsePublicBgp() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetUsePublicBgpOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UsePublicBgp) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasUsePublicBgp() bool {
	if o != nil && !utils.IsNil(o.UsePublicBgp) {
		return true
	}
...
func (o *SipServerTestResponse) SetUsePublicBgp(v bool) {
	o.UsePublicBgp = &v
}

// GetMonitors returns the Monitors field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetMonitors() []Monitor {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetMonitorsOk() ([]Monitor, bool) {
	if o == nil || utils.IsNil(o.Monitors) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasMonitors() bool {
	if o != nil && !utils.IsNil(o.Monitors) {
		return true
	}
...
func (o *SipServerTestResponse) SetMonitors(v []Monitor) {
	o.Monitors = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *SipServerTestResponse) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *SipServerTestResponse) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *SipServerTestResponse) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *SipServerTestResponse) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *SipServerTestResponse) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *SipServerTestResponse) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *SipServerTestResponse) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
func (o *SipServerTestResponse) SetTestId(v string) {
	o.TestId = &v
}

// GetTestName returns the TestName field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetTestName() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *SipServerTestResponse) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *SipServerTestResponse) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *SipServerTestResponse) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *SipServerTestResponse) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *SipServerTestResponse) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *SipServerTestResponse) SetLabels(v []TestLabel) {
	o.Labels = v
}
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
func (o *SipServerTestResponse) SetSharedWithAccounts(v []SharedWithAccount) {
	o.SharedWithAccounts = v
}

// GetMtuMeasurements returns the MtuMeasurements field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetMtuMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetMtuMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.MtuMeasurements) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasMtuMeasurements() bool {
	if o != nil && !utils.IsNil(o.MtuMeasurements) {
		return true
	}
...
func (o *SipServerTestResponse) SetMtuMeasurements(v bool) {
	o.MtuMeasurements = &v
}

// GetNetworkMeasurements returns the NetworkMeasurements field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetNetworkMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetNetworkMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.NetworkMeasurements) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasNetworkMeasurements() bool {
	if o != nil && !utils.IsNil(o.NetworkMeasurements) {
		return true
	}
...
func (o *SipServerTestResponse) SetNetworkMeasurements(v bool) {
	o.NetworkMeasurements = &v
}

// GetNumPathTraces returns the NumPathTraces field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetNumPathTraces() int32 {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *SipServerTestResponse) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetOptionsRegex returns the OptionsRegex field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetOptionsRegex() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetOptionsRegexOk() (*string, bool) {
	if o == nil || utils.IsNil(o.OptionsRegex) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasOptionsRegex() bool {
	if o != nil && !utils.IsNil(o.OptionsRegex) {
		return true
	}
...
func (o *SipServerTestResponse) SetOptionsRegex(v string) {
	o.OptionsRegex = &v
}

// GetPathTraceMode returns the PathTraceMode field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetPathTraceMode() TestPathTraceMode {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetPathTraceModeOk() (*TestPathTraceMode, bool) {
	if o == nil || utils.IsNil(o.PathTraceMode) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasPathTraceMode() bool {
	if o != nil && !utils.IsNil(o.PathTraceMode) {
		return true
	}
...
func (o *SipServerTestResponse) SetPathTraceMode(v TestPathTraceMode) {
	o.PathTraceMode = &v
}

// GetProbeMode returns the ProbeMode field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetProbeMode() TestProbeMode {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetProbeModeOk() (*TestProbeMode, bool) {
	if o == nil || utils.IsNil(o.ProbeMode) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasProbeMode() bool {
	if o != nil && !utils.IsNil(o.ProbeMode) {
		return true
	}
...
func (o *SipServerTestResponse) SetProbeMode(v TestProbeMode) {
	o.ProbeMode = &v
}

// GetRandomizedStartTime returns the RandomizedStartTime field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetRandomizedStartTime() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
func (o *SipServerTestResponse) SetRandomizedStartTime(v bool) {
	o.RandomizedStartTime = &v
}

// GetRegisterEnabled returns the RegisterEnabled field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetRegisterEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetRegisterEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RegisterEnabled) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasRegisterEnabled() bool {
	if o != nil && !utils.IsNil(o.RegisterEnabled) {
		return true
	}
...
func (o *SipServerTestResponse) SetRegisterEnabled(v bool) {
	o.RegisterEnabled = &v
}

// GetSipTargetTime returns the SipTargetTime field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetSipTargetTime() int32 {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetSipTargetTimeOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.SipTargetTime) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasSipTargetTime() bool {
	if o != nil && !utils.IsNil(o.SipTargetTime) {
		return true
	}
...
func (o *SipServerTestResponse) SetSipTargetTime(v int32) {
	o.SipTargetTime = &v
}

// GetSipTimeLimit returns the SipTimeLimit field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetSipTimeLimit() int32 {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetSipTimeLimitOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.SipTimeLimit) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasSipTimeLimit() bool {
	if o != nil && !utils.IsNil(o.SipTimeLimit) {
		return true
	}
...
func (o *SipServerTestResponse) SetSipTimeLimit(v int32) {
	o.SipTimeLimit = &v
}

// GetFixedPacketRate returns the FixedPacketRate field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetFixedPacketRate() int32 {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetFixedPacketRateOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.FixedPacketRate) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasFixedPacketRate() bool {
	if o != nil && !utils.IsNil(o.FixedPacketRate) {
		return true
	}
...
func (o *SipServerTestResponse) SetFixedPacketRate(v int32) {
	o.FixedPacketRate = &v
}

// GetIpv6Policy returns the Ipv6Policy field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetIpv6Policy() TestIpv6Policy {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetIpv6PolicyOk() (*TestIpv6Policy, bool) {
	if o == nil || utils.IsNil(o.Ipv6Policy) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasIpv6Policy() bool {
	if o != nil && !utils.IsNil(o.Ipv6Policy) {
		return true
	}
...
func (o *SipServerTestResponse) SetIpv6Policy(v TestIpv6Policy) {
	o.Ipv6Policy = &v
}

// GetAuthUser returns the AuthUser field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetAuthUser() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetAuthUserOk() (*string, bool) {
	if o == nil || utils.IsNil(o.AuthUser) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasAuthUser() bool {
	if o != nil && !utils.IsNil(o.AuthUser) {
		return true
	}
...
func (o *SipServerTestResponse) SetAuthUser(v string) {
	o.AuthUser = &v
}

// GetPassword returns the Password field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetPassword() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetPasswordOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Password) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasPassword() bool {
	if o != nil && !utils.IsNil(o.Password) {
		return true
	}
...
func (o *SipServerTestResponse) SetPassword(v string) {
	o.Password = &v
}

// GetPort returns the Port field value
func (o *SipServerTestResponse) GetPort() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetPortOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Port, true
...
func (o *SipServerTestResponse) SetPort(v int32) {
	o.Port = v
}

// GetProtocol returns the Protocol field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetProtocol() SipTestProtocol {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetProtocolOk() (*SipTestProtocol, bool) {
	if o == nil || utils.IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasProtocol() bool {
	if o != nil && !utils.IsNil(o.Protocol) {
		return true
	}
...
func (o *SipServerTestResponse) SetProtocol(v SipTestProtocol) {
	o.Protocol = &v
}

// GetSipRegistrar returns the SipRegistrar field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetSipRegistrar() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetSipRegistrarOk() (*string, bool) {
	if o == nil || utils.IsNil(o.SipRegistrar) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasSipRegistrar() bool {
	if o != nil && !utils.IsNil(o.SipRegistrar) {
		return true
	}
...
func (o *SipServerTestResponse) SetSipRegistrar(v string) {
	o.SipRegistrar = &v
}

// GetUser returns the User field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetUser() string {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetUserOk() (*string, bool) {
	if o == nil || utils.IsNil(o.User) {
		return nil, false
	}
	return o.User, true
...
func (o *SipServerTestResponse) HasUser() bool {
	if o != nil && !utils.IsNil(o.User) {
		return true
	}
...
func (o *SipServerTestResponse) SetUser(v string) {
	o.User = &v
}

// GetAgents returns the Agents field value if set, zero value otherwise.
func (o *SipServerTestResponse) GetAgents() []TestAgentResponse {
...
// and a boolean to check if the value has been set.
func (o *SipServerTestResponse) GetAgentsOk() ([]TestAgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *SipServerTestResponse) HasAgents() bool {
	if o != nil && !utils.IsNil(o.Agents) {
		return true
	}
...
func (o *SipServerTestResponse) SetAgents(v []TestAgentResponse) {
	o.Agents = v
}

func (o SipServerTestResponse) MarshalJSON() ([]byte, error) {
...
func (o SipServerTestResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SipServerTestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSipServerTestResponse := _SipServerTestResponse{}

    err = json.Unmarshal(data, &varSipServerTestResponse)

	if err != nil {
		return err
	}

	*o = SipServerTestResponse(varSipServerTestResponse)

	return err
}

type NullableSipServerTestResponse struct {
	value *SipServerTestResponse
	isSet bool
}

func (v NullableSipServerTestResponse) Get() *SipServerTestResponse {
	return v.value
}

func (v *NullableSipServerTestResponse) Set(val *SipServerTestResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSipServerTestResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSipServerTestResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSipServerTestResponse(val *SipServerTestResponse) *NullableSipServerTestResponse {
	return &NullableSipServerTestResponse{value: val, isSet: true}
}

func (v NullableSipServerTestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSipServerTestResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
