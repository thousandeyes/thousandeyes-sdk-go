...
func (o *UnexpandedHttpServerTest) GetDistributedTracing() bool {
...
// and a boolean to check if the value has been set.
func (o *UnexpandedHttpServerTest) GetDistributedTracingOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.DistributedTracing) {
		return nil, false
	}
...
func (o *UnexpandedHttpServerTest) HasDistributedTracing() bool {
	if o != nil && !utils.IsNil(o.DistributedTracing) {
		return true
	}
...
func (o *UnexpandedHttpServerTest) SetDistributedTracing(v bool) {
...
func (o *UnexpandedHttpServerTest) GetVaultCredentials() []TestVaultCredential {
...
// and a boolean to check if the value has been set.
func (o *UnexpandedHttpServerTest) GetVaultCredentialsOk() ([]TestVaultCredential, bool) {
	if o == nil || utils.IsNil(o.VaultCredentials) {
		return nil, false
	}
...
func (o *UnexpandedHttpServerTest) HasVaultCredentials() bool {
	if o != nil && !utils.IsNil(o.VaultCredentials) {
		return true
	}
...
func (o *UnexpandedHttpServerTest) SetVaultCredentials(v []TestVaultCredential) {
...
func (o *UnexpandedHttpServerTest) GetRequestMethod() RequestMethod {
...
// and a boolean to check if the value has been set.
func (o *UnexpandedHttpServerTest) GetRequestMethodOk() (*RequestMethod, bool) {
	if o == nil || utils.IsNil(o.RequestMethod) {
		return nil, false
	}
...
func (o *UnexpandedHttpServerTest) HasRequestMethod() bool {
	if o != nil && !utils.IsNil(o.RequestMethod) {
		return true
	}
...
func (o *UnexpandedHttpServerTest) SetRequestMethod(v RequestMethod) {
	o.RequestMethod = &v
}
