...
func NewAgentToServerTestRequest(interval TestInterval, server string, agents []TestAgentRequest) *AgentToServerTestRequest {
...
// and a boolean to check if the value has been set.
func (o *AgentToServerTestRequest) GetAgentsOk() ([]TestAgentRequest, bool) {
	if o == nil {
		return nil, false
	}
