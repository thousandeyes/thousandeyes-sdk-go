...
func (o *AgentToServerTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *AgentToServerTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *AgentToServerTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *AgentToServerTest) SetTags(v []TestTag) {
	o.Tags = v
}
