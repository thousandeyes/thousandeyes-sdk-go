...
// checks if the DnsServerTest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DnsServerTest{}

// DnsServerTest struct for DnsServerTest
...
type _DnsServerTest DnsServerTest

// NewDnsServerTest instantiates a new DnsServerTest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDnsServerTest(interval TestInterval, dnsServers []TestDnsServer, domain string) *DnsServerTest {
	this := DnsServerTest{}
...
// NewDnsServerTestWithDefaults instantiates a new DnsServerTest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDnsServerTestWithDefaults() *DnsServerTest {
	this := DnsServerTest{}
...
func (o *DnsServerTest) GetInterval() TestInterval {
	if o == nil {
...
func (o *DnsServerTest) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsServerTest) SetInterval(v TestInterval) {
	o.Interval = v
}

// GetAlertsEnabled returns the AlertsEnabled field value if set, zero value otherwise.
func (o *DnsServerTest) GetAlertsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *DnsServerTest) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *DnsServerTest) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *DnsServerTest) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *DnsServerTest) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
func (o *DnsServerTest) SetEnabled(v bool) {
	o.Enabled = &v
}

// GetAlertRules returns the AlertRules field value if set, zero value otherwise.
func (o *DnsServerTest) GetAlertRules() []AlertRule {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *DnsServerTest) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *DnsServerTest) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *DnsServerTest) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *DnsServerTest) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *DnsServerTest) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *DnsServerTest) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *DnsServerTest) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *DnsServerTest) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *DnsServerTest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *DnsServerTest) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *DnsServerTest) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *DnsServerTest) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *DnsServerTest) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *DnsServerTest) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *DnsServerTest) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *DnsServerTest) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *DnsServerTest) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *DnsServerTest) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *DnsServerTest) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *DnsServerTest) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *DnsServerTest) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *DnsServerTest) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *DnsServerTest) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *DnsServerTest) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *DnsServerTest) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
func (o *DnsServerTest) SetTestId(v string) {
	o.TestId = &v
}

// GetTestName returns the TestName field value if set, zero value otherwise.
func (o *DnsServerTest) GetTestName() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *DnsServerTest) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *DnsServerTest) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *DnsServerTest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *DnsServerTest) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *DnsServerTest) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *DnsServerTest) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *DnsServerTest) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *DnsServerTest) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *DnsServerTest) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *DnsServerTest) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *DnsServerTest) SetLabels(v []TestLabel) {
	o.Labels = v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *DnsServerTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *DnsServerTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *DnsServerTest) SetTags(v []TestTag) {
	o.Tags = v
}

// GetSharedWithAccounts returns the SharedWithAccounts field value if set, zero value otherwise.
func (o *DnsServerTest) GetSharedWithAccounts() []SharedWithAccount {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *DnsServerTest) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetBandwidthMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BandwidthMeasurements) {
		return nil, false
	}
...
func (o *DnsServerTest) HasBandwidthMeasurements() bool {
	if o != nil && !utils.IsNil(o.BandwidthMeasurements) {
		return true
	}
...
func (o *DnsServerTest) SetBandwidthMeasurements(v bool) {
	o.BandwidthMeasurements = &v
}

// GetDnsServers returns the DnsServers field value
func (o *DnsServerTest) GetDnsServers() []TestDnsServer {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetDnsServersOk() ([]TestDnsServer, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsServerTest) SetDnsServers(v []TestDnsServer) {
	o.DnsServers = v
}

// GetDnsTransportProtocol returns the DnsTransportProtocol field value if set, zero value otherwise.
func (o *DnsServerTest) GetDnsTransportProtocol() TestDnsTransportProtocol {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetDnsTransportProtocolOk() (*TestDnsTransportProtocol, bool) {
	if o == nil || utils.IsNil(o.DnsTransportProtocol) {
		return nil, false
	}
...
func (o *DnsServerTest) HasDnsTransportProtocol() bool {
	if o != nil && !utils.IsNil(o.DnsTransportProtocol) {
		return true
	}
...
func (o *DnsServerTest) SetDnsTransportProtocol(v TestDnsTransportProtocol) {
	o.DnsTransportProtocol = &v
}

// GetDomain returns the Domain field value
func (o *DnsServerTest) GetDomain() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetDomainOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetMtuMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.MtuMeasurements) {
		return nil, false
	}
...
func (o *DnsServerTest) HasMtuMeasurements() bool {
	if o != nil && !utils.IsNil(o.MtuMeasurements) {
		return true
	}
...
func (o *DnsServerTest) SetMtuMeasurements(v bool) {
	o.MtuMeasurements = &v
}

// GetNetworkMeasurements returns the NetworkMeasurements field value if set, zero value otherwise.
func (o *DnsServerTest) GetNetworkMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetNetworkMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.NetworkMeasurements) {
		return nil, false
	}
...
func (o *DnsServerTest) HasNetworkMeasurements() bool {
	if o != nil && !utils.IsNil(o.NetworkMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *DnsServerTest) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *DnsServerTest) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetPathTraceMode returns the PathTraceMode field value if set, zero value otherwise.
func (o *DnsServerTest) GetPathTraceMode() TestPathTraceMode {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetPathTraceModeOk() (*TestPathTraceMode, bool) {
	if o == nil || utils.IsNil(o.PathTraceMode) {
		return nil, false
	}
...
func (o *DnsServerTest) HasPathTraceMode() bool {
	if o != nil && !utils.IsNil(o.PathTraceMode) {
		return true
	}
...
func (o *DnsServerTest) SetPathTraceMode(v TestPathTraceMode) {
	o.PathTraceMode = &v
}

// GetProbeMode returns the ProbeMode field value if set, zero value otherwise.
func (o *DnsServerTest) GetProbeMode() TestProbeMode {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetProbeModeOk() (*TestProbeMode, bool) {
	if o == nil || utils.IsNil(o.ProbeMode) {
		return nil, false
	}
...
func (o *DnsServerTest) HasProbeMode() bool {
	if o != nil && !utils.IsNil(o.ProbeMode) {
		return true
	}
...
func (o *DnsServerTest) SetProbeMode(v TestProbeMode) {
	o.ProbeMode = &v
}

// GetProtocol returns the Protocol field value if set, zero value otherwise.
func (o *DnsServerTest) GetProtocol() TestProtocol {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetProtocolOk() (*TestProtocol, bool) {
	if o == nil || utils.IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *DnsServerTest) HasProtocol() bool {
	if o != nil && !utils.IsNil(o.Protocol) {
		return true
	}
...
func (o *DnsServerTest) SetProtocol(v TestProtocol) {
	o.Protocol = &v
}

// GetRandomizedStartTime returns the RandomizedStartTime field value if set, zero value otherwise.
func (o *DnsServerTest) GetRandomizedStartTime() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *DnsServerTest) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetRecursiveQueriesOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RecursiveQueries) {
		return nil, false
	}
...
func (o *DnsServerTest) HasRecursiveQueries() bool {
	if o != nil && !utils.IsNil(o.RecursiveQueries) {
		return true
	}
...
func (o *DnsServerTest) SetRecursiveQueries(v bool) {
	o.RecursiveQueries = &v
}

// GetIpv6Policy returns the Ipv6Policy field value if set, zero value otherwise.
func (o *DnsServerTest) GetIpv6Policy() TestIpv6Policy {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetIpv6PolicyOk() (*TestIpv6Policy, bool) {
	if o == nil || utils.IsNil(o.Ipv6Policy) {
		return nil, false
	}
...
func (o *DnsServerTest) HasIpv6Policy() bool {
	if o != nil && !utils.IsNil(o.Ipv6Policy) {
		return true
	}
...
func (o *DnsServerTest) SetIpv6Policy(v TestIpv6Policy) {
	o.Ipv6Policy = &v
}

// GetFixedPacketRate returns the FixedPacketRate field value if set, zero value otherwise.
func (o *DnsServerTest) GetFixedPacketRate() int32 {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetFixedPacketRateOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.FixedPacketRate) {
		return nil, false
	}
...
func (o *DnsServerTest) HasFixedPacketRate() bool {
	if o != nil && !utils.IsNil(o.FixedPacketRate) {
		return true
	}
...
func (o *DnsServerTest) SetFixedPacketRate(v int32) {
	o.FixedPacketRate = &v
}

// GetDnsQueryClass returns the DnsQueryClass field value if set, zero value otherwise.
func (o *DnsServerTest) GetDnsQueryClass() DnsQueryClass {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetDnsQueryClassOk() (*DnsQueryClass, bool) {
	if o == nil || utils.IsNil(o.DnsQueryClass) {
		return nil, false
	}
...
func (o *DnsServerTest) HasDnsQueryClass() bool {
	if o != nil && !utils.IsNil(o.DnsQueryClass) {
		return true
	}
...
func (o *DnsServerTest) SetDnsQueryClass(v DnsQueryClass) {
	o.DnsQueryClass = &v
}

// GetBgpMeasurements returns the BgpMeasurements field value if set, zero value otherwise.
func (o *DnsServerTest) GetBgpMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetBgpMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BgpMeasurements) {
		return nil, false
	}
...
func (o *DnsServerTest) HasBgpMeasurements() bool {
	if o != nil && !utils.IsNil(o.BgpMeasurements) {
		return true
	}
...
func (o *DnsServerTest) SetBgpMeasurements(v bool) {
	o.BgpMeasurements = &v
}

// GetUsePublicBgp returns the UsePublicBgp field value if set, zero value otherwise.
func (o *DnsServerTest) GetUsePublicBgp() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetUsePublicBgpOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UsePublicBgp) {
		return nil, false
	}
...
func (o *DnsServerTest) HasUsePublicBgp() bool {
	if o != nil && !utils.IsNil(o.UsePublicBgp) {
		return true
	}
...
func (o *DnsServerTest) SetUsePublicBgp(v bool) {
	o.UsePublicBgp = &v
}

// GetMonitors returns the Monitors field value if set, zero value otherwise.
func (o *DnsServerTest) GetMonitors() []Monitor {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTest) GetMonitorsOk() ([]Monitor, bool) {
	if o == nil || utils.IsNil(o.Monitors) {
		return nil, false
	}
...
func (o *DnsServerTest) HasMonitors() bool {
	if o != nil && !utils.IsNil(o.Monitors) {
		return true
	}
...
func (o *DnsServerTest) SetMonitors(v []Monitor) {
	o.Monitors = v
}

func (o DnsServerTest) MarshalJSON() ([]byte, error) {
...
func (o DnsServerTest) ToMap() (map[string]interface{}, error) {
...
func (o *DnsServerTest) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsServerTest := _DnsServerTest{}

    err = json.Unmarshal(data, &varDnsServerTest)

	if err != nil {
		return err
	}

	*o = DnsServerTest(varDnsServerTest)

	return err
}

type NullableDnsServerTest struct {
	value *DnsServerTest
	isSet bool
}

func (v NullableDnsServerTest) Get() *DnsServerTest {
	return v.value
}

func (v *NullableDnsServerTest) Set(val *DnsServerTest) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsServerTest) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsServerTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsServerTest(val *DnsServerTest) *NullableDnsServerTest {
	return &NullableDnsServerTest{value: val, isSet: true}
}

func (v NullableDnsServerTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsServerTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
