...
func (o *AgentToServerInstantTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *AgentToServerInstantTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *AgentToServerInstantTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *AgentToServerInstantTest) SetTags(v []TestTag) {
	o.Tags = v
}
