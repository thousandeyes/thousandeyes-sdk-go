...
func (o *AgentToAgentInstantTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *AgentToAgentInstantTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *AgentToAgentInstantTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *AgentToAgentInstantTest) SetTags(v []TestTag) {
	o.Tags = v
}
