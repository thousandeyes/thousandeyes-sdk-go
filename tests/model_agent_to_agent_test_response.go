...
func (o *AgentToAgentTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *AgentToAgentTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *AgentToAgentTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *AgentToAgentTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}
...
func (o *AgentToAgentTestResponse) GetAgents() []TestAgentResponse {
...
// and a boolean to check if the value has been set.
func (o *AgentToAgentTestResponse) GetAgentsOk() ([]TestAgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *AgentToAgentTestResponse) SetAgents(v []TestAgentResponse) {
	o.Agents = v
}
