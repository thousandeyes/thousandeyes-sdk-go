...
// checks if the ApiTest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ApiTest{}

// ApiTest struct for ApiTest
type ApiTest struct {
...
type _ApiTest ApiTest

// NewApiTest instantiates a new ApiTest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewApiTest(interval TestInterval, requests []ApiRequest, url string) *ApiTest {
	this := ApiTest{}
...
// NewApiTestWithDefaults instantiates a new ApiTest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewApiTestWithDefaults() *ApiTest {
	this := ApiTest{}
...
func (o *ApiTest) GetInterval() TestInterval {
	if o == nil {
...
func (o *ApiTest) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *ApiTest) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *ApiTest) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *ApiTest) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *ApiTest) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *ApiTest) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *ApiTest) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *ApiTest) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *ApiTest) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *ApiTest) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *ApiTest) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *ApiTest) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *ApiTest) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *ApiTest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *ApiTest) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *ApiTest) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *ApiTest) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *ApiTest) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *ApiTest) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *ApiTest) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *ApiTest) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *ApiTest) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *ApiTest) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *ApiTest) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *ApiTest) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *ApiTest) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *ApiTest) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *ApiTest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *ApiTest) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *ApiTest) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ApiTest) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *ApiTest) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *ApiTest) GetSharedWithAccounts() []SharedWithAccount {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *ApiTest) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetClientCertificateOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ClientCertificate) {
		return nil, false
	}
...
func (o *ApiTest) HasClientCertificate() bool {
	if o != nil && !utils.IsNil(o.ClientCertificate) {
		return true
	}
...
func (o *ApiTest) SetClientCertificate(v string) {
...
func (o *ApiTest) GetClientCertDomainsAllowList() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetClientCertDomainsAllowListOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ClientCertDomainsAllowList) {
		return nil, false
	}
...
func (o *ApiTest) HasClientCertDomainsAllowList() bool {
	if o != nil && !utils.IsNil(o.ClientCertDomainsAllowList) {
		return true
	}
...
func (o *ApiTest) SetClientCertDomainsAllowList(v string) {
...
func (o *ApiTest) GetCollectProxyNetworkData() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetCollectProxyNetworkDataOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.CollectProxyNetworkData) {
		return nil, false
	}
...
func (o *ApiTest) HasCollectProxyNetworkData() bool {
	if o != nil && !utils.IsNil(o.CollectProxyNetworkData) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetDistributedTracingOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.DistributedTracing) {
		return nil, false
	}
...
func (o *ApiTest) HasDistributedTracing() bool {
	if o != nil && !utils.IsNil(o.DistributedTracing) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetFollowRedirectsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.FollowRedirects) {
		return nil, false
	}
...
func (o *ApiTest) HasFollowRedirects() bool {
	if o != nil && !utils.IsNil(o.FollowRedirects) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetMtuMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.MtuMeasurements) {
		return nil, false
	}
...
func (o *ApiTest) HasMtuMeasurements() bool {
	if o != nil && !utils.IsNil(o.MtuMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetNetworkMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.NetworkMeasurements) {
		return nil, false
	}
...
func (o *ApiTest) HasNetworkMeasurements() bool {
	if o != nil && !utils.IsNil(o.NetworkMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *ApiTest) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetOverrideAgentProxyOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.OverrideAgentProxy) {
		return nil, false
	}
...
func (o *ApiTest) HasOverrideAgentProxy() bool {
	if o != nil && !utils.IsNil(o.OverrideAgentProxy) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetOverrideProxyIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.OverrideProxyId) {
		return nil, false
	}
...
func (o *ApiTest) HasOverrideProxyId() bool {
	if o != nil && !utils.IsNil(o.OverrideProxyId) {
		return true
	}
...
func (o *ApiTest) SetOverrideProxyId(v string) {
	o.OverrideProxyId = &v
}

// GetPathTraceMode returns the PathTraceMode field value if set, zero value otherwise.
func (o *ApiTest) GetPathTraceMode() TestPathTraceMode {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetPathTraceModeOk() (*TestPathTraceMode, bool) {
	if o == nil || utils.IsNil(o.PathTraceMode) {
		return nil, false
	}
...
func (o *ApiTest) HasPathTraceMode() bool {
	if o != nil && !utils.IsNil(o.PathTraceMode) {
		return true
	}
...
func (o *ApiTest) SetPathTraceMode(v TestPathTraceMode) {
	o.PathTraceMode = &v
}

// GetPredefinedVariables returns the PredefinedVariables field value if set, zero value otherwise.
func (o *ApiTest) GetPredefinedVariables() []ApiPredefinedVariable {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetPredefinedVariablesOk() ([]ApiPredefinedVariable, bool) {
	if o == nil || utils.IsNil(o.PredefinedVariables) {
		return nil, false
	}
...
func (o *ApiTest) HasPredefinedVariables() bool {
	if o != nil && !utils.IsNil(o.PredefinedVariables) {
		return true
	}
...
func (o *ApiTest) SetPredefinedVariables(v []ApiPredefinedVariable) {
	o.PredefinedVariables = v
}

// GetProbeMode returns the ProbeMode field value if set, zero value otherwise.
func (o *ApiTest) GetProbeMode() TestProbeMode {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetProbeModeOk() (*TestProbeMode, bool) {
	if o == nil || utils.IsNil(o.ProbeMode) {
		return nil, false
	}
...
func (o *ApiTest) HasProbeMode() bool {
	if o != nil && !utils.IsNil(o.ProbeMode) {
		return true
	}
...
func (o *ApiTest) SetProbeMode(v TestProbeMode) {
	o.ProbeMode = &v
}

// GetProtocol returns the Protocol field value if set, zero value otherwise.
func (o *ApiTest) GetProtocol() TestProtocol {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetProtocolOk() (*TestProtocol, bool) {
	if o == nil || utils.IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *ApiTest) HasProtocol() bool {
	if o != nil && !utils.IsNil(o.Protocol) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *ApiTest) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
func (o *ApiTest) SetRandomizedStartTime(v bool) {
	o.RandomizedStartTime = &v
}

// GetRequests returns the Requests field value
func (o *ApiTest) GetRequests() []ApiRequest {
	if o == nil {
		var ret []ApiRequest
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetRequestsOk() ([]ApiRequest, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApiTest) SetRequests(v []ApiRequest) {
	o.Requests = v
}

// GetSslVersionId returns the SslVersionId field value if set, zero value otherwise.
func (o *ApiTest) GetSslVersionId() TestSslVersionId {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetSslVersionIdOk() (*TestSslVersionId, bool) {
	if o == nil || utils.IsNil(o.SslVersionId) {
		return nil, false
	}
...
func (o *ApiTest) HasSslVersionId() bool {
	if o != nil && !utils.IsNil(o.SslVersionId) {
		return true
	}
...
func (o *ApiTest) SetSslVersionId(v TestSslVersionId) {
	o.SslVersionId = &v
}

// GetTargetTime returns the TargetTime field value if set, zero value otherwise.
func (o *ApiTest) GetTargetTime() int32 {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetTargetTimeOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.TargetTime) {
		return nil, false
	}
...
func (o *ApiTest) HasTargetTime() bool {
	if o != nil && !utils.IsNil(o.TargetTime) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetTimeLimitOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.TimeLimit) {
		return nil, false
	}
...
func (o *ApiTest) HasTimeLimit() bool {
	if o != nil && !utils.IsNil(o.TimeLimit) {
		return true
	}
...
func (o *ApiTest) SetTimeLimit(v int32) {
	o.TimeLimit = &v
}

// GetUrl returns the Url field value
func (o *ApiTest) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *ApiTest) SetUrl(v string) {
	o.Url = v
}

// GetCredentials returns the Credentials field value if set, zero value otherwise.
func (o *ApiTest) GetCredentials() []string {
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetCredentialsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Credentials) {
		return nil, false
	}
...
func (o *ApiTest) HasCredentials() bool {
	if o != nil && !utils.IsNil(o.Credentials) {
		return true
	}
...
func (o *ApiTest) SetCredentials(v []string) {
	o.Credentials = v
}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetBgpMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BgpMeasurements) {
		return nil, false
	}
...
func (o *ApiTest) HasBgpMeasurements() bool {
	if o != nil && !utils.IsNil(o.BgpMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetUsePublicBgpOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UsePublicBgp) {
		return nil, false
	}
...
func (o *ApiTest) HasUsePublicBgp() bool {
	if o != nil && !utils.IsNil(o.UsePublicBgp) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTest) GetMonitorsOk() ([]Monitor, bool) {
	if o == nil || utils.IsNil(o.Monitors) {
		return nil, false
	}
...
func (o *ApiTest) HasMonitors() bool {
	if o != nil && !utils.IsNil(o.Monitors) {
		return true
	}
...
func (o *ApiTest) SetMonitors(v []Monitor) {
	o.Monitors = v
}

func (o ApiTest) MarshalJSON() ([]byte, error) {
...
func (o ApiTest) ToMap() (map[string]interface{}, error) {
...
func (o *ApiTest) UnmarshalJSON(data []byte) (err error) {
    ...
    err = json.Unmarshal(data, &varApiTest)

	if err != nil {
		return err
	}

	*o = ApiTest(varApiTest)

	return err
}

type NullableApiTest struct {
	value *ApiTest
	isSet bool
}

func (v NullableApiTest) Get() *ApiTest {
	return v.value
}

func (v *NullableApiTest) Set(val *ApiTest) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTest) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTest(val *ApiTest) *NullableApiTest {
	return &NullableApiTest{value: val, isSet: true}
}

func (v NullableApiTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
