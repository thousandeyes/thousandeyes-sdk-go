...
func (o *AgentToServerTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *AgentToServerTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *AgentToServerTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *AgentToServerTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}
...
func (o *AgentToServerTestResponse) GetAgents() []TestAgentResponse {
...
// and a boolean to check if the value has been set.
func (o *AgentToServerTestResponse) GetAgentsOk() ([]TestAgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *AgentToServerTestResponse) SetAgents(v []TestAgentResponse) {
	o.Agents = v
}
