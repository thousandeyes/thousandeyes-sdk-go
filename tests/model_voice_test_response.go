...
func (o *VoiceTestResponse) GetAgents() []AgentResponse {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetAgentsOk() ([]AgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *VoiceTestResponse) SetAgents(v []AgentResponse) {
	o.Agents = v
}
