...
// checks if the VoiceTestResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VoiceTestResponse{}

// VoiceTestResponse struct for VoiceTestResponse
...
type _VoiceTestResponse VoiceTestResponse

// NewVoiceTestResponse instantiates a new VoiceTestResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewVoiceTestResponse(interval TestInterval, targetAgentId string) *VoiceTestResponse {
	this := VoiceTestResponse{}
...
// NewVoiceTestResponseWithDefaults instantiates a new VoiceTestResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewVoiceTestResponseWithDefaults() *VoiceTestResponse {
	this := VoiceTestResponse{}
...
func (o *VoiceTestResponse) GetInterval() TestInterval {
	if o == nil {
...
func (o *VoiceTestResponse) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VoiceTestResponse) SetInterval(v TestInterval) {
	o.Interval = v
}

// GetAlertsEnabled returns the AlertsEnabled field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetAlertsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *VoiceTestResponse) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
func (o *VoiceTestResponse) SetEnabled(v bool) {
	o.Enabled = &v
}

// GetAlertRules returns the AlertRules field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetAlertRules() []AlertRule {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *VoiceTestResponse) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *VoiceTestResponse) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *VoiceTestResponse) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *VoiceTestResponse) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *VoiceTestResponse) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *VoiceTestResponse) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *VoiceTestResponse) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *VoiceTestResponse) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
func (o *VoiceTestResponse) SetTestId(v string) {
	o.TestId = &v
}

// GetTestName returns the TestName field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetTestName() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *VoiceTestResponse) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *VoiceTestResponse) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *VoiceTestResponse) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *VoiceTestResponse) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *VoiceTestResponse) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *VoiceTestResponse) SetLabels(v []TestLabel) {
	o.Labels = v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *VoiceTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *VoiceTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}

// GetSharedWithAccounts returns the SharedWithAccounts field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetSharedWithAccounts() []SharedWithAccount {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
func (o *VoiceTestResponse) SetSharedWithAccounts(v []SharedWithAccount) {
	o.SharedWithAccounts = v
}

// GetCodec returns the Codec field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetCodec() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetCodecOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Codec) {
		return nil, false
	}
	return o.Codec, true
...
func (o *VoiceTestResponse) HasCodec() bool {
	if o != nil && !utils.IsNil(o.Codec) {
		return true
	}
...
func (o *VoiceTestResponse) SetCodec(v string) {
	o.Codec = &v
}

// GetCodecId returns the CodecId field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetCodecId() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetCodecIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CodecId) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasCodecId() bool {
	if o != nil && !utils.IsNil(o.CodecId) {
		return true
	}
...
func (o *VoiceTestResponse) SetCodecId(v string) {
	o.CodecId = &v
}

// GetDscp returns the Dscp field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetDscp() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetDscpOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Dscp) {
		return nil, false
	}
	return o.Dscp, true
...
func (o *VoiceTestResponse) HasDscp() bool {
	if o != nil && !utils.IsNil(o.Dscp) {
		return true
	}
...
func (o *VoiceTestResponse) SetDscp(v string) {
	o.Dscp = &v
}

// GetDscpId returns the DscpId field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetDscpId() TestDscpId {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetDscpIdOk() (*TestDscpId, bool) {
	if o == nil || utils.IsNil(o.DscpId) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasDscpId() bool {
	if o != nil && !utils.IsNil(o.DscpId) {
		return true
	}
...
func (o *VoiceTestResponse) SetDscpId(v TestDscpId) {
	o.DscpId = &v
}

// GetDuration returns the Duration field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetDuration() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetDurationOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Duration) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasDuration() bool {
	if o != nil && !utils.IsNil(o.Duration) {
		return true
	}
...
func (o *VoiceTestResponse) SetDuration(v int32) {
	o.Duration = &v
}

// GetJitterBuffer returns the JitterBuffer field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetJitterBuffer() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetJitterBufferOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.JitterBuffer) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasJitterBuffer() bool {
	if o != nil && !utils.IsNil(o.JitterBuffer) {
		return true
	}
...
func (o *VoiceTestResponse) SetJitterBuffer(v int32) {
	o.JitterBuffer = &v
}

// GetNumPathTraces returns the NumPathTraces field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetNumPathTraces() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *VoiceTestResponse) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetPort returns the Port field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetPort() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetPortOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Port) {
		return nil, false
	}
	return o.Port, true
...
func (o *VoiceTestResponse) HasPort() bool {
	if o != nil && !utils.IsNil(o.Port) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
func (o *VoiceTestResponse) SetRandomizedStartTime(v bool) {
	o.RandomizedStartTime = &v
}

// GetTargetAgentId returns the TargetAgentId field value
func (o *VoiceTestResponse) GetTargetAgentId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetTargetAgentIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VoiceTestResponse) SetTargetAgentId(v string) {
	o.TargetAgentId = v
}

// GetBgpMeasurements returns the BgpMeasurements field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetBgpMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetBgpMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BgpMeasurements) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasBgpMeasurements() bool {
	if o != nil && !utils.IsNil(o.BgpMeasurements) {
		return true
	}
...
func (o *VoiceTestResponse) SetBgpMeasurements(v bool) {
	o.BgpMeasurements = &v
}

// GetUsePublicBgp returns the UsePublicBgp field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetUsePublicBgp() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetUsePublicBgpOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UsePublicBgp) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasUsePublicBgp() bool {
	if o != nil && !utils.IsNil(o.UsePublicBgp) {
		return true
	}
...
func (o *VoiceTestResponse) SetUsePublicBgp(v bool) {
	o.UsePublicBgp = &v
}

// GetMonitors returns the Monitors field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetMonitors() []Monitor {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetMonitorsOk() ([]Monitor, bool) {
	if o == nil || utils.IsNil(o.Monitors) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasMonitors() bool {
	if o != nil && !utils.IsNil(o.Monitors) {
		return true
	}
...
func (o *VoiceTestResponse) SetMonitors(v []Monitor) {
	o.Monitors = v
}

// GetAgents returns the Agents field value if set, zero value otherwise.
func (o *VoiceTestResponse) GetAgents() []TestAgentResponse {
...
// and a boolean to check if the value has been set.
func (o *VoiceTestResponse) GetAgentsOk() ([]TestAgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *VoiceTestResponse) HasAgents() bool {
	if o != nil && !utils.IsNil(o.Agents) {
		return true
	}
...
func (o *VoiceTestResponse) SetAgents(v []TestAgentResponse) {
	o.Agents = v
}

func (o VoiceTestResponse) MarshalJSON() ([]byte, error) {
...
func (o VoiceTestResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VoiceTestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVoiceTestResponse := _VoiceTestResponse{}

    err = json.Unmarshal(data, &varVoiceTestResponse)

	if err != nil {
		return err
	}

	*o = VoiceTestResponse(varVoiceTestResponse)

	return err
}

type NullableVoiceTestResponse struct {
	value *VoiceTestResponse
	isSet bool
}

func (v NullableVoiceTestResponse) Get() *VoiceTestResponse {
	return v.value
}

func (v *NullableVoiceTestResponse) Set(val *VoiceTestResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVoiceTestResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVoiceTestResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoiceTestResponse(val *VoiceTestResponse) *NullableVoiceTestResponse {
	return &NullableVoiceTestResponse{value: val, isSet: true}
}

func (v NullableVoiceTestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoiceTestResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
