...
// checks if the ApiTestResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ApiTestResponse{}

// ApiTestResponse struct for ApiTestResponse
...
type _ApiTestResponse ApiTestResponse

// NewApiTestResponse instantiates a new ApiTestResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewApiTestResponse(interval TestInterval, requests []ApiRequest, url string) *ApiTestResponse {
	this := ApiTestResponse{}
...
// NewApiTestResponseWithDefaults instantiates a new ApiTestResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewApiTestResponseWithDefaults() *ApiTestResponse {
	this := ApiTestResponse{}
...
func (o *ApiTestResponse) GetInterval() TestInterval {
	if o == nil {
...
func (o *ApiTestResponse) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApiTestResponse) SetInterval(v TestInterval) {
	o.Interval = v
}

// GetAlertsEnabled returns the AlertsEnabled field value if set, zero value otherwise.
func (o *ApiTestResponse) GetAlertsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *ApiTestResponse) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *ApiTestResponse) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
func (o *ApiTestResponse) SetEnabled(v bool) {
	o.Enabled = &v
}

// GetAlertRules returns the AlertRules field value if set, zero value otherwise.
func (o *ApiTestResponse) GetAlertRules() []AlertRule {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *ApiTestResponse) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *ApiTestResponse) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *ApiTestResponse) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *ApiTestResponse) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *ApiTestResponse) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *ApiTestResponse) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *ApiTestResponse) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *ApiTestResponse) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *ApiTestResponse) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *ApiTestResponse) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *ApiTestResponse) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *ApiTestResponse) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *ApiTestResponse) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *ApiTestResponse) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *ApiTestResponse) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *ApiTestResponse) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
func (o *ApiTestResponse) SetTestId(v string) {
	o.TestId = &v
}

// GetTestName returns the TestName field value if set, zero value otherwise.
func (o *ApiTestResponse) GetTestName() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *ApiTestResponse) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *ApiTestResponse) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *ApiTestResponse) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *ApiTestResponse) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *ApiTestResponse) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ApiTestResponse) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *ApiTestResponse) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *ApiTestResponse) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *ApiTestResponse) SetLabels(v []TestLabel) {
	o.Labels = v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *ApiTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *ApiTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *ApiTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}

// GetSharedWithAccounts returns the SharedWithAccounts field value if set, zero value otherwise.
func (o *ApiTestResponse) GetSharedWithAccounts() []SharedWithAccount {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
func (o *ApiTestResponse) SetSharedWithAccounts(v []SharedWithAccount) {
	o.SharedWithAccounts = v
}

// GetClientCertificate returns the ClientCertificate field value if set, zero value otherwise.
func (o *ApiTestResponse) GetClientCertificate() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetClientCertificateOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ClientCertificate) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasClientCertificate() bool {
	if o != nil && !utils.IsNil(o.ClientCertificate) {
		return true
	}
...
func (o *ApiTestResponse) SetClientCertificate(v string) {
	o.ClientCertificate = &v
}

// GetClientCertDomainsAllowList returns the ClientCertDomainsAllowList field value if set, zero value otherwise.
func (o *ApiTestResponse) GetClientCertDomainsAllowList() string {
	if o == nil || utils.IsNil(o.ClientCertDomainsAllowList) {
		var ret string
		return ret
	}
	return *o.ClientCertDomainsAllowList
}

// GetClientCertDomainsAllowListOk returns a tuple with the ClientCertDomainsAllowList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetClientCertDomainsAllowListOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ClientCertDomainsAllowList) {
		return nil, false
	}
	return o.ClientCertDomainsAllowList, true
}

// HasClientCertDomainsAllowList returns a boolean if a field has been set.
func (o *ApiTestResponse) HasClientCertDomainsAllowList() bool {
	if o != nil && !utils.IsNil(o.ClientCertDomainsAllowList) {
		return true
	}
...
// SetClientCertDomainsAllowList gets a reference to the given string and assigns it to the ClientCertDomainsAllowList field.
func (o *ApiTestResponse) SetClientCertDomainsAllowList(v string) {
	o.ClientCertDomainsAllowList = &v
}

// GetCollectProxyNetworkData returns the CollectProxyNetworkData field value if set, zero value otherwise.
func (o *ApiTestResponse) GetCollectProxyNetworkData() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetCollectProxyNetworkDataOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.CollectProxyNetworkData) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasCollectProxyNetworkData() bool {
	if o != nil && !utils.IsNil(o.CollectProxyNetworkData) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetDistributedTracingOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.DistributedTracing) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasDistributedTracing() bool {
	if o != nil && !utils.IsNil(o.DistributedTracing) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetFollowRedirectsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.FollowRedirects) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasFollowRedirects() bool {
	if o != nil && !utils.IsNil(o.FollowRedirects) {
		return true
	}
...
func (o *ApiTestResponse) SetFollowRedirects(v bool) {
	o.FollowRedirects = &v
}

// GetMtuMeasurements returns the MtuMeasurements field value if set, zero value otherwise.
func (o *ApiTestResponse) GetMtuMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetMtuMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.MtuMeasurements) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasMtuMeasurements() bool {
	if o != nil && !utils.IsNil(o.MtuMeasurements) {
		return true
	}
...
func (o *ApiTestResponse) SetMtuMeasurements(v bool) {
	o.MtuMeasurements = &v
}

// GetNetworkMeasurements returns the NetworkMeasurements field value if set, zero value otherwise.
func (o *ApiTestResponse) GetNetworkMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetNetworkMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.NetworkMeasurements) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasNetworkMeasurements() bool {
	if o != nil && !utils.IsNil(o.NetworkMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *ApiTestResponse) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetOverrideAgentProxy returns the OverrideAgentProxy field value if set, zero value otherwise.
func (o *ApiTestResponse) GetOverrideAgentProxy() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetOverrideAgentProxyOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.OverrideAgentProxy) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasOverrideAgentProxy() bool {
	if o != nil && !utils.IsNil(o.OverrideAgentProxy) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetOverrideProxyIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.OverrideProxyId) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasOverrideProxyId() bool {
	if o != nil && !utils.IsNil(o.OverrideProxyId) {
		return true
	}
...
func (o *ApiTestResponse) SetOverrideProxyId(v string) {
	o.OverrideProxyId = &v
}

// GetPathTraceMode returns the PathTraceMode field value if set, zero value otherwise.
func (o *ApiTestResponse) GetPathTraceMode() TestPathTraceMode {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetPathTraceModeOk() (*TestPathTraceMode, bool) {
	if o == nil || utils.IsNil(o.PathTraceMode) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasPathTraceMode() bool {
	if o != nil && !utils.IsNil(o.PathTraceMode) {
		return true
	}
...
func (o *ApiTestResponse) SetPathTraceMode(v TestPathTraceMode) {
	o.PathTraceMode = &v
}

// GetPredefinedVariables returns the PredefinedVariables field value if set, zero value otherwise.
func (o *ApiTestResponse) GetPredefinedVariables() []ApiPredefinedVariable {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetPredefinedVariablesOk() ([]ApiPredefinedVariable, bool) {
	if o == nil || utils.IsNil(o.PredefinedVariables) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasPredefinedVariables() bool {
	if o != nil && !utils.IsNil(o.PredefinedVariables) {
		return true
	}
...
func (o *ApiTestResponse) SetPredefinedVariables(v []ApiPredefinedVariable) {
	o.PredefinedVariables = v
}

// GetProbeMode returns the ProbeMode field value if set, zero value otherwise.
func (o *ApiTestResponse) GetProbeMode() TestProbeMode {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetProbeModeOk() (*TestProbeMode, bool) {
	if o == nil || utils.IsNil(o.ProbeMode) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasProbeMode() bool {
	if o != nil && !utils.IsNil(o.ProbeMode) {
		return true
	}
...
func (o *ApiTestResponse) SetProbeMode(v TestProbeMode) {
	o.ProbeMode = &v
}

// GetProtocol returns the Protocol field value if set, zero value otherwise.
func (o *ApiTestResponse) GetProtocol() TestProtocol {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetProtocolOk() (*TestProtocol, bool) {
	if o == nil || utils.IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasProtocol() bool {
	if o != nil && !utils.IsNil(o.Protocol) {
		return true
	}
...
func (o *ApiTestResponse) SetProtocol(v TestProtocol) {
	o.Protocol = &v
}

// GetRandomizedStartTime returns the RandomizedStartTime field value if set, zero value otherwise.
func (o *ApiTestResponse) GetRandomizedStartTime() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
func (o *ApiTestResponse) SetRandomizedStartTime(v bool) {
	o.RandomizedStartTime = &v
}

// GetRequests returns the Requests field value
func (o *ApiTestResponse) GetRequests() []ApiRequest {
	if o == nil {
		var ret []ApiRequest
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetRequestsOk() ([]ApiRequest, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApiTestResponse) SetRequests(v []ApiRequest) {
	o.Requests = v
}

// GetSslVersionId returns the SslVersionId field value if set, zero value otherwise.
func (o *ApiTestResponse) GetSslVersionId() TestSslVersionId {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetSslVersionIdOk() (*TestSslVersionId, bool) {
	if o == nil || utils.IsNil(o.SslVersionId) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasSslVersionId() bool {
	if o != nil && !utils.IsNil(o.SslVersionId) {
		return true
	}
...
func (o *ApiTestResponse) SetSslVersionId(v TestSslVersionId) {
	o.SslVersionId = &v
}

// GetTargetTime returns the TargetTime field value if set, zero value otherwise.
func (o *ApiTestResponse) GetTargetTime() int32 {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetTargetTimeOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.TargetTime) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasTargetTime() bool {
	if o != nil && !utils.IsNil(o.TargetTime) {
		return true
	}
...
func (o *ApiTestResponse) SetTargetTime(v int32) {
	o.TargetTime = &v
}

// GetTimeLimit returns the TimeLimit field value if set, zero value otherwise.
func (o *ApiTestResponse) GetTimeLimit() int32 {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetTimeLimitOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.TimeLimit) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasTimeLimit() bool {
	if o != nil && !utils.IsNil(o.TimeLimit) {
		return true
	}
...
func (o *ApiTestResponse) SetTimeLimit(v int32) {
	o.TimeLimit = &v
}

// GetUrl returns the Url field value
func (o *ApiTestResponse) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *ApiTestResponse) SetUrl(v string) {
	o.Url = v
}

// GetCredentials returns the Credentials field value if set, zero value otherwise.
func (o *ApiTestResponse) GetCredentials() []string {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetCredentialsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Credentials) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasCredentials() bool {
	if o != nil && !utils.IsNil(o.Credentials) {
		return true
	}
...
func (o *ApiTestResponse) SetCredentials(v []string) {
	o.Credentials = v
}

// GetVaultCredentials returns the VaultCredentials field value if set, zero value otherwise.
func (o *ApiTestResponse) GetVaultCredentials() []TestVaultCredential {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetVaultCredentialsOk() ([]TestVaultCredential, bool) {
	if o == nil || utils.IsNil(o.VaultCredentials) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasVaultCredentials() bool {
	if o != nil && !utils.IsNil(o.VaultCredentials) {
		return true
	}
...
func (o *ApiTestResponse) SetVaultCredentials(v []TestVaultCredential) {
	o.VaultCredentials = v
}

// GetBgpMeasurements returns the BgpMeasurements field value if set, zero value otherwise.
func (o *ApiTestResponse) GetBgpMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetBgpMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BgpMeasurements) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasBgpMeasurements() bool {
	if o != nil && !utils.IsNil(o.BgpMeasurements) {
		return true
	}
...
func (o *ApiTestResponse) SetBgpMeasurements(v bool) {
	o.BgpMeasurements = &v
}

// GetUsePublicBgp returns the UsePublicBgp field value if set, zero value otherwise.
func (o *ApiTestResponse) GetUsePublicBgp() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetUsePublicBgpOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UsePublicBgp) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasUsePublicBgp() bool {
	if o != nil && !utils.IsNil(o.UsePublicBgp) {
		return true
	}
...
func (o *ApiTestResponse) SetUsePublicBgp(v bool) {
	o.UsePublicBgp = &v
}

// GetMonitors returns the Monitors field value if set, zero value otherwise.
func (o *ApiTestResponse) GetMonitors() []Monitor {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetMonitorsOk() ([]Monitor, bool) {
	if o == nil || utils.IsNil(o.Monitors) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasMonitors() bool {
	if o != nil && !utils.IsNil(o.Monitors) {
		return true
	}
...
func (o *ApiTestResponse) SetMonitors(v []Monitor) {
	o.Monitors = v
}

// GetAgents returns the Agents field value if set, zero value otherwise.
func (o *ApiTestResponse) GetAgents() []TestAgentResponse {
...
// and a boolean to check if the value has been set.
func (o *ApiTestResponse) GetAgentsOk() ([]TestAgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *ApiTestResponse) HasAgents() bool {
	if o != nil && !utils.IsNil(o.Agents) {
		return true
	}
...
func (o *ApiTestResponse) SetAgents(v []TestAgentResponse) {
	o.Agents = v
}

func (o ApiTestResponse) MarshalJSON() ([]byte, error) {
...
func (o ApiTestResponse) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.ClientCertDomainsAllowList) {
		toSerialize["clientCertDomainsAllowList"] = o.ClientCertDomainsAllowList
	}
...
func (o *ApiTestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varApiTestResponse := _ApiTestResponse{}

    err = json.Unmarshal(data, &varApiTestResponse)

	if err != nil {
		return err
	}

	*o = ApiTestResponse(varApiTestResponse)

	return err
}

type NullableApiTestResponse struct {
	value *ApiTestResponse
	isSet bool
}

func (v NullableApiTestResponse) Get() *ApiTestResponse {
	return v.value
}

func (v *NullableApiTestResponse) Set(val *ApiTestResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTestResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTestResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTestResponse(val *ApiTestResponse) *NullableApiTestResponse {
	return &NullableApiTestResponse{value: val, isSet: true}
}

func (v NullableApiTestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTestResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
