...
func (o *ApiInstantTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *ApiInstantTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *ApiInstantTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *ApiInstantTest) SetTags(v []TestTag) {
	o.Tags = v
}
...
func (o *ApiInstantTest) GetClientCertificate() string {
...
// and a boolean to check if the value has been set.
func (o *ApiInstantTest) GetClientCertificateOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ClientCertificate) {
		return nil, false
	}
...
func (o *ApiInstantTest) HasClientCertificate() bool {
	if o != nil && !utils.IsNil(o.ClientCertificate) {
		return true
	}
...
func (o *ApiInstantTest) SetClientCertificate(v string) {
...
func (o *ApiInstantTest) GetClientCertDomainsAllowList() string {
...
// and a boolean to check if the value has been set.
func (o *ApiInstantTest) GetClientCertDomainsAllowListOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ClientCertDomainsAllowList) {
		return nil, false
	}
...
func (o *ApiInstantTest) HasClientCertDomainsAllowList() bool {
	if o != nil && !utils.IsNil(o.ClientCertDomainsAllowList) {
		return true
	}
...
func (o *ApiInstantTest) SetClientCertDomainsAllowList(v string) {
...
func (o *ApiInstantTest) GetDistributedTracing() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiInstantTest) GetDistributedTracingOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.DistributedTracing) {
		return nil, false
	}
...
func (o *ApiInstantTest) HasDistributedTracing() bool {
	if o != nil && !utils.IsNil(o.DistributedTracing) {
		return true
	}
...
func (o *ApiInstantTest) SetDistributedTracing(v bool) {
...
func (o *ApiInstantTest) GetVaultCredentials() []TestVaultCredential {
...
// and a boolean to check if the value has been set.
func (o *ApiInstantTest) GetVaultCredentialsOk() ([]TestVaultCredential, bool) {
	if o == nil || utils.IsNil(o.VaultCredentials) {
		return nil, false
	}
...
func (o *ApiInstantTest) HasVaultCredentials() bool {
	if o != nil && !utils.IsNil(o.VaultCredentials) {
		return true
	}
...
func (o *ApiInstantTest) SetVaultCredentials(v []TestVaultCredential) {
