...
// checks if the DnsServerProperties type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DnsServerProperties{}

// DnsServerProperties struct for DnsServerProperties
type DnsServerProperties struct {
...
type _DnsServerProperties DnsServerProperties

// NewDnsServerProperties instantiates a new DnsServerProperties object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDnsServerProperties(dnsServers []TestDnsServer, domain string) *DnsServerProperties {
	this := DnsServerProperties{}
...
// NewDnsServerPropertiesWithDefaults instantiates a new DnsServerProperties object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDnsServerPropertiesWithDefaults() *DnsServerProperties {
	this := DnsServerProperties{}
	var dnsTransportProtocol TestDnsTransportProtocol = TESTDNSTRANSPORTPROTOCOL_UDP
	this.DnsTransportProtocol = &dnsTransportProtocol
	var networkMeasurements bool = true
...
func (o *DnsServerProperties) GetBandwidthMeasurements() bool {
...
func (o *DnsServerProperties) GetBandwidthMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BandwidthMeasurements) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasBandwidthMeasurements() bool {
	if o != nil && !utils.IsNil(o.BandwidthMeasurements) {
		return true
	}
...
func (o *DnsServerProperties) SetBandwidthMeasurements(v bool) {
	o.BandwidthMeasurements = &v
}

// GetDnsServers returns the DnsServers field value
func (o *DnsServerProperties) GetDnsServers() []TestDnsServer {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetDnsServersOk() ([]TestDnsServer, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsServerProperties) SetDnsServers(v []TestDnsServer) {
	o.DnsServers = v
}

// GetDnsTransportProtocol returns the DnsTransportProtocol field value if set, zero value otherwise.
func (o *DnsServerProperties) GetDnsTransportProtocol() TestDnsTransportProtocol {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetDnsTransportProtocolOk() (*TestDnsTransportProtocol, bool) {
	if o == nil || utils.IsNil(o.DnsTransportProtocol) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasDnsTransportProtocol() bool {
	if o != nil && !utils.IsNil(o.DnsTransportProtocol) {
		return true
	}
...
func (o *DnsServerProperties) SetDnsTransportProtocol(v TestDnsTransportProtocol) {
	o.DnsTransportProtocol = &v
}

// GetDomain returns the Domain field value
func (o *DnsServerProperties) GetDomain() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetDomainOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsServerProperties) SetDomain(v string) {
	o.Domain = v
}

// GetMtuMeasurements returns the MtuMeasurements field value if set, zero value otherwise.
func (o *DnsServerProperties) GetMtuMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetMtuMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.MtuMeasurements) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasMtuMeasurements() bool {
	if o != nil && !utils.IsNil(o.MtuMeasurements) {
		return true
	}
...
func (o *DnsServerProperties) SetMtuMeasurements(v bool) {
	o.MtuMeasurements = &v
}

// GetNetworkMeasurements returns the NetworkMeasurements field value if set, zero value otherwise.
func (o *DnsServerProperties) GetNetworkMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetNetworkMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.NetworkMeasurements) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasNetworkMeasurements() bool {
	if o != nil && !utils.IsNil(o.NetworkMeasurements) {
		return true
	}
...
func (o *DnsServerProperties) SetNetworkMeasurements(v bool) {
	o.NetworkMeasurements = &v
}

// GetNumPathTraces returns the NumPathTraces field value if set, zero value otherwise.
func (o *DnsServerProperties) GetNumPathTraces() int32 {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *DnsServerProperties) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetPathTraceMode returns the PathTraceMode field value if set, zero value otherwise.
func (o *DnsServerProperties) GetPathTraceMode() TestPathTraceMode {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetPathTraceModeOk() (*TestPathTraceMode, bool) {
	if o == nil || utils.IsNil(o.PathTraceMode) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasPathTraceMode() bool {
	if o != nil && !utils.IsNil(o.PathTraceMode) {
		return true
	}
...
func (o *DnsServerProperties) SetPathTraceMode(v TestPathTraceMode) {
	o.PathTraceMode = &v
}

// GetProbeMode returns the ProbeMode field value if set, zero value otherwise.
func (o *DnsServerProperties) GetProbeMode() TestProbeMode {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetProbeModeOk() (*TestProbeMode, bool) {
	if o == nil || utils.IsNil(o.ProbeMode) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasProbeMode() bool {
	if o != nil && !utils.IsNil(o.ProbeMode) {
		return true
	}
...
func (o *DnsServerProperties) SetProbeMode(v TestProbeMode) {
	o.ProbeMode = &v
}

// GetProtocol returns the Protocol field value if set, zero value otherwise.
func (o *DnsServerProperties) GetProtocol() TestProtocol {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetProtocolOk() (*TestProtocol, bool) {
	if o == nil || utils.IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasProtocol() bool {
	if o != nil && !utils.IsNil(o.Protocol) {
		return true
	}
...
func (o *DnsServerProperties) SetProtocol(v TestProtocol) {
	o.Protocol = &v
}

// GetRandomizedStartTime returns the RandomizedStartTime field value if set, zero value otherwise.
func (o *DnsServerProperties) GetRandomizedStartTime() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetRecursiveQueriesOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RecursiveQueries) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasRecursiveQueries() bool {
	if o != nil && !utils.IsNil(o.RecursiveQueries) {
		return true
	}
...
func (o *DnsServerProperties) SetRecursiveQueries(v bool) {
	o.RecursiveQueries = &v
}

// GetIpv6Policy returns the Ipv6Policy field value if set, zero value otherwise.
func (o *DnsServerProperties) GetIpv6Policy() TestIpv6Policy {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetIpv6PolicyOk() (*TestIpv6Policy, bool) {
	if o == nil || utils.IsNil(o.Ipv6Policy) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasIpv6Policy() bool {
	if o != nil && !utils.IsNil(o.Ipv6Policy) {
		return true
	}
...
func (o *DnsServerProperties) SetIpv6Policy(v TestIpv6Policy) {
	o.Ipv6Policy = &v
}

// GetFixedPacketRate returns the FixedPacketRate field value if set, zero value otherwise.
func (o *DnsServerProperties) GetFixedPacketRate() int32 {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetFixedPacketRateOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.FixedPacketRate) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasFixedPacketRate() bool {
	if o != nil && !utils.IsNil(o.FixedPacketRate) {
		return true
	}
...
func (o *DnsServerProperties) SetFixedPacketRate(v int32) {
	o.FixedPacketRate = &v
}

// GetDnsQueryClass returns the DnsQueryClass field value if set, zero value otherwise.
func (o *DnsServerProperties) GetDnsQueryClass() DnsQueryClass {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetDnsQueryClassOk() (*DnsQueryClass, bool) {
	if o == nil || utils.IsNil(o.DnsQueryClass) {
		return nil, false
	}
...
func (o *DnsServerProperties) HasDnsQueryClass() bool {
	if o != nil && !utils.IsNil(o.DnsQueryClass) {
		return true
	}
...
func (o *DnsServerProperties) SetDnsQueryClass(v DnsQueryClass) {
	o.DnsQueryClass = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *DnsServerProperties) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerProperties) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *DnsServerProperties) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *DnsServerProperties) SetType(v string) {
	o.Type = &v
}

func (o DnsServerProperties) MarshalJSON() ([]byte, error) {
...
func (o DnsServerProperties) ToMap() (map[string]interface{}, error) {
...
func (o *DnsServerProperties) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsServerProperties := _DnsServerProperties{}

    err = json.Unmarshal(data, &varDnsServerProperties)

	if err != nil {
		return err
	}

	*o = DnsServerProperties(varDnsServerProperties)

	return err
}

type NullableDnsServerProperties struct {
	value *DnsServerProperties
	isSet bool
}

func (v NullableDnsServerProperties) Get() *DnsServerProperties {
	return v.value
}

func (v *NullableDnsServerProperties) Set(val *DnsServerProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsServerProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsServerProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsServerProperties(val *DnsServerProperties) *NullableDnsServerProperties {
	return &NullableDnsServerProperties{value: val, isSet: true}
}

func (v NullableDnsServerProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsServerProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
