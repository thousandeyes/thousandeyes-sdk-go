...
// checks if the DnsSecTest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DnsSecTest{}

// DnsSecTest struct for DnsSecTest
...
type _DnsSecTest DnsSecTest

// NewDnsSecTest instantiates a new DnsSecTest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDnsSecTest(interval TestInterval, domain string) *DnsSecTest {
	this := DnsSecTest{}
...
// NewDnsSecTestWithDefaults instantiates a new DnsSecTest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDnsSecTestWithDefaults() *DnsSecTest {
	this := DnsSecTest{}
...
func (o *DnsSecTest) GetInterval() TestInterval {
	if o == nil {
...
func (o *DnsSecTest) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsSecTest) SetInterval(v TestInterval) {
	o.Interval = v
}

// GetAlertsEnabled returns the AlertsEnabled field value if set, zero value otherwise.
func (o *DnsSecTest) GetAlertsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *DnsSecTest) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *DnsSecTest) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *DnsSecTest) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *DnsSecTest) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
func (o *DnsSecTest) SetEnabled(v bool) {
	o.Enabled = &v
}

// GetAlertRules returns the AlertRules field value if set, zero value otherwise.
func (o *DnsSecTest) GetAlertRules() []AlertRule {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *DnsSecTest) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *DnsSecTest) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *DnsSecTest) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *DnsSecTest) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *DnsSecTest) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *DnsSecTest) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *DnsSecTest) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *DnsSecTest) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *DnsSecTest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *DnsSecTest) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *DnsSecTest) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *DnsSecTest) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *DnsSecTest) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *DnsSecTest) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *DnsSecTest) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *DnsSecTest) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *DnsSecTest) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *DnsSecTest) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *DnsSecTest) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *DnsSecTest) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *DnsSecTest) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *DnsSecTest) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *DnsSecTest) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *DnsSecTest) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *DnsSecTest) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
func (o *DnsSecTest) SetTestId(v string) {
	o.TestId = &v
}

// GetTestName returns the TestName field value if set, zero value otherwise.
func (o *DnsSecTest) GetTestName() string {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *DnsSecTest) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *DnsSecTest) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *DnsSecTest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *DnsSecTest) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *DnsSecTest) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *DnsSecTest) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *DnsSecTest) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *DnsSecTest) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *DnsSecTest) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *DnsSecTest) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *DnsSecTest) SetLabels(v []TestLabel) {
	o.Labels = v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *DnsSecTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *DnsSecTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *DnsSecTest) SetTags(v []TestTag) {
	o.Tags = v
}

// GetSharedWithAccounts returns the SharedWithAccounts field value if set, zero value otherwise.
func (o *DnsSecTest) GetSharedWithAccounts() []SharedWithAccount {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *DnsSecTest) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
func (o *DnsSecTest) SetSharedWithAccounts(v []SharedWithAccount) {
	o.SharedWithAccounts = v
}

// GetDomain returns the Domain field value
func (o *DnsSecTest) GetDomain() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetDomainOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsSecTest) SetDomain(v string) {
	o.Domain = v
}

// GetDnsQueryClass returns the DnsQueryClass field value if set, zero value otherwise.
func (o *DnsSecTest) GetDnsQueryClass() DnsQueryClass {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetDnsQueryClassOk() (*DnsQueryClass, bool) {
	if o == nil || utils.IsNil(o.DnsQueryClass) {
		return nil, false
	}
...
func (o *DnsSecTest) HasDnsQueryClass() bool {
	if o != nil && !utils.IsNil(o.DnsQueryClass) {
		return true
	}
...
func (o *DnsSecTest) SetDnsQueryClass(v DnsQueryClass) {
	o.DnsQueryClass = &v
}

// GetRandomizedStartTime returns the RandomizedStartTime field value if set, zero value otherwise.
func (o *DnsSecTest) GetRandomizedStartTime() bool {
...
// and a boolean to check if the value has been set.
func (o *DnsSecTest) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *DnsSecTest) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
func (o *DnsSecTest) SetRandomizedStartTime(v bool) {
	o.RandomizedStartTime = &v
}

func (o DnsSecTest) MarshalJSON() ([]byte, error) {
...
func (o DnsSecTest) ToMap() (map[string]interface{}, error) {
...
func (o *DnsSecTest) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsSecTest := _DnsSecTest{}

    err = json.Unmarshal(data, &varDnsSecTest)

	if err != nil {
		return err
	}

	*o = DnsSecTest(varDnsSecTest)

	return err
}

type NullableDnsSecTest struct {
	value *DnsSecTest
	isSet bool
}

func (v NullableDnsSecTest) Get() *DnsSecTest {
	return v.value
}

func (v *NullableDnsSecTest) Set(val *DnsSecTest) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsSecTest) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsSecTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsSecTest(val *DnsSecTest) *NullableDnsSecTest {
	return &NullableDnsSecTest{value: val, isSet: true}
}

func (v NullableDnsSecTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsSecTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
