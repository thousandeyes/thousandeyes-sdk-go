...
// checks if the HttpServerTest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &HttpServerTest{}

// HttpServerTest struct for HttpServerTest
...
type _HttpServerTest HttpServerTest

// NewHttpServerTest instantiates a new HttpServerTest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHttpServerTest(interval TestInterval, url string) *HttpServerTest {
	this := HttpServerTest{}
...
// NewHttpServerTestWithDefaults instantiates a new HttpServerTest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHttpServerTestWithDefaults() *HttpServerTest {
	this := HttpServerTest{}
...
func (o *HttpServerTest) GetInterval() TestInterval {
	if o == nil {
...
func (o *HttpServerTest) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HttpServerTest) SetInterval(v TestInterval) {
	o.Interval = v
}

// GetAlertsEnabled returns the AlertsEnabled field value if set, zero value otherwise.
func (o *HttpServerTest) GetAlertsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *HttpServerTest) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *HttpServerTest) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *HttpServerTest) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *HttpServerTest) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
func (o *HttpServerTest) SetEnabled(v bool) {
	o.Enabled = &v
}

// GetAlertRules returns the AlertRules field value if set, zero value otherwise.
func (o *HttpServerTest) GetAlertRules() []AlertRule {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *HttpServerTest) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *HttpServerTest) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *HttpServerTest) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *HttpServerTest) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *HttpServerTest) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *HttpServerTest) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *HttpServerTest) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *HttpServerTest) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *HttpServerTest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *HttpServerTest) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *HttpServerTest) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *HttpServerTest) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *HttpServerTest) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *HttpServerTest) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *HttpServerTest) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *HttpServerTest) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *HttpServerTest) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *HttpServerTest) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *HttpServerTest) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *HttpServerTest) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *HttpServerTest) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *HttpServerTest) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *HttpServerTest) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *HttpServerTest) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *HttpServerTest) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
func (o *HttpServerTest) SetTestId(v string) {
	o.TestId = &v
}

// GetTestName returns the TestName field value if set, zero value otherwise.
func (o *HttpServerTest) GetTestName() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *HttpServerTest) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *HttpServerTest) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *HttpServerTest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *HttpServerTest) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *HttpServerTest) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *HttpServerTest) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *HttpServerTest) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *HttpServerTest) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *HttpServerTest) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *HttpServerTest) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *HttpServerTest) SetLabels(v []TestLabel) {
	o.Labels = v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *HttpServerTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *HttpServerTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *HttpServerTest) SetTags(v []TestTag) {
	o.Tags = v
}

// GetSharedWithAccounts returns the SharedWithAccounts field value if set, zero value otherwise.
func (o *HttpServerTest) GetSharedWithAccounts() []SharedWithAccount {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *HttpServerTest) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
func (o *HttpServerTest) SetSharedWithAccounts(v []SharedWithAccount) {
	o.SharedWithAccounts = v
}

// GetAuthType returns the AuthType field value if set, zero value otherwise.
func (o *HttpServerTest) GetAuthType() TestAuthType {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetAuthTypeOk() (*TestAuthType, bool) {
	if o == nil || utils.IsNil(o.AuthType) {
		return nil, false
	}
...
func (o *HttpServerTest) HasAuthType() bool {
	if o != nil && !utils.IsNil(o.AuthType) {
		return true
	}
...
func (o *HttpServerTest) GetBandwidthMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetBandwidthMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BandwidthMeasurements) {
		return nil, false
	}
...
func (o *HttpServerTest) HasBandwidthMeasurements() bool {
	if o != nil && !utils.IsNil(o.BandwidthMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetClientCertificateOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ClientCertificate) {
		return nil, false
	}
...
func (o *HttpServerTest) HasClientCertificate() bool {
	if o != nil && !utils.IsNil(o.ClientCertificate) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetContentRegexOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ContentRegex) {
		return nil, false
	}
...
func (o *HttpServerTest) HasContentRegex() bool {
	if o != nil && !utils.IsNil(o.ContentRegex) {
		return true
	}
...
func (o *HttpServerTest) SetContentRegex(v string) {
	o.ContentRegex = &v
}

// GetCustomHeaders returns the CustomHeaders field value if set, zero value otherwise.
func (o *HttpServerTest) GetCustomHeaders() TestCustomHeaders {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetCustomHeadersOk() (*TestCustomHeaders, bool) {
	if o == nil || utils.IsNil(o.CustomHeaders) {
		return nil, false
	}
...
func (o *HttpServerTest) HasCustomHeaders() bool {
	if o != nil && !utils.IsNil(o.CustomHeaders) {
		return true
	}
...
func (o *HttpServerTest) SetCustomHeaders(v TestCustomHeaders) {
	o.CustomHeaders = &v
}

// GetDesiredStatusCode returns the DesiredStatusCode field value if set, zero value otherwise.
func (o *HttpServerTest) GetDesiredStatusCode() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetDesiredStatusCodeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.DesiredStatusCode) {
		return nil, false
	}
...
func (o *HttpServerTest) HasDesiredStatusCode() bool {
	if o != nil && !utils.IsNil(o.DesiredStatusCode) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetDistributedTracingOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.DistributedTracing) {
		return nil, false
	}
...
func (o *HttpServerTest) HasDistributedTracing() bool {
	if o != nil && !utils.IsNil(o.DistributedTracing) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetDownloadLimitOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.DownloadLimit) {
		return nil, false
	}
...
func (o *HttpServerTest) HasDownloadLimit() bool {
	if o != nil && !utils.IsNil(o.DownloadLimit) {
		return true
	}
...
func (o *HttpServerTest) SetDownloadLimit(v int32) {
	o.DownloadLimit = &v
}

// GetDnsOverride returns the DnsOverride field value if set, zero value otherwise.
func (o *HttpServerTest) GetDnsOverride() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetDnsOverrideOk() (*string, bool) {
	if o == nil || utils.IsNil(o.DnsOverride) {
		return nil, false
	}
...
func (o *HttpServerTest) HasDnsOverride() bool {
	if o != nil && !utils.IsNil(o.DnsOverride) {
		return true
	}
...
func (o *HttpServerTest) SetDnsOverride(v string) {
	o.DnsOverride = &v
}

// GetHttpTargetTime returns the HttpTargetTime field value if set, zero value otherwise.
func (o *HttpServerTest) GetHttpTargetTime() int32 {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetHttpTargetTimeOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.HttpTargetTime) {
		return nil, false
	}
...
func (o *HttpServerTest) HasHttpTargetTime() bool {
	if o != nil && !utils.IsNil(o.HttpTargetTime) {
		return true
	}
...
func (o *HttpServerTest) SetHttpTargetTime(v int32) {
	o.HttpTargetTime = &v
}

// GetHttpTimeLimit returns the HttpTimeLimit field value if set, zero value otherwise.
func (o *HttpServerTest) GetHttpTimeLimit() int32 {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetHttpTimeLimitOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.HttpTimeLimit) {
		return nil, false
	}
...
func (o *HttpServerTest) HasHttpTimeLimit() bool {
	if o != nil && !utils.IsNil(o.HttpTimeLimit) {
		return true
	}
...
func (o *HttpServerTest) SetHttpTimeLimit(v int32) {
	o.HttpTimeLimit = &v
}

// GetHttpVersion returns the HttpVersion field value if set, zero value otherwise.
func (o *HttpServerTest) GetHttpVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetHttpVersionOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.HttpVersion) {
		return nil, false
	}
...
func (o *HttpServerTest) HasHttpVersion() bool {
	if o != nil && !utils.IsNil(o.HttpVersion) {
		return true
	}
...
func (o *HttpServerTest) SetHttpVersion(v int32) {
	o.HttpVersion = &v
}

// GetIncludeHeaders returns the IncludeHeaders field value if set, zero value otherwise.
func (o *HttpServerTest) GetIncludeHeaders() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetIncludeHeadersOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.IncludeHeaders) {
		return nil, false
	}
...
func (o *HttpServerTest) HasIncludeHeaders() bool {
	if o != nil && !utils.IsNil(o.IncludeHeaders) {
		return true
	}
...
func (o *HttpServerTest) SetIncludeHeaders(v bool) {
	o.IncludeHeaders = &v
}

// GetMtuMeasurements returns the MtuMeasurements field value if set, zero value otherwise.
func (o *HttpServerTest) GetMtuMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetMtuMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.MtuMeasurements) {
		return nil, false
	}
...
func (o *HttpServerTest) HasMtuMeasurements() bool {
	if o != nil && !utils.IsNil(o.MtuMeasurements) {
		return true
	}
...
func (o *HttpServerTest) SetMtuMeasurements(v bool) {
	o.MtuMeasurements = &v
}

// GetNetworkMeasurements returns the NetworkMeasurements field value if set, zero value otherwise.
func (o *HttpServerTest) GetNetworkMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetNetworkMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.NetworkMeasurements) {
		return nil, false
	}
...
func (o *HttpServerTest) HasNetworkMeasurements() bool {
	if o != nil && !utils.IsNil(o.NetworkMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *HttpServerTest) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *HttpServerTest) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetOAuth returns the OAuth field value if set, zero value otherwise.
func (o *HttpServerTest) GetOAuth() OAuth {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetOAuthOk() (*OAuth, bool) {
	if o == nil || utils.IsNil(o.OAuth) {
		return nil, false
	}
	return o.OAuth, true
...
func (o *HttpServerTest) HasOAuth() bool {
	if o != nil && !utils.IsNil(o.OAuth) {
		return true
	}
...
func (o *HttpServerTest) SetOAuth(v OAuth) {
	o.OAuth = &v
}

// GetPassword returns the Password field value if set, zero value otherwise.
func (o *HttpServerTest) GetPassword() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetPasswordOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Password) {
		return nil, false
	}
...
func (o *HttpServerTest) HasPassword() bool {
	if o != nil && !utils.IsNil(o.Password) {
		return true
	}
...
func (o *HttpServerTest) SetPassword(v string) {
	o.Password = &v
}

// GetPathTraceMode returns the PathTraceMode field value if set, zero value otherwise.
func (o *HttpServerTest) GetPathTraceMode() TestPathTraceMode {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetPathTraceModeOk() (*TestPathTraceMode, bool) {
	if o == nil || utils.IsNil(o.PathTraceMode) {
		return nil, false
	}
...
func (o *HttpServerTest) HasPathTraceMode() bool {
	if o != nil && !utils.IsNil(o.PathTraceMode) {
		return true
	}
...
func (o *HttpServerTest) SetPathTraceMode(v TestPathTraceMode) {
	o.PathTraceMode = &v
}

// GetProbeMode returns the ProbeMode field value if set, zero value otherwise.
func (o *HttpServerTest) GetProbeMode() TestProbeMode {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetProbeModeOk() (*TestProbeMode, bool) {
	if o == nil || utils.IsNil(o.ProbeMode) {
		return nil, false
	}
...
func (o *HttpServerTest) HasProbeMode() bool {
	if o != nil && !utils.IsNil(o.ProbeMode) {
		return true
	}
...
func (o *HttpServerTest) SetProbeMode(v TestProbeMode) {
	o.ProbeMode = &v
}

// GetProtocol returns the Protocol field value if set, zero value otherwise.
func (o *HttpServerTest) GetProtocol() TestProtocol {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetProtocolOk() (*TestProtocol, bool) {
	if o == nil || utils.IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *HttpServerTest) HasProtocol() bool {
	if o != nil && !utils.IsNil(o.Protocol) {
		return true
	}
...
func (o *HttpServerTest) SetProtocol(v TestProtocol) {
	o.Protocol = &v
}

// GetSslVersion returns the SslVersion field value if set, zero value otherwise.
func (o *HttpServerTest) GetSslVersion() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetSslVersionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.SslVersion) {
		return nil, false
	}
...
func (o *HttpServerTest) HasSslVersion() bool {
	if o != nil && !utils.IsNil(o.SslVersion) {
		return true
	}
...
func (o *HttpServerTest) SetSslVersion(v string) {
	o.SslVersion = &v
}

// GetSslVersionId returns the SslVersionId field value if set, zero value otherwise.
func (o *HttpServerTest) GetSslVersionId() TestSslVersionId {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetSslVersionIdOk() (*TestSslVersionId, bool) {
	if o == nil || utils.IsNil(o.SslVersionId) {
		return nil, false
	}
...
func (o *HttpServerTest) HasSslVersionId() bool {
	if o != nil && !utils.IsNil(o.SslVersionId) {
		return true
	}
...
func (o *HttpServerTest) SetSslVersionId(v TestSslVersionId) {
	o.SslVersionId = &v
}

// GetUrl returns the Url field value
func (o *HttpServerTest) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *HttpServerTest) SetUrl(v string) {
	o.Url = v
}

// GetUseNtlm returns the UseNtlm field value if set, zero value otherwise.
func (o *HttpServerTest) GetUseNtlm() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetUseNtlmOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UseNtlm) {
		return nil, false
	}
...
func (o *HttpServerTest) HasUseNtlm() bool {
	if o != nil && !utils.IsNil(o.UseNtlm) {
		return true
	}
...
func (o *HttpServerTest) SetUseNtlm(v bool) {
	o.UseNtlm = &v
}

// GetUserAgent returns the UserAgent field value if set, zero value otherwise.
func (o *HttpServerTest) GetUserAgent() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetUserAgentOk() (*string, bool) {
	if o == nil || utils.IsNil(o.UserAgent) {
		return nil, false
	}
...
func (o *HttpServerTest) HasUserAgent() bool {
	if o != nil && !utils.IsNil(o.UserAgent) {
		return true
	}
...
func (o *HttpServerTest) SetUserAgent(v string) {
	o.UserAgent = &v
}

// GetUsername returns the Username field value if set, zero value otherwise.
func (o *HttpServerTest) GetUsername() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetUsernameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Username) {
		return nil, false
	}
...
func (o *HttpServerTest) HasUsername() bool {
	if o != nil && !utils.IsNil(o.Username) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetVerifyCertificateOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.VerifyCertificate) {
		return nil, false
	}
...
func (o *HttpServerTest) HasVerifyCertificate() bool {
	if o != nil && !utils.IsNil(o.VerifyCertificate) {
		return true
	}
...
func (o *HttpServerTest) SetVerifyCertificate(v bool) {
...
func (o *HttpServerTest) GetAllowUnsafeLegacyRenegotiation() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetAllowUnsafeLegacyRenegotiationOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AllowUnsafeLegacyRenegotiation) {
		return nil, false
	}
...
func (o *HttpServerTest) HasAllowUnsafeLegacyRenegotiation() bool {
	if o != nil && !utils.IsNil(o.AllowUnsafeLegacyRenegotiation) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetFollowRedirectsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.FollowRedirects) {
		return nil, false
	}
...
func (o *HttpServerTest) HasFollowRedirects() bool {
	if o != nil && !utils.IsNil(o.FollowRedirects) {
		return true
	}
...
func (o *HttpServerTest) SetFollowRedirects(v bool) {
	o.FollowRedirects = &v
}

// GetFixedPacketRate returns the FixedPacketRate field value if set, zero value otherwise.
func (o *HttpServerTest) GetFixedPacketRate() int32 {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetFixedPacketRateOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.FixedPacketRate) {
		return nil, false
	}
...
func (o *HttpServerTest) HasFixedPacketRate() bool {
	if o != nil && !utils.IsNil(o.FixedPacketRate) {
		return true
	}
...
func (o *HttpServerTest) SetFixedPacketRate(v int32) {
	o.FixedPacketRate = &v
}

// GetOverrideAgentProxy returns the OverrideAgentProxy field value if set, zero value otherwise.
func (o *HttpServerTest) GetOverrideAgentProxy() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetOverrideAgentProxyOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.OverrideAgentProxy) {
		return nil, false
	}
...
func (o *HttpServerTest) HasOverrideAgentProxy() bool {
	if o != nil && !utils.IsNil(o.OverrideAgentProxy) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetOverrideProxyIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.OverrideProxyId) {
		return nil, false
	}
...
func (o *HttpServerTest) HasOverrideProxyId() bool {
	if o != nil && !utils.IsNil(o.OverrideProxyId) {
		return true
	}
...
func (o *HttpServerTest) SetOverrideProxyId(v string) {
	o.OverrideProxyId = &v
}

// GetCollectProxyNetworkData returns the CollectProxyNetworkData field value if set, zero value otherwise.
func (o *HttpServerTest) GetCollectProxyNetworkData() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetCollectProxyNetworkDataOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.CollectProxyNetworkData) {
		return nil, false
	}
...
func (o *HttpServerTest) HasCollectProxyNetworkData() bool {
	if o != nil && !utils.IsNil(o.CollectProxyNetworkData) {
		return true
	}
...
func (o *HttpServerTest) SetCollectProxyNetworkData(v bool) {
	o.CollectProxyNetworkData = &v
}

// GetVaultCredentials returns the VaultCredentials field value if set, zero value otherwise.
func (o *HttpServerTest) GetVaultCredentials() []TestVaultCredential {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetVaultCredentialsOk() ([]TestVaultCredential, bool) {
	if o == nil || utils.IsNil(o.VaultCredentials) {
		return nil, false
	}
...
func (o *HttpServerTest) HasVaultCredentials() bool {
	if o != nil && !utils.IsNil(o.VaultCredentials) {
		return true
	}
...
func (o *HttpServerTest) SetVaultCredentials(v []TestVaultCredential) {
	o.VaultCredentials = v
}

// GetHeaders returns the Headers field value if set, zero value otherwise.
func (o *HttpServerTest) GetHeaders() []string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetHeadersOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Headers) {
		return nil, false
	}
...
func (o *HttpServerTest) HasHeaders() bool {
	if o != nil && !utils.IsNil(o.Headers) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *HttpServerTest) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetRequestMethodOk() (*RequestMethod, bool) {
	if o == nil || utils.IsNil(o.RequestMethod) {
		return nil, false
	}
...
func (o *HttpServerTest) HasRequestMethod() bool {
	if o != nil && !utils.IsNil(o.RequestMethod) {
		return true
	}
...
func (o *HttpServerTest) SetRequestMethod(v RequestMethod) {
	o.RequestMethod = &v
}

// GetPostBody returns the PostBody field value if set, zero value otherwise.
func (o *HttpServerTest) GetPostBody() string {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetPostBodyOk() (*string, bool) {
	if o == nil || utils.IsNil(o.PostBody) {
		return nil, false
	}
...
func (o *HttpServerTest) HasPostBody() bool {
	if o != nil && !utils.IsNil(o.PostBody) {
		return true
	}
...
func (o *HttpServerTest) SetPostBody(v string) {
	o.PostBody = &v
}

// GetIpv6Policy returns the Ipv6Policy field value if set, zero value otherwise.
func (o *HttpServerTest) GetIpv6Policy() TestIpv6Policy {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetIpv6PolicyOk() (*TestIpv6Policy, bool) {
	if o == nil || utils.IsNil(o.Ipv6Policy) {
		return nil, false
	}
...
func (o *HttpServerTest) HasIpv6Policy() bool {
	if o != nil && !utils.IsNil(o.Ipv6Policy) {
		return true
	}
...
func (o *HttpServerTest) SetIpv6Policy(v TestIpv6Policy) {
	o.Ipv6Policy = &v
}

// GetBgpMeasurements returns the BgpMeasurements field value if set, zero value otherwise.
func (o *HttpServerTest) GetBgpMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetBgpMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BgpMeasurements) {
		return nil, false
	}
...
func (o *HttpServerTest) HasBgpMeasurements() bool {
	if o != nil && !utils.IsNil(o.BgpMeasurements) {
		return true
	}
...
func (o *HttpServerTest) SetBgpMeasurements(v bool) {
	o.BgpMeasurements = &v
}

// GetUsePublicBgp returns the UsePublicBgp field value if set, zero value otherwise.
func (o *HttpServerTest) GetUsePublicBgp() bool {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetUsePublicBgpOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UsePublicBgp) {
		return nil, false
	}
...
func (o *HttpServerTest) HasUsePublicBgp() bool {
	if o != nil && !utils.IsNil(o.UsePublicBgp) {
		return true
	}
...
func (o *HttpServerTest) SetUsePublicBgp(v bool) {
	o.UsePublicBgp = &v
}

// GetMonitors returns the Monitors field value if set, zero value otherwise.
func (o *HttpServerTest) GetMonitors() []Monitor {
...
// and a boolean to check if the value has been set.
func (o *HttpServerTest) GetMonitorsOk() ([]Monitor, bool) {
	if o == nil || utils.IsNil(o.Monitors) {
		return nil, false
	}
...
func (o *HttpServerTest) HasMonitors() bool {
	if o != nil && !utils.IsNil(o.Monitors) {
		return true
	}
...
func (o *HttpServerTest) SetMonitors(v []Monitor) {
	o.Monitors = v
}

func (o HttpServerTest) MarshalJSON() ([]byte, error) {
...
func (o HttpServerTest) ToMap() (map[string]interface{}, error) {
...
func (o *HttpServerTest) UnmarshalJSON(data []byte) (err error) {
	...
	varHttpServerTest := _HttpServerTest{}

    err = json.Unmarshal(data, &varHttpServerTest)

	if err != nil {
		return err
	}

	*o = HttpServerTest(varHttpServerTest)

	return err
}

type NullableHttpServerTest struct {
	value *HttpServerTest
	isSet bool
}

func (v NullableHttpServerTest) Get() *HttpServerTest {
	return v.value
}

func (v *NullableHttpServerTest) Set(val *HttpServerTest) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpServerTest) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpServerTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpServerTest(val *HttpServerTest) *NullableHttpServerTest {
	return &NullableHttpServerTest{value: val, isSet: true}
}

func (v NullableHttpServerTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpServerTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
