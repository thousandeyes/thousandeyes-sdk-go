...
// checks if the VoiceTest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VoiceTest{}

// VoiceTest struct for VoiceTest
...
type _VoiceTest VoiceTest

// NewVoiceTest instantiates a new VoiceTest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewVoiceTest(interval TestInterval, targetAgentId string) *VoiceTest {
	this := VoiceTest{}
...
// NewVoiceTestWithDefaults instantiates a new VoiceTest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewVoiceTestWithDefaults() *VoiceTest {
	this := VoiceTest{}
...
func (o *VoiceTest) GetInterval() TestInterval {
	if o == nil {
...
func (o *VoiceTest) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *VoiceTest) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *VoiceTest) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *VoiceTest) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *VoiceTest) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *VoiceTest) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *VoiceTest) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *VoiceTest) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *VoiceTest) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *VoiceTest) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *VoiceTest) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *VoiceTest) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *VoiceTest) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *VoiceTest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *VoiceTest) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *VoiceTest) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *VoiceTest) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *VoiceTest) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *VoiceTest) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *VoiceTest) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *VoiceTest) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *VoiceTest) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *VoiceTest) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *VoiceTest) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *VoiceTest) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *VoiceTest) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *VoiceTest) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *VoiceTest) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *VoiceTest) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *VoiceTest) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *VoiceTest) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *VoiceTest) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *VoiceTest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *VoiceTest) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *VoiceTest) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *VoiceTest) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *VoiceTest) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *VoiceTest) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *VoiceTest) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *VoiceTest) SetLabels(v []TestLabel) {
	o.Labels = v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *VoiceTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *VoiceTest) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
func (o *VoiceTest) SetSharedWithAccounts(v []SharedWithAccount) {
	o.SharedWithAccounts = v
}

// GetCodec returns the Codec field value if set, zero value otherwise.
func (o *VoiceTest) GetCodec() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetCodecOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Codec) {
		return nil, false
	}
	return o.Codec, true
...
func (o *VoiceTest) HasCodec() bool {
	if o != nil && !utils.IsNil(o.Codec) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetCodecIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CodecId) {
		return nil, false
	}
...
func (o *VoiceTest) HasCodecId() bool {
	if o != nil && !utils.IsNil(o.CodecId) {
		return true
	}
...
func (o *VoiceTest) SetCodecId(v string) {
	o.CodecId = &v
}

// GetDscp returns the Dscp field value if set, zero value otherwise.
func (o *VoiceTest) GetDscp() string {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetDscpOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Dscp) {
		return nil, false
	}
	return o.Dscp, true
...
func (o *VoiceTest) SetDscp(v string) {
	o.Dscp = &v
}

// GetDscpId returns the DscpId field value if set, zero value otherwise.
func (o *VoiceTest) GetDscpId() TestDscpId {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetDscpIdOk() (*TestDscpId, bool) {
	if o == nil || utils.IsNil(o.DscpId) {
		return nil, false
	}
...
func (o *VoiceTest) HasDscpId() bool {
	if o != nil && !utils.IsNil(o.DscpId) {
		return true
	}
...
func (o *VoiceTest) SetDscpId(v TestDscpId) {
	o.DscpId = &v
}

// GetDuration returns the Duration field value if set, zero value otherwise.
func (o *VoiceTest) GetDuration() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetDurationOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Duration) {
		return nil, false
	}
...
func (o *VoiceTest) HasDuration() bool {
	if o != nil && !utils.IsNil(o.Duration) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetJitterBufferOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.JitterBuffer) {
		return nil, false
	}
...
func (o *VoiceTest) HasJitterBuffer() bool {
	if o != nil && !utils.IsNil(o.JitterBuffer) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *VoiceTest) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *VoiceTest) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetPort returns the Port field value if set, zero value otherwise.
func (o *VoiceTest) GetPort() int32 {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetPortOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.Port) {
		return nil, false
	}
	return o.Port, true
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *VoiceTest) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
func (o *VoiceTest) SetRandomizedStartTime(v bool) {
	o.RandomizedStartTime = &v
}

// GetTargetAgentId returns the TargetAgentId field value
func (o *VoiceTest) GetTargetAgentId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetTargetAgentIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetBgpMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BgpMeasurements) {
		return nil, false
	}
...
func (o *VoiceTest) HasBgpMeasurements() bool {
	if o != nil && !utils.IsNil(o.BgpMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetUsePublicBgpOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UsePublicBgp) {
		return nil, false
	}
...
func (o *VoiceTest) HasUsePublicBgp() bool {
	if o != nil && !utils.IsNil(o.UsePublicBgp) {
		return true
	}
...
func (o *VoiceTest) SetUsePublicBgp(v bool) {
	o.UsePublicBgp = &v
}

// GetMonitors returns the Monitors field value if set, zero value otherwise.
func (o *VoiceTest) GetMonitors() []Monitor {
...
// and a boolean to check if the value has been set.
func (o *VoiceTest) GetMonitorsOk() ([]Monitor, bool) {
	if o == nil || utils.IsNil(o.Monitors) {
		return nil, false
	}
...
func (o *VoiceTest) HasMonitors() bool {
	if o != nil && !utils.IsNil(o.Monitors) {
		return true
	}
...
func (o *VoiceTest) SetMonitors(v []Monitor) {
	o.Monitors = v
}

func (o VoiceTest) MarshalJSON() ([]byte, error) {
...
func (o VoiceTest) ToMap() (map[string]interface{}, error) {
...
func (o *VoiceTest) UnmarshalJSON(data []byte) (err error) {
	...
	varVoiceTest := _VoiceTest{}

    err = json.Unmarshal(data, &varVoiceTest)

	if err != nil {
		return err
	}

	*o = VoiceTest(varVoiceTest)

	return err
}

type NullableVoiceTest struct {
	value *VoiceTest
	isSet bool
}

func (v NullableVoiceTest) Get() *VoiceTest {
	return v.value
}

func (v *NullableVoiceTest) Set(val *VoiceTest) {
	v.value = val
	v.isSet = true
}

func (v NullableVoiceTest) IsSet() bool {
	return v.isSet
}

func (v *NullableVoiceTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoiceTest(val *VoiceTest) *NullableVoiceTest {
	return &NullableVoiceTest{value: val, isSet: true}
}

func (v NullableVoiceTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoiceTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
