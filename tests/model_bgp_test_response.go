...
func (o *BgpTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *BgpTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *BgpTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *BgpTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}
