...
// checks if the PageLoadTest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PageLoadTest{}

// PageLoadTest struct for PageLoadTest
...
type _PageLoadTest PageLoadTest

// NewPageLoadTest instantiates a new PageLoadTest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPageLoadTest(interval TestInterval, url string) *PageLoadTest {
	this := PageLoadTest{}
...
// NewPageLoadTestWithDefaults instantiates a new PageLoadTest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPageLoadTestWithDefaults() *PageLoadTest {
	this := PageLoadTest{}
...
func (o *PageLoadTest) GetInterval() TestInterval {
	if o == nil {
...
func (o *PageLoadTest) GetIntervalOk() (*TestInterval, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PageLoadTest) SetInterval(v TestInterval) {
	o.Interval = v
}

// GetAlertsEnabled returns the AlertsEnabled field value if set, zero value otherwise.
func (o *PageLoadTest) GetAlertsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetAlertsEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AlertsEnabled) {
		return nil, false
	}
...
func (o *PageLoadTest) HasAlertsEnabled() bool {
	if o != nil && !utils.IsNil(o.AlertsEnabled) {
		return true
	}
...
func (o *PageLoadTest) SetAlertsEnabled(v bool) {
	o.AlertsEnabled = &v
}

// GetEnabled returns the Enabled field value if set, zero value otherwise.
func (o *PageLoadTest) GetEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetEnabledOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.Enabled) {
		return nil, false
	}
...
func (o *PageLoadTest) HasEnabled() bool {
	if o != nil && !utils.IsNil(o.Enabled) {
		return true
	}
...
func (o *PageLoadTest) SetEnabled(v bool) {
	o.Enabled = &v
}

// GetAlertRules returns the AlertRules field value if set, zero value otherwise.
func (o *PageLoadTest) GetAlertRules() []AlertRule {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetAlertRulesOk() ([]AlertRule, bool) {
	if o == nil || utils.IsNil(o.AlertRules) {
		return nil, false
	}
...
func (o *PageLoadTest) HasAlertRules() bool {
	if o != nil && !utils.IsNil(o.AlertRules) {
		return true
	}
...
func (o *PageLoadTest) SetAlertRules(v []AlertRule) {
	o.AlertRules = v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *PageLoadTest) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetCreatedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *PageLoadTest) HasCreatedBy() bool {
	if o != nil && !utils.IsNil(o.CreatedBy) {
		return true
	}
...
func (o *PageLoadTest) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCreatedDate returns the CreatedDate field value if set, zero value otherwise.
func (o *PageLoadTest) GetCreatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetCreatedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.CreatedDate) {
		return nil, false
	}
...
func (o *PageLoadTest) HasCreatedDate() bool {
	if o != nil && !utils.IsNil(o.CreatedDate) {
		return true
	}
...
func (o *PageLoadTest) SetCreatedDate(v time.Time) {
	o.CreatedDate = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *PageLoadTest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetDescriptionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Description) {
		return nil, false
	}
...
func (o *PageLoadTest) HasDescription() bool {
	if o != nil && !utils.IsNil(o.Description) {
		return true
	}
...
func (o *PageLoadTest) SetDescription(v string) {
	o.Description = &v
}

// GetLiveShare returns the LiveShare field value if set, zero value otherwise.
func (o *PageLoadTest) GetLiveShare() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetLiveShareOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.LiveShare) {
		return nil, false
	}
...
func (o *PageLoadTest) HasLiveShare() bool {
	if o != nil && !utils.IsNil(o.LiveShare) {
		return true
	}
...
func (o *PageLoadTest) SetLiveShare(v bool) {
	o.LiveShare = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *PageLoadTest) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetModifiedByOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ModifiedBy) {
		return nil, false
	}
...
func (o *PageLoadTest) HasModifiedBy() bool {
	if o != nil && !utils.IsNil(o.ModifiedBy) {
		return true
	}
...
func (o *PageLoadTest) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedDate returns the ModifiedDate field value if set, zero value otherwise.
func (o *PageLoadTest) GetModifiedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetModifiedDateOk() (*time.Time, bool) {
	if o == nil || utils.IsNil(o.ModifiedDate) {
		return nil, false
	}
...
func (o *PageLoadTest) HasModifiedDate() bool {
	if o != nil && !utils.IsNil(o.ModifiedDate) {
		return true
	}
...
func (o *PageLoadTest) SetModifiedDate(v time.Time) {
	o.ModifiedDate = &v
}

// GetSavedEvent returns the SavedEvent field value if set, zero value otherwise.
func (o *PageLoadTest) GetSavedEvent() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetSavedEventOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.SavedEvent) {
		return nil, false
	}
...
func (o *PageLoadTest) HasSavedEvent() bool {
	if o != nil && !utils.IsNil(o.SavedEvent) {
		return true
	}
...
func (o *PageLoadTest) SetSavedEvent(v bool) {
	o.SavedEvent = &v
}

// GetTestId returns the TestId field value if set, zero value otherwise.
func (o *PageLoadTest) GetTestId() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetTestIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestId) {
		return nil, false
	}
...
func (o *PageLoadTest) HasTestId() bool {
	if o != nil && !utils.IsNil(o.TestId) {
		return true
	}
...
func (o *PageLoadTest) SetTestId(v string) {
	o.TestId = &v
}

// GetTestName returns the TestName field value if set, zero value otherwise.
func (o *PageLoadTest) GetTestName() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetTestNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TestName) {
		return nil, false
	}
...
func (o *PageLoadTest) HasTestName() bool {
	if o != nil && !utils.IsNil(o.TestName) {
		return true
	}
...
func (o *PageLoadTest) SetTestName(v string) {
	o.TestName = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *PageLoadTest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetTypeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *PageLoadTest) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
func (o *PageLoadTest) SetType(v string) {
	o.Type = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *PageLoadTest) GetLinks() TestLinks {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetLinksOk() (*TestLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PageLoadTest) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *PageLoadTest) SetLinks(v TestLinks) {
	o.Links = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *PageLoadTest) GetLabels() []TestLabel {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetLabelsOk() ([]TestLabel, bool) {
	if o == nil || utils.IsNil(o.Labels) {
		return nil, false
	}
...
func (o *PageLoadTest) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *PageLoadTest) SetLabels(v []TestLabel) {
	o.Labels = v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *PageLoadTest) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *PageLoadTest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *PageLoadTest) SetTags(v []TestTag) {
	o.Tags = v
}

// GetSharedWithAccounts returns the SharedWithAccounts field value if set, zero value otherwise.
func (o *PageLoadTest) GetSharedWithAccounts() []SharedWithAccount {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetSharedWithAccountsOk() ([]SharedWithAccount, bool) {
	if o == nil || utils.IsNil(o.SharedWithAccounts) {
		return nil, false
	}
...
func (o *PageLoadTest) HasSharedWithAccounts() bool {
	if o != nil && !utils.IsNil(o.SharedWithAccounts) {
		return true
	}
...
func (o *PageLoadTest) SetSharedWithAccounts(v []SharedWithAccount) {
	o.SharedWithAccounts = v
}

// GetAuthType returns the AuthType field value if set, zero value otherwise.
func (o *PageLoadTest) GetAuthType() TestAuthType {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetAuthTypeOk() (*TestAuthType, bool) {
	if o == nil || utils.IsNil(o.AuthType) {
		return nil, false
	}
...
func (o *PageLoadTest) HasAuthType() bool {
	if o != nil && !utils.IsNil(o.AuthType) {
		return true
	}
...
func (o *PageLoadTest) SetAuthType(v TestAuthType) {
	o.AuthType = &v
}

// GetAgentInterfaces returns the AgentInterfaces field value if set, zero value otherwise.
func (o *PageLoadTest) GetAgentInterfaces() AgentInterfaces {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetAgentInterfacesOk() (*AgentInterfaces, bool) {
	if o == nil || utils.IsNil(o.AgentInterfaces) {
		return nil, false
	}
...
func (o *PageLoadTest) HasAgentInterfaces() bool {
	if o != nil && !utils.IsNil(o.AgentInterfaces) {
		return true
	}
...
func (o *PageLoadTest) SetAgentInterfaces(v AgentInterfaces) {
	o.AgentInterfaces = &v
}

// GetBandwidthMeasurements returns the BandwidthMeasurements field value if set, zero value otherwise.
func (o *PageLoadTest) GetBandwidthMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetBandwidthMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BandwidthMeasurements) {
		return nil, false
	}
...
func (o *PageLoadTest) HasBandwidthMeasurements() bool {
	if o != nil && !utils.IsNil(o.BandwidthMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetClientCertificateOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ClientCertificate) {
		return nil, false
	}
...
func (o *PageLoadTest) HasClientCertificate() bool {
	if o != nil && !utils.IsNil(o.ClientCertificate) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetContentRegexOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ContentRegex) {
		return nil, false
	}
...
func (o *PageLoadTest) HasContentRegex() bool {
	if o != nil && !utils.IsNil(o.ContentRegex) {
		return true
	}
...
func (o *PageLoadTest) SetContentRegex(v string) {
	o.ContentRegex = &v
}

// GetCustomHeaders returns the CustomHeaders field value if set, zero value otherwise.
func (o *PageLoadTest) GetCustomHeaders() TestCustomHeaders {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetCustomHeadersOk() (*TestCustomHeaders, bool) {
	if o == nil || utils.IsNil(o.CustomHeaders) {
		return nil, false
	}
...
func (o *PageLoadTest) HasCustomHeaders() bool {
	if o != nil && !utils.IsNil(o.CustomHeaders) {
		return true
	}
...
func (o *PageLoadTest) SetCustomHeaders(v TestCustomHeaders) {
	o.CustomHeaders = &v
}

// GetDesiredStatusCode returns the DesiredStatusCode field value if set, zero value otherwise.
func (o *PageLoadTest) GetDesiredStatusCode() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetDesiredStatusCodeOk() (*string, bool) {
	if o == nil || utils.IsNil(o.DesiredStatusCode) {
		return nil, false
	}
...
func (o *PageLoadTest) HasDesiredStatusCode() bool {
	if o != nil && !utils.IsNil(o.DesiredStatusCode) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetDistributedTracingOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.DistributedTracing) {
		return nil, false
	}
...
func (o *PageLoadTest) HasDistributedTracing() bool {
	if o != nil && !utils.IsNil(o.DistributedTracing) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetDownloadLimitOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.DownloadLimit) {
		return nil, false
	}
...
func (o *PageLoadTest) HasDownloadLimit() bool {
	if o != nil && !utils.IsNil(o.DownloadLimit) {
		return true
	}
...
func (o *PageLoadTest) SetDownloadLimit(v int32) {
	o.DownloadLimit = &v
}

// GetDnsOverride returns the DnsOverride field value if set, zero value otherwise.
func (o *PageLoadTest) GetDnsOverride() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetDnsOverrideOk() (*string, bool) {
	if o == nil || utils.IsNil(o.DnsOverride) {
		return nil, false
	}
...
func (o *PageLoadTest) HasDnsOverride() bool {
	if o != nil && !utils.IsNil(o.DnsOverride) {
		return true
	}
...
func (o *PageLoadTest) SetDnsOverride(v string) {
	o.DnsOverride = &v
}

// GetHttpTargetTime returns the HttpTargetTime field value if set, zero value otherwise.
func (o *PageLoadTest) GetHttpTargetTime() int32 {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetHttpTargetTimeOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.HttpTargetTime) {
		return nil, false
	}
...
func (o *PageLoadTest) HasHttpTargetTime() bool {
	if o != nil && !utils.IsNil(o.HttpTargetTime) {
		return true
	}
...
func (o *PageLoadTest) SetHttpTargetTime(v int32) {
	o.HttpTargetTime = &v
}

// GetHttpTimeLimit returns the HttpTimeLimit field value if set, zero value otherwise.
func (o *PageLoadTest) GetHttpTimeLimit() int32 {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetHttpTimeLimitOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.HttpTimeLimit) {
		return nil, false
	}
...
func (o *PageLoadTest) HasHttpTimeLimit() bool {
	if o != nil && !utils.IsNil(o.HttpTimeLimit) {
		return true
	}
...
func (o *PageLoadTest) SetHttpTimeLimit(v int32) {
	o.HttpTimeLimit = &v
}

// GetHttpVersion returns the HttpVersion field value if set, zero value otherwise.
func (o *PageLoadTest) GetHttpVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetHttpVersionOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.HttpVersion) {
		return nil, false
	}
...
func (o *PageLoadTest) HasHttpVersion() bool {
	if o != nil && !utils.IsNil(o.HttpVersion) {
		return true
	}
...
func (o *PageLoadTest) SetHttpVersion(v int32) {
	o.HttpVersion = &v
}

// GetIncludeHeaders returns the IncludeHeaders field value if set, zero value otherwise.
func (o *PageLoadTest) GetIncludeHeaders() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetIncludeHeadersOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.IncludeHeaders) {
		return nil, false
	}
...
func (o *PageLoadTest) HasIncludeHeaders() bool {
	if o != nil && !utils.IsNil(o.IncludeHeaders) {
		return true
	}
...
func (o *PageLoadTest) SetIncludeHeaders(v bool) {
	o.IncludeHeaders = &v
}

// GetMtuMeasurements returns the MtuMeasurements field value if set, zero value otherwise.
func (o *PageLoadTest) GetMtuMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetMtuMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.MtuMeasurements) {
		return nil, false
	}
...
func (o *PageLoadTest) HasMtuMeasurements() bool {
	if o != nil && !utils.IsNil(o.MtuMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetNetworkMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.NetworkMeasurements) {
		return nil, false
	}
...
func (o *PageLoadTest) HasNetworkMeasurements() bool {
	if o != nil && !utils.IsNil(o.NetworkMeasurements) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetNumPathTracesOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.NumPathTraces) {
		return nil, false
	}
...
func (o *PageLoadTest) HasNumPathTraces() bool {
	if o != nil && !utils.IsNil(o.NumPathTraces) {
		return true
	}
...
func (o *PageLoadTest) SetNumPathTraces(v int32) {
	o.NumPathTraces = &v
}

// GetOAuth returns the OAuth field value if set, zero value otherwise.
func (o *PageLoadTest) GetOAuth() OAuth {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetOAuthOk() (*OAuth, bool) {
	if o == nil || utils.IsNil(o.OAuth) {
		return nil, false
	}
	return o.OAuth, true
...
func (o *PageLoadTest) HasOAuth() bool {
	if o != nil && !utils.IsNil(o.OAuth) {
		return true
	}
...
func (o *PageLoadTest) SetOAuth(v OAuth) {
	o.OAuth = &v
}

// GetPassword returns the Password field value if set, zero value otherwise.
func (o *PageLoadTest) GetPassword() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetPasswordOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Password) {
		return nil, false
	}
...
func (o *PageLoadTest) HasPassword() bool {
	if o != nil && !utils.IsNil(o.Password) {
		return true
	}
...
func (o *PageLoadTest) SetPassword(v string) {
	o.Password = &v
}

// GetPathTraceMode returns the PathTraceMode field value if set, zero value otherwise.
func (o *PageLoadTest) GetPathTraceMode() TestPathTraceMode {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetPathTraceModeOk() (*TestPathTraceMode, bool) {
	if o == nil || utils.IsNil(o.PathTraceMode) {
		return nil, false
	}
...
func (o *PageLoadTest) HasPathTraceMode() bool {
	if o != nil && !utils.IsNil(o.PathTraceMode) {
		return true
	}
...
func (o *PageLoadTest) SetPathTraceMode(v TestPathTraceMode) {
	o.PathTraceMode = &v
}

// GetProbeMode returns the ProbeMode field value if set, zero value otherwise.
func (o *PageLoadTest) GetProbeMode() TestProbeMode {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetProbeModeOk() (*TestProbeMode, bool) {
	if o == nil || utils.IsNil(o.ProbeMode) {
		return nil, false
	}
...
func (o *PageLoadTest) HasProbeMode() bool {
	if o != nil && !utils.IsNil(o.ProbeMode) {
		return true
	}
...
func (o *PageLoadTest) SetProbeMode(v TestProbeMode) {
	o.ProbeMode = &v
}

// GetProtocol returns the Protocol field value if set, zero value otherwise.
func (o *PageLoadTest) GetProtocol() TestProtocol {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetProtocolOk() (*TestProtocol, bool) {
	if o == nil || utils.IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *PageLoadTest) HasProtocol() bool {
	if o != nil && !utils.IsNil(o.Protocol) {
		return true
	}
...
func (o *PageLoadTest) SetProtocol(v TestProtocol) {
	o.Protocol = &v
}

// GetSslVersion returns the SslVersion field value if set, zero value otherwise.
func (o *PageLoadTest) GetSslVersion() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetSslVersionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.SslVersion) {
		return nil, false
	}
...
func (o *PageLoadTest) HasSslVersion() bool {
	if o != nil && !utils.IsNil(o.SslVersion) {
		return true
	}
...
func (o *PageLoadTest) SetSslVersion(v string) {
	o.SslVersion = &v
}

// GetSslVersionId returns the SslVersionId field value if set, zero value otherwise.
func (o *PageLoadTest) GetSslVersionId() TestSslVersionId {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetSslVersionIdOk() (*TestSslVersionId, bool) {
	if o == nil || utils.IsNil(o.SslVersionId) {
		return nil, false
	}
...
func (o *PageLoadTest) HasSslVersionId() bool {
	if o != nil && !utils.IsNil(o.SslVersionId) {
		return true
	}
...
func (o *PageLoadTest) SetSslVersionId(v TestSslVersionId) {
	o.SslVersionId = &v
}

// GetUrl returns the Url field value
func (o *PageLoadTest) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *PageLoadTest) SetUrl(v string) {
	o.Url = v
}

// GetUseNtlm returns the UseNtlm field value if set, zero value otherwise.
func (o *PageLoadTest) GetUseNtlm() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetUseNtlmOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UseNtlm) {
		return nil, false
	}
...
func (o *PageLoadTest) HasUseNtlm() bool {
	if o != nil && !utils.IsNil(o.UseNtlm) {
		return true
	}
...
func (o *PageLoadTest) SetUseNtlm(v bool) {
	o.UseNtlm = &v
}

// GetUserAgent returns the UserAgent field value if set, zero value otherwise.
func (o *PageLoadTest) GetUserAgent() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetUserAgentOk() (*string, bool) {
	if o == nil || utils.IsNil(o.UserAgent) {
		return nil, false
	}
...
func (o *PageLoadTest) HasUserAgent() bool {
	if o != nil && !utils.IsNil(o.UserAgent) {
		return true
	}
...
func (o *PageLoadTest) SetUserAgent(v string) {
	o.UserAgent = &v
}

// GetUsername returns the Username field value if set, zero value otherwise.
func (o *PageLoadTest) GetUsername() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetUsernameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Username) {
		return nil, false
	}
...
func (o *PageLoadTest) HasUsername() bool {
	if o != nil && !utils.IsNil(o.Username) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetVerifyCertificateOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.VerifyCertificate) {
		return nil, false
	}
...
func (o *PageLoadTest) HasVerifyCertificate() bool {
	if o != nil && !utils.IsNil(o.VerifyCertificate) {
		return true
	}
...
func (o *PageLoadTest) SetVerifyCertificate(v bool) {
...
func (o *PageLoadTest) GetAllowUnsafeLegacyRenegotiation() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetAllowUnsafeLegacyRenegotiationOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AllowUnsafeLegacyRenegotiation) {
		return nil, false
	}
...
func (o *PageLoadTest) HasAllowUnsafeLegacyRenegotiation() bool {
	if o != nil && !utils.IsNil(o.AllowUnsafeLegacyRenegotiation) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetFollowRedirectsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.FollowRedirects) {
		return nil, false
	}
...
func (o *PageLoadTest) HasFollowRedirects() bool {
	if o != nil && !utils.IsNil(o.FollowRedirects) {
		return true
	}
...
func (o *PageLoadTest) SetFollowRedirects(v bool) {
	o.FollowRedirects = &v
}

// GetFixedPacketRate returns the FixedPacketRate field value if set, zero value otherwise.
func (o *PageLoadTest) GetFixedPacketRate() int32 {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetFixedPacketRateOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.FixedPacketRate) {
		return nil, false
	}
...
func (o *PageLoadTest) HasFixedPacketRate() bool {
	if o != nil && !utils.IsNil(o.FixedPacketRate) {
		return true
	}
...
func (o *PageLoadTest) SetFixedPacketRate(v int32) {
	o.FixedPacketRate = &v
}

// GetOverrideAgentProxy returns the OverrideAgentProxy field value if set, zero value otherwise.
func (o *PageLoadTest) GetOverrideAgentProxy() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetOverrideAgentProxyOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.OverrideAgentProxy) {
		return nil, false
	}
...
func (o *PageLoadTest) HasOverrideAgentProxy() bool {
	if o != nil && !utils.IsNil(o.OverrideAgentProxy) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetOverrideProxyIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.OverrideProxyId) {
		return nil, false
	}
...
func (o *PageLoadTest) HasOverrideProxyId() bool {
	if o != nil && !utils.IsNil(o.OverrideProxyId) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetCollectProxyNetworkDataOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.CollectProxyNetworkData) {
		return nil, false
	}
...
func (o *PageLoadTest) HasCollectProxyNetworkData() bool {
	if o != nil && !utils.IsNil(o.CollectProxyNetworkData) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetVaultCredentialsOk() ([]TestVaultCredential, bool) {
	if o == nil || utils.IsNil(o.VaultCredentials) {
		return nil, false
	}
...
func (o *PageLoadTest) HasVaultCredentials() bool {
	if o != nil && !utils.IsNil(o.VaultCredentials) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetEmulatedDeviceIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.EmulatedDeviceId) {
		return nil, false
	}
...
func (o *PageLoadTest) HasEmulatedDeviceId() bool {
	if o != nil && !utils.IsNil(o.EmulatedDeviceId) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetPageLoadTargetTimeOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.PageLoadTargetTime) {
		return nil, false
	}
...
func (o *PageLoadTest) HasPageLoadTargetTime() bool {
	if o != nil && !utils.IsNil(o.PageLoadTargetTime) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetPageLoadTimeLimitOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.PageLoadTimeLimit) {
		return nil, false
	}
...
func (o *PageLoadTest) HasPageLoadTimeLimit() bool {
	if o != nil && !utils.IsNil(o.PageLoadTimeLimit) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetBlockDomainsOk() (*string, bool) {
	if o == nil || utils.IsNil(o.BlockDomains) {
		return nil, false
	}
...
func (o *PageLoadTest) HasBlockDomains() bool {
	if o != nil && !utils.IsNil(o.BlockDomains) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetDisableScreenshotOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.DisableScreenshot) {
		return nil, false
	}
...
func (o *PageLoadTest) HasDisableScreenshot() bool {
	if o != nil && !utils.IsNil(o.DisableScreenshot) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetAllowMicAndCameraOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AllowMicAndCamera) {
		return nil, false
	}
...
func (o *PageLoadTest) HasAllowMicAndCamera() bool {
	if o != nil && !utils.IsNil(o.AllowMicAndCamera) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetAllowGeolocationOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.AllowGeolocation) {
		return nil, false
	}
...
func (o *PageLoadTest) HasAllowGeolocation() bool {
	if o != nil && !utils.IsNil(o.AllowGeolocation) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetBrowserLanguageOk() (*string, bool) {
	if o == nil || utils.IsNil(o.BrowserLanguage) {
		return nil, false
	}
...
func (o *PageLoadTest) HasBrowserLanguage() bool {
	if o != nil && !utils.IsNil(o.BrowserLanguage) {
		return true
	}
...
func (o *PageLoadTest) SetBrowserLanguage(v string) {
	o.BrowserLanguage = &v
}

// GetChromeOptions returns the ChromeOptions field value if set, zero value otherwise.
func (o *PageLoadTest) GetChromeOptions() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetChromeOptionsOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ChromeOptions) {
		return nil, false
	}
...
func (o *PageLoadTest) HasChromeOptions() bool {
	if o != nil && !utils.IsNil(o.ChromeOptions) {
		return true
	}
...
func (o *PageLoadTest) SetChromeOptions(v string) {
	o.ChromeOptions = &v
}

// GetChromePolicies returns the ChromePolicies field value if set, zero value otherwise.
func (o *PageLoadTest) GetChromePolicies() string {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetChromePoliciesOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ChromePolicies) {
		return nil, false
	}
...
func (o *PageLoadTest) HasChromePolicies() bool {
	if o != nil && !utils.IsNil(o.ChromePolicies) {
		return true
	}
...
func (o *PageLoadTest) SetChromePolicies(v string) {
	o.ChromePolicies = &v
}

// GetChromiumTrack returns the ChromiumTrack field value if set, zero value otherwise.
func (o *PageLoadTest) GetChromiumTrack() TestChromiumTrack {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetChromiumTrackOk() (*TestChromiumTrack, bool) {
	if o == nil || utils.IsNil(o.ChromiumTrack) {
		return nil, false
	}
...
func (o *PageLoadTest) HasChromiumTrack() bool {
	if o != nil && !utils.IsNil(o.ChromiumTrack) {
		return true
	}
...
func (o *PageLoadTest) SetChromiumTrack(v TestChromiumTrack) {
	o.ChromiumTrack = &v
}

// GetPageLoadingStrategy returns the PageLoadingStrategy field value if set, zero value otherwise.
func (o *PageLoadTest) GetPageLoadingStrategy() TestPageLoadingStrategy {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetPageLoadingStrategyOk() (*TestPageLoadingStrategy, bool) {
	if o == nil || utils.IsNil(o.PageLoadingStrategy) {
		return nil, false
	}
...
func (o *PageLoadTest) HasPageLoadingStrategy() bool {
	if o != nil && !utils.IsNil(o.PageLoadingStrategy) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetRandomizedStartTimeOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.RandomizedStartTime) {
		return nil, false
	}
...
func (o *PageLoadTest) HasRandomizedStartTime() bool {
	if o != nil && !utils.IsNil(o.RandomizedStartTime) {
		return true
	}
...
func (o *PageLoadTest) SetRandomizedStartTime(v bool) {
...
func (o *PageLoadTest) GetIdentifyAgentTrafficWithUserAgent() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetIdentifyAgentTrafficWithUserAgentOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.IdentifyAgentTrafficWithUserAgent) {
		return nil, false
	}
...
func (o *PageLoadTest) HasIdentifyAgentTrafficWithUserAgent() bool {
	if o != nil && !utils.IsNil(o.IdentifyAgentTrafficWithUserAgent) {
		return true
	}
...
func (o *PageLoadTest) SetIdentifyAgentTrafficWithUserAgent(v bool) {
...
func (o *PageLoadTest) GetBgpMeasurements() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetBgpMeasurementsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.BgpMeasurements) {
		return nil, false
	}
...
func (o *PageLoadTest) HasBgpMeasurements() bool {
	if o != nil && !utils.IsNil(o.BgpMeasurements) {
		return true
	}
...
func (o *PageLoadTest) SetBgpMeasurements(v bool) {
	o.BgpMeasurements = &v
}

// GetUsePublicBgp returns the UsePublicBgp field value if set, zero value otherwise.
func (o *PageLoadTest) GetUsePublicBgp() bool {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetUsePublicBgpOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.UsePublicBgp) {
		return nil, false
	}
...
func (o *PageLoadTest) HasUsePublicBgp() bool {
	if o != nil && !utils.IsNil(o.UsePublicBgp) {
		return true
	}
...
func (o *PageLoadTest) SetUsePublicBgp(v bool) {
	o.UsePublicBgp = &v
}

// GetMonitors returns the Monitors field value if set, zero value otherwise.
func (o *PageLoadTest) GetMonitors() []Monitor {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetMonitorsOk() ([]Monitor, bool) {
	if o == nil || utils.IsNil(o.Monitors) {
		return nil, false
	}
...
func (o *PageLoadTest) HasMonitors() bool {
	if o != nil && !utils.IsNil(o.Monitors) {
		return true
	}
...
func (o *PageLoadTest) SetMonitors(v []Monitor) {
	o.Monitors = v
}

// GetHttpInterval returns the HttpInterval field value if set, zero value otherwise.
func (o *PageLoadTest) GetHttpInterval() TestHttpInterval {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetHttpIntervalOk() (*TestHttpInterval, bool) {
	if o == nil || utils.IsNil(o.HttpInterval) {
		return nil, false
	}
...
func (o *PageLoadTest) HasHttpInterval() bool {
	if o != nil && !utils.IsNil(o.HttpInterval) {
		return true
	}
...
func (o *PageLoadTest) SetHttpInterval(v TestHttpInterval) {
	o.HttpInterval = &v
}

// GetSubinterval returns the Subinterval field value if set, zero value otherwise.
func (o *PageLoadTest) GetSubinterval() TestSubInterval {
...
// and a boolean to check if the value has been set.
func (o *PageLoadTest) GetSubintervalOk() (*TestSubInterval, bool) {
	if o == nil || utils.IsNil(o.Subinterval) {
		return nil, false
	}
...
func (o *PageLoadTest) HasSubinterval() bool {
	if o != nil && !utils.IsNil(o.Subinterval) {
		return true
	}
...
func (o *PageLoadTest) SetSubinterval(v TestSubInterval) {
	o.Subinterval = &v
}

func (o PageLoadTest) MarshalJSON() ([]byte, error) {
...
func (o PageLoadTest) ToMap() (map[string]interface{}, error) {
...
func (o *PageLoadTest) UnmarshalJSON(data []byte) (err error) {
	...
	varPageLoadTest := _PageLoadTest{}

    err = json.Unmarshal(data, &varPageLoadTest)

	if err != nil {
		return err
	}

	*o = PageLoadTest(varPageLoadTest)

	return err
}

type NullablePageLoadTest struct {
	value *PageLoadTest
	isSet bool
}

func (v NullablePageLoadTest) Get() *PageLoadTest {
	return v.value
}

func (v *NullablePageLoadTest) Set(val *PageLoadTest) {
	v.value = val
	v.isSet = true
}

func (v NullablePageLoadTest) IsSet() bool {
	return v.isSet
}

func (v *NullablePageLoadTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageLoadTest(val *PageLoadTest) *NullablePageLoadTest {
	return &NullablePageLoadTest{value: val, isSet: true}
}

func (v NullablePageLoadTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageLoadTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
