...
func (o *DnsServerTestRequest) GetTags() []string {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTestRequest) GetTagsOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *DnsServerTestRequest) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *DnsServerTestRequest) SetTags(v []string) {
	o.Tags = v
}
