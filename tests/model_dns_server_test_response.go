...
func (o *DnsServerTestResponse) GetTags() []TestTag {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTestResponse) GetTagsOk() ([]TestTag, bool) {
	if o == nil || utils.IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *DnsServerTestResponse) HasTags() bool {
	if o != nil && !utils.IsNil(o.Tags) {
		return true
	}
...
func (o *DnsServerTestResponse) SetTags(v []TestTag) {
	o.Tags = v
}
...
func (o *DnsServerTestResponse) GetAgents() []TestAgentResponse {
...
// and a boolean to check if the value has been set.
func (o *DnsServerTestResponse) GetAgentsOk() ([]TestAgentResponse, bool) {
	if o == nil || utils.IsNil(o.Agents) {
		return nil, false
	}
...
func (o *DnsServerTestResponse) SetAgents(v []TestAgentResponse) {
	o.Agents = v
}
