...
func (o *AgentSearchFilters) GetUserPrincipalName() []string {
...
// and a boolean to check if the value has been set.
func (o *AgentSearchFilters) GetUserPrincipalNameOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.UserPrincipalName) {
		return nil, false
	}
...
func (o *AgentSearchFilters) HasUserPrincipalName() bool {
	if o != nil && !utils.IsNil(o.UserPrincipalName) {
		return true
	}
...
func (o *AgentSearchFilters) SetUserPrincipalName(v []string) {
...
func (o *AgentSearchFilters) GetAnyConnectDeviceId() []string {
	if o == nil || utils.IsNil(o.AnyConnectDeviceId) {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AgentSearchFilters) GetAnyConnectDeviceIdOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.AnyConnectDeviceId) {
		return nil, false
	}
...
func (o *AgentSearchFilters) HasAnyConnectDeviceId() bool {
	if o != nil && !utils.IsNil(o.AnyConnectDeviceId) {
		return true
	}
...
func (o *AgentSearchFilters) SetAnyConnectDeviceId(v []string) {
...
func (o AgentSearchFilters) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.AnyConnectDeviceId) {
