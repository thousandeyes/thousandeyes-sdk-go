...
type EndpointAgent struct {
	...
	ExternalMetadata []ExternalMetadataItem `json:"externalMetadata,omitempty"`
...
func (o *EndpointAgent) GetTargetVersion() string {
	if o == nil || utils.IsNil(o.TargetVersion) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EndpointAgent) GetTargetVersionOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TargetVersion) {
		return nil, false
	}
...
func (o *EndpointAgent) HasTargetVersion() bool {
	if o != nil && !utils.IsNil(o.TargetVersion) {
		return true
	}
...
func (o *EndpointAgent) SetTargetVersion(v string) {
	o.TargetVersion = &v
}
...
func (o *EndpointAgent) GetExternalMetadata() []ExternalMetadataItem {
	if o == nil || utils.IsNil(o.ExternalMetadata) {
		var ret []ExternalMetadataItem
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EndpointAgent) GetExternalMetadataOk() ([]ExternalMetadataItem, bool) {
	if o == nil || utils.IsNil(o.ExternalMetadata) {
		return nil, false
	}
...
func (o *EndpointAgent) HasExternalMetadata() bool {
	if o != nil && !utils.IsNil(o.ExternalMetadata) {
		return true
	}
...
// SetExternalMetadata gets a reference to the given []ExternalMetadataItem and assigns it to the ExternalMetadata field.
func (o *EndpointAgent) SetExternalMetadata(v []ExternalMetadataItem) {
...
func (o *EndpointAgent) GetBatteryMetrics() BatteryMetrics {
...
// and a boolean to check if the value has been set.
func (o *EndpointAgent) GetBatteryMetricsOk() (*BatteryMetrics, bool) {
	if o == nil || utils.IsNil(o.BatteryMetrics) {
		return nil, false
	}
...
func (o *EndpointAgent) HasBatteryMetrics() bool {
	if o != nil && !utils.IsNil(o.BatteryMetrics) {
		return true
	}
...
func (o *EndpointAgent) SetBatteryMetrics(v BatteryMetrics) {
	o.BatteryMetrics = &v
}

// GetCellularProfile returns the CellularProfile field value if set, zero value otherwise.
func (o *EndpointAgent) GetCellularProfile() CellularProfile {
...
// and a boolean to check if the value has been set.
func (o *EndpointAgent) GetCellularProfileOk() (*CellularProfile, bool) {
	if o == nil || utils.IsNil(o.CellularProfile) {
		return nil, false
	}
...
func (o *EndpointAgent) HasCellularProfile() bool {
	if o != nil && !utils.IsNil(o.CellularProfile) {
		return true
	}
...
func (o *EndpointAgent) SetCellularProfile(v CellularProfile) {
	o.CellularProfile = &v
}
...
func (o EndpointAgent) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.TargetVersion) {
	...
	if !utils.IsNil(o.ExternalMetadata) {
