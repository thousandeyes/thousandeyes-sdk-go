...
func (o *ApiNumbersCardData) GetCardName() string {
	if o == nil || utils.IsNil(o.CardName) {
		var ret string
		return ret
	}
	return *o.CardName
...
// and a boolean to check if the value has been set.
func (o *ApiNumbersCardData) GetCardNameOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CardName) {
		return nil, false
	}
...
func (o *ApiNumbersCardData) HasCardName() bool {
	if o != nil && !utils.IsNil(o.CardName) {
		return true
	}
...
func (o *ApiNumbersCardData) SetCardName(v string) {
	o.CardName = &v
}
...
func (o *ApiNumbersCardData) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *ApiNumbersCardData) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ApiNumbersCardData) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *ApiNumbersCardData) SetLinks(v SelfLinks) {
	o.Links = &v
}
