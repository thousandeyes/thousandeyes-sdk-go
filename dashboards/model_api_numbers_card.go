...
func (o *ApiNumbersCard) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *ApiNumbersCard) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ApiNumbersCard) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *ApiNumbersCard) SetLinks(v SelfLinks) {
	o.Links = &v
}
