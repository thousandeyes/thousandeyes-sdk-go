...
// checks if the ApiTimeseriesWidget type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ApiTimeseriesWidget{}

// ApiTimeseriesWidget The Timeseries widget graphs data over time, with the chosen metric displayed on the vertical axis. vertical axis
...
type _ApiTimeseriesWidget ApiTimeseriesWidget

// NewApiTimeseriesWidget instantiates a new ApiTimeseriesWidget object
...
// NewApiTimeseriesWidgetWithDefaults instantiates a new ApiTimeseriesWidget object
...
func (o *ApiTimeseriesWidget) GetId() string {
...
func (o *ApiTimeseriesWidget) GetIdOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *ApiTimeseriesWidget) HasId() bool {
	if o != nil && !utils.IsNil(o.Id) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetId(v string) {
	o.Id = &v
}

// GetTitle returns the Title field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetTitle() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetTitleOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Title) {
		return nil, false
	}
	return o.Title, true
...
func (o *ApiTimeseriesWidget) HasTitle() bool {
	if o != nil && !utils.IsNil(o.Title) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetTitle(v string) {
	o.Title = &v
}

// GetVisualMode returns the VisualMode field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetVisualMode() VisualMode {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetVisualModeOk() (*VisualMode, bool) {
	if o == nil || utils.IsNil(o.VisualMode) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasVisualMode() bool {
	if o != nil && !utils.IsNil(o.VisualMode) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetVisualMode(v VisualMode) {
	o.VisualMode = &v
}

// GetEmbedUrl returns the EmbedUrl field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetEmbedUrl() string {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetEmbedUrlOk() (*string, bool) {
	if o == nil || utils.IsNil(o.EmbedUrl) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasEmbedUrl() bool {
	if o != nil && !utils.IsNil(o.EmbedUrl) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetEmbedUrl(v string) {
	o.EmbedUrl = &v
}

// GetIsEmbedded returns the IsEmbedded field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetIsEmbedded() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetIsEmbeddedOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.IsEmbedded) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasIsEmbedded() bool {
	if o != nil && !utils.IsNil(o.IsEmbedded) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetIsEmbedded(v bool) {
	o.IsEmbedded = &v
}

// GetMetricGroup returns the MetricGroup field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetMetricGroup() MetricGroup {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetMetricGroupOk() (*MetricGroup, bool) {
	if o == nil || utils.IsNil(o.MetricGroup) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasMetricGroup() bool {
	if o != nil && !utils.IsNil(o.MetricGroup) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetMetricGroup(v MetricGroup) {
	o.MetricGroup = &v
}

// GetDirection returns the Direction field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetDirection() DashboardMetricDirection {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetDirectionOk() (*DashboardMetricDirection, bool) {
	if o == nil || utils.IsNil(o.Direction) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasDirection() bool {
	if o != nil && !utils.IsNil(o.Direction) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetDirection(v DashboardMetricDirection) {
	o.Direction = &v
}

// GetMetric returns the Metric field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetMetric() DashboardMetric {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetMetricOk() (*DashboardMetric, bool) {
	if o == nil || utils.IsNil(o.Metric) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasMetric() bool {
	if o != nil && !utils.IsNil(o.Metric) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetMetric(v DashboardMetric) {
	o.Metric = &v
}

// GetFilters returns the Filters field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetFilters() map[string][]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetFiltersOk() (*map[string][]interface{}, bool) {
	if o == nil || utils.IsNil(o.Filters) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasFilters() bool {
	if o != nil && !utils.IsNil(o.Filters) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetFilters(v map[string][]interface{}) {
	o.Filters = &v
}

// GetMeasure returns the Measure field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetMeasure() ApiWidgetMeasure {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetMeasureOk() (*ApiWidgetMeasure, bool) {
	if o == nil || utils.IsNil(o.Measure) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasMeasure() bool {
	if o != nil && !utils.IsNil(o.Measure) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetMeasure(v ApiWidgetMeasure) {
	o.Measure = &v
}

// GetFixedTimespan returns the FixedTimespan field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetFixedTimespan() ApiDuration {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetFixedTimespanOk() (*ApiDuration, bool) {
	if o == nil || utils.IsNil(o.FixedTimespan) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasFixedTimespan() bool {
	if o != nil && !utils.IsNil(o.FixedTimespan) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetFixedTimespan(v ApiDuration) {
	o.FixedTimespan = &v
}

// GetApiLink returns the ApiLink field value if set, zero value otherwise.
// Deprecated
func (o *ApiTimeseriesWidget) GetApiLink() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *ApiTimeseriesWidget) GetApiLinkOk() (*string, bool) {
	if o == nil || utils.IsNil(o.ApiLink) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasApiLink() bool {
	if o != nil && !utils.IsNil(o.ApiLink) {
		return true
	}
...
// Deprecated
func (o *ApiTimeseriesWidget) SetApiLink(v string) {
	o.ApiLink = &v
}
...
func (o *ApiTimeseriesWidget) GetShouldExcludeAlertSuppressionWindows() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetShouldExcludeAlertSuppressionWindowsOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.ShouldExcludeAlertSuppressionWindows) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasShouldExcludeAlertSuppressionWindows() bool {
	if o != nil && !utils.IsNil(o.ShouldExcludeAlertSuppressionWindows) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetShouldExcludeAlertSuppressionWindows(v bool) {
	o.ShouldExcludeAlertSuppressionWindows = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ApiTimeseriesWidget) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetLinks(v SelfLinks) {
	o.Links = &v
}

// GetMinScale returns the MinScale field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetMinScale() float32 {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetMinScaleOk() (*float32, bool) {
	if o == nil || utils.IsNil(o.MinScale) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasMinScale() bool {
	if o != nil && !utils.IsNil(o.MinScale) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetMinScale(v float32) {
	o.MinScale = &v
}

// GetMaxScale returns the MaxScale field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetMaxScale() float32 {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetMaxScaleOk() (*float32, bool) {
	if o == nil || utils.IsNil(o.MaxScale) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasMaxScale() bool {
	if o != nil && !utils.IsNil(o.MaxScale) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetMaxScale(v float32) {
	o.MaxScale = &v
}

// GetUnit returns the Unit field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetUnit() ApiWidgetFixedYScalePrefix {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetUnitOk() (*ApiWidgetFixedYScalePrefix, bool) {
	if o == nil || utils.IsNil(o.Unit) {
		return nil, false
	}
	return o.Unit, true
...
func (o *ApiTimeseriesWidget) HasUnit() bool {
	if o != nil && !utils.IsNil(o.Unit) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetUnit(v ApiWidgetFixedYScalePrefix) {
	o.Unit = &v
}

// GetType returns the Type field value
func (o *ApiTimeseriesWidget) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetShowTimeseriesOverallBaselineOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.ShowTimeseriesOverallBaseline) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasShowTimeseriesOverallBaseline() bool {
	if o != nil && !utils.IsNil(o.ShowTimeseriesOverallBaseline) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetShowTimeseriesOverallBaseline(v bool) {
	o.ShowTimeseriesOverallBaseline = &v
}

// GetGroupBy returns the GroupBy field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetGroupBy() ApiAggregateProperty {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetGroupByOk() (*ApiAggregateProperty, bool) {
	if o == nil || utils.IsNil(o.GroupBy) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasGroupBy() bool {
	if o != nil && !utils.IsNil(o.GroupBy) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetGroupBy(v ApiAggregateProperty) {
	o.GroupBy = &v
}

// GetIsTimeseriesOneChartPerLine returns the IsTimeseriesOneChartPerLine field value if set, zero value otherwise.
func (o *ApiTimeseriesWidget) GetIsTimeseriesOneChartPerLine() bool {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetIsTimeseriesOneChartPerLineOk() (*bool, bool) {
	if o == nil || utils.IsNil(o.IsTimeseriesOneChartPerLine) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasIsTimeseriesOneChartPerLine() bool {
	if o != nil && !utils.IsNil(o.IsTimeseriesOneChartPerLine) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetIsTimeseriesOneChartPerLine(v bool) {
...
// and a boolean to check if the value has been set.
func (o *ApiTimeseriesWidget) GetDataSourceOk() (*TimeseriesDatasource, bool) {
	if o == nil || utils.IsNil(o.DataSource) {
		return nil, false
	}
...
func (o *ApiTimeseriesWidget) HasDataSource() bool {
	if o != nil && !utils.IsNil(o.DataSource) {
		return true
	}
...
func (o *ApiTimeseriesWidget) SetDataSource(v TimeseriesDatasource) {
	o.DataSource = &v
}

func (o ApiTimeseriesWidget) MarshalJSON() ([]byte, error) {
...
func (o ApiTimeseriesWidget) ToMap() (map[string]interface{}, error) {
...
func (o *ApiTimeseriesWidget) UnmarshalJSON(data []byte) (err error) {
	...
	varApiTimeseriesWidget := _ApiTimeseriesWidget{}

    err = json.Unmarshal(data, &varApiTimeseriesWidget)

	if err != nil {
		return err
	}

	*o = ApiTimeseriesWidget(varApiTimeseriesWidget)

	return err
}

type NullableApiTimeseriesWidget struct {
	value *ApiTimeseriesWidget
	isSet bool
}

func (v NullableApiTimeseriesWidget) Get() *ApiTimeseriesWidget {
	return v.value
}

func (v *NullableApiTimeseriesWidget) Set(val *ApiTimeseriesWidget) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTimeseriesWidget) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTimeseriesWidget) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTimeseriesWidget(val *ApiTimeseriesWidget) *NullableApiTimeseriesWidget {
	return &NullableApiTimeseriesWidget{value: val, isSet: true}
}

func (v NullableApiTimeseriesWidget) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTimeseriesWidget) UnmarshalJSON(src []byte) error {
	v.isSet = true
