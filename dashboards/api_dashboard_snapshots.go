...
func (r ApiGetDashboardSnapshotsRequest) ExecuteContext(ctx context.Context) (*DashboardSnapshotsPage, *http.Response, error) {
	r.ctx = ctx
	return r.Execute()
}

func (r ApiGetDashboardSnapshotsRequest) Paginated() *pagination.Pager[DashboardSnapshotsPage] {
	return pagination.NewPager(
		r.cursor,
		func(ctx context.Context, cursor *string) (*DashboardSnapshotsPage, *http.Response, error) {
			pageRequest := r
			if cursor != nil {
		...
		func(page *DashboardSnapshotsPage) (string, bool) {
			if page == nil {
				return "", false
			}
