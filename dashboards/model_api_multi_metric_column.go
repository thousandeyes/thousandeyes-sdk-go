...
func (o *ApiMultiMetricColumn) GetLinks() SelfLinks {
...
// and a boolean to check if the value has been set.
func (o *ApiMultiMetricColumn) GetLinksOk() (*SelfLinks, bool) {
	if o == nil || utils.IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ApiMultiMetricColumn) HasLinks() bool {
	if o != nil && !utils.IsNil(o.Links) {
		return true
	}
...
func (o *ApiMultiMetricColumn) SetLinks(v SelfLinks) {
	o.Links = &v
}
