...
type ApiGetIndividualCardDataRequest struct {
...
// A unique identifier associated with your account group. You can retrieve your &#x60;AccountGroupId&#x60; from the &#x60;/account-groups&#x60; endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.
func (r ApiGetIndividualCardDataRequest) Aid(aid string) ApiGetIndividualCardDataRequest {
	r.aid = &aid
	return r
}

// A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: &#x60;s&#x60; for seconds (default if no type is specified), &#x60;m&#x60; for minutes, &#x60;h&#x60; for hours, &#x60;d&#x60; for days, and &#x60;w&#x60; for weeks. For a precise date range, use &#x60;startDate&#x60; and &#x60;endDate&#x60;.
func (r ApiGetIndividualCardDataRequest) Window(window string) ApiGetIndividualCardDataRequest {
	r.window = &window
	return r
}

// Use with the &#x60;endDate&#x60; parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can&#39;t be used with &#x60;window&#x60;.
func (r ApiGetIndividualCardDataRequest) StartDate(startDate time.Time) ApiGetIndividualCardDataRequest {
	r.startDate = &startDate
	return r
}

// Defaults to current time the request is made. Use with the &#x60;startDate&#x60; parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can&#39;t be used with &#x60;window&#x60;.
func (r ApiGetIndividualCardDataRequest) EndDate(endDate time.Time) ApiGetIndividualCardDataRequest {
	r.endDate = &endDate
	return r
}

func (r ApiGetIndividualCardDataRequest) Execute() (*ApiNumbersCardData, *http.Response, error) {
	return r.ApiService.GetIndividualCardDataExecute(r)
}
...
Returns the raw data for an individual card within a numbers widget in the dashboard.
 ...
 @param dashboardId A Identifier for a dashboard which can be obtained from the `/dashboards` endpoint. @param widgetId A Identifier for a widget. @param cardId An identifier for a card within the numbers widget.
 @return ApiGetIndividualCardDataRequest
*/
func (a *DashboardsAPIService) GetIndividualCardData(dashboardId string , widgetId string , cardId string ) ApiGetIndividualCardDataRequest {
	return ApiGetIndividualCardDataRequest{
		ApiService: a,
		dashboardId: dashboardId,
		widgetId: widgetId,
...
func (a *DashboardsAPIService) GetIndividualCardDataExecute(r ApiGetIndividualCardDataRequest) (*ApiNumbersCardData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarReturnValue  *ApiNumbersCardData
	)

	localBasePath := a.Client.GetConfig().ServerURL

	localVarPath := localBasePath + "/dashboards/{dashboardId}/widgets/{widgetId}/cards/{cardId}"
	localVarPath = strings.Replace(localVarPath, "{"+"dashboardId"+"}", url.PathEscape(request.ParameterValueToString(r.dashboardId, "dashboardId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"widgetId"+"}", url.PathEscape(request.ParameterValueToString(r.widgetId, "widgetId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"cardId"+"}", url.PathEscape(request.ParameterValueToString(r.cardId, "cardId")), -1)
...
type ApiGetIndividualColumnDataRequest struct {
...
// A unique identifier associated with your account group. You can retrieve your &#x60;AccountGroupId&#x60; from the &#x60;/account-groups&#x60; endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response.
func (r ApiGetIndividualColumnDataRequest) Aid(aid string) ApiGetIndividualColumnDataRequest {
	r.aid = &aid
	return r
}

// A dynamic time interval up to the current time of the request. Specify the interval as a number followed by an optional type: &#x60;s&#x60; for seconds (default if no type is specified), &#x60;m&#x60; for minutes, &#x60;h&#x60; for hours, &#x60;d&#x60; for days, and &#x60;w&#x60; for weeks. For a precise date range, use &#x60;startDate&#x60; and &#x60;endDate&#x60;.
func (r ApiGetIndividualColumnDataRequest) Window(window string) ApiGetIndividualColumnDataRequest {
	r.window = &window
	return r
}

// Use with the &#x60;endDate&#x60; parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can&#39;t be used with &#x60;window&#x60;.
func (r ApiGetIndividualColumnDataRequest) StartDate(startDate time.Time) ApiGetIndividualColumnDataRequest {
	r.startDate = &startDate
	return r
}

// Defaults to current time the request is made. Use with the &#x60;startDate&#x60; parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can&#39;t be used with &#x60;window&#x60;.
func (r ApiGetIndividualColumnDataRequest) EndDate(endDate time.Time) ApiGetIndividualColumnDataRequest {
	r.endDate = &endDate
	return r
}

func (r ApiGetIndividualColumnDataRequest) Execute() (*ApiMultiMetricColumnData, *http.Response, error) {
	return r.ApiService.GetIndividualColumnDataExecute(r)
}
...
Returns the raw data for an individual column within a multi-metric table widget in the dashboard.
 ...
 @param dashboardId A Identifier for a dashboard which can be obtained from the `/dashboards` endpoint. @param widgetId A Identifier for a widget. @param columnId An identifier for a column within the multi-metric table widget.
 @return ApiGetIndividualColumnDataRequest
*/
func (a *DashboardsAPIService) GetIndividualColumnData(dashboardId string , widgetId string , columnId string ) ApiGetIndividualColumnDataRequest {
	return ApiGetIndividualColumnDataRequest{
		ApiService: a,
		dashboardId: dashboardId,
		widgetId: widgetId,
...
func (a *DashboardsAPIService) GetIndividualColumnDataExecute(r ApiGetIndividualColumnDataRequest) (*ApiMultiMetricColumnData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarReturnValue  *ApiMultiMetricColumnData
	)

	localBasePath := a.Client.GetConfig().ServerURL

	localVarPath := localBasePath + "/dashboards/{dashboardId}/widgets/{widgetId}/columns/{columnId}"
	localVarPath = strings.Replace(localVarPath, "{"+"dashboardId"+"}", url.PathEscape(request.ParameterValueToString(r.dashboardId, "dashboardId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"widgetId"+"}", url.PathEscape(request.ParameterValueToString(r.widgetId, "widgetId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"columnId"+"}", url.PathEscape(request.ParameterValueToString(r.columnId, "columnId")), -1)
